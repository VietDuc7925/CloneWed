...
var H = V
  ...
  , Z = {};
Z["[object Float32Array]"] = Z["[object Float64Array]"] = Z["[object Int8Array]"] = Z["[object Int16Array]"] = Z["[object Int32Array]"] = Z["[object Uint8Array]"] = Z["[object Uint8ClampedArray]"] = Z["[object Uint16Array]"] = Z["[object Uint32Array]"] = !0,
...
var ee = o((function(e, t) {
  ...
  , ie = function(e) {
    ...
    }(e) && ($(e) || "string" == typeof e || "function" == typeof e.splice || J(e) || ne(e) || Y(e)))
        return !e.length;
    var i = H(e);
    if ("[object Map]" == i || "[object Set]" == i)
        return !e.size;
    if (t(e))
        return !function(e) {
            if (!t(e))
            ...
            for (var o in Object(e))
                r.call(e, o) && "constructor" != o && i.push(o);
            return i
        }(e).length;
    for (var o in e)
        if (re.call(e, o))
...
function je(e, t) {
    if (!t || !t.length)
        return 0;
    if (1 === t.length && t.end(0) - t.start(0) < 1e-6)
        return 0;
    let n = 0;
...
function Ye(e, t) {
    ...
    this.clone = ()=>new Ye(e,this),
    this.isVimeoResponse = !0
}
let $e = function(e) {
    function t() {
        var t;
        return (t = e.call(this, "The operation was aborted.") || this).name = "AbortError",
        t
    }
    return he(t, e),
    t
  ...
  , ze = function(e) {
    function t(t) {
        var n;
        return (n = e.call(this, t.statusText) || this).name = "HTTPError",
        n.response = t,
        n
    }
    return he(t, e),
  ...
  , Qe = function(e) {
    function t() {
        var t;
        return (t = e.call(this, "A network error occurred.") || this).name = "NetworkError",
        t
    }
    return he(t, e),
    t
  ...
  , Je = function(e) {
    function t(t) {
        var n;
        return (n = e.call(this, "Request timed out.") || this).name = "TimeoutError",
        n.timeoutMs = t,
        n
    }
    return he(t, e),
...
function Ze(e, t) {
    let {url: n, method: r, body: i, onDownloadProgress: o} = e
      , s = 100;
    return new Promise((function(a, u) {
        ...
        c.onload = function() {
            if (0 === c.status && (!c.responseURL || 0 !== c.responseURL.indexOf("file:")))
                return;
            const e = {};
            ...
            if (window.performance && void 0 !== window.performance.getEntriesByType) {
                ...
                if (e.length && e.length >= s && ("function" == typeof l.clearResourceTimings && l.clearResourceTimings(),
                "function" == typeof l.setResourceTimingBufferSize && (l.setResourceTimingBufferSize(500),
                s = 500)),
                e.length) {
        ...
        for (let t in e.headers)
            c.setRequestHeader(t, e.headers[t]);
...
function tt(e, t, n) {
    if (!e.s) {
        if (n instanceof nt) {
            if (!n.s)
                return void (n.o = tt.bind(null, e, t));
            1 & t && (t = n.s),
            n = n.v
        }
        if (n && n.then)
            return void n.then(tt.bind(null, e, t), tt.bind(null, e, 2));
        e.s = t,
        e.v = n;
        const r = e.o;
        r && r(e)
...
function it(e) {
    const t = function(e) {
        ...
        return function(e, t) {
            ...
            n++;
            const s = function(t) {
                if (!e.retryAbortErrors && t instanceof $e)
                    return 0;
                if (t instanceof Je)
                    return 0;
                if (n >= e.retry)
                    return 0;
                if (t instanceof ze) {
                    if (!e.retryStatus(t.response.status))
                        return 0;
                    const n = t.response.headers["retry-after"];
                    if (n && e.retryStatus(t.response.status)) {
                        let e = Number(n);
                        return isNaN(e) ? e = Date.parse(n) - Date.now() : e *= 1e3,
                        e
                    }
                                ...
                                return function n(s) {
                                    try {
                                        for (; ++o < e.length; )
                                            if ((s = t(o)) && s.then) {
                                                if (!rt(s))
                                                    return void s.then(n, i || (i = tt.bind(null, r = new nt, 2)));
                                                s = s.v
                                            }
                                        r ? tt(r, 1, s) : r = s
                                    } catch (Vd) {
    ...
    return function s(a) {
        try {
            for (; ++o < e.length && (!n || !n()); )
                if ((a = t(o)) && a.then) {
                    if (!ct(a))
                        return void a.then(s, i || (i = at.bind(null, r = new ut, 2)));
                    a = a.v
                }
            r ? at(r, 1, a) : r = a
        } catch (Vd) {
...
function pt(e, t) {
    const n = st((function() {
        ...
        return dt(lt(r, (function(i) {
            return ot((0,
            r[i])(t), (function(r) {
                return r instanceof mt ? (t = r,
                void (n = !0)) : (null == r ? void 0 : r.isVimeoResponse) ? (e = !0,
                Promise.resolve(r).then(vt(t))) : void 0
            }
            ))
        }
        ), (function() {
    ...
    t = new mt(e,t);
    const {method: r, json: i, jwt: o, searchParams: s} = t;
    if (i && (t.headers["Content-Type"] = ft.json,
    t.body = JSON.stringify(i)),
    o && (t.headers.Authorization = `jwt ${o}`),
    s) {
    ...
    for (const u in ft)
        a[u] = st((function() {
            return t.headers["Content-Type"] = ft[u],
            ot(a, (function(e) {
                return e.clone()[u]()
            }
            ))
...
const {get: gt, post: yt, put: Et, patch: Tt, head: St} = pt
  , bt = {
...
Bt.hevc = qt(),
Bt.hevcMain10 = qt("hvc1.2.4.H150.90"),
Bt.hdr = Xt,
Bt.dolbyVision = function() {
...
Bt.vp9hdr = (window.matchMedia("(color-gamut: p3)").matches || window.matchMedia("(color-gamut: rec2020)").matches) && screen.colorDepth >= 48 && (MediaSource.isTypeSupported('video/webm; codecs="vp09.02.10.10.01.09.16.09.00"') || MediaSource.isTypeSupported('video/webm; codecs="vp09.02.10.10.01.09.16.09.01"') || MediaSource.isTypeSupported('video/webm; codecs="vp09.02.10.10.01.09.18.09.00"') || MediaSource.isTypeSupported('video/webm; codecs="vp09.02.10.10.01.09.18.09.01"')),
Bt.av1 = "undefined" != typeof MediaSource && MediaSource.isTypeSupported('video/mp4; codecs="av01.0.31M.08.0.110.01.01.01.0"'),
Bt.webvr = !!(window.navigator && "getVRDisplays"in window.navigator),
Bt.webxr = !!(window.navigator && "xr"in window.navigator && "supportsSession"in window.navigator.xr),
Bt.spatialPlayback = Gt(),
Bt.spatialHEVC = !Bt.browser.safari && Gt() && qt(),
Bt.stereoscopic = Bt.spatialPlayback && Bt.mobileAndroid;
...
In.prototype.set = function(e, t) {
    ...
    n[e] = Sn && void 0 === t ? "__lodash_hash_undefined__" : t,
    this
}
;
...
Pn.prototype.delete = function(e) {
    var t = this.__data__
      , n = Rn(t, e);
    return !(n < 0 || (n == t.length - 1 ? t.pop() : kn.call(t, n, 1),
    --this.size,
    0))
}
,
...
function Cn(e, t) {
    ...
    return n.cache = new (Cn.Cache || Ln),
    n
}
...
function Xn(e, t) {
    for (var n = 0, r = (t = Vn(t, e)).length; null != e && n < r; )
        e = e[Hn(t[n++])];
...
function lr() {
    ...
    return function(e) {
        return function(n, r, i) {
            var o, s = e(n, r, i), a = s.dispatch, u = {
                getState: s.getState,
                dispatch: function(e) {
                    return a(e)
                }
            ...
            a = ur.apply(void 0, o)(s.dispatch),
            cr({}, s, {
                dispatch: a
            })
        }
        ...
        e.fire = function(n) {
            ...
            if (n in t)
                for (var r = t[n].slice(0), i = 0, o = r.length; i < o; i++)
                    if (r[i].apply(e, r.slice.call(arguments, 1)),
                    e.__isHalted) {
                        delete e.__isHalted;
                        break
                    }
...
Dr["[object Float32Array]"] = Dr["[object Float64Array]"] = Dr["[object Int8Array]"] = Dr["[object Int16Array]"] = Dr["[object Int32Array]"] = Dr["[object Uint8Array]"] = Dr["[object Uint8ClampedArray]"] = Dr["[object Uint16Array]"] = Dr["[object Uint32Array]"] = !0,
Dr["[object Arguments]"] = Dr["[object Array]"] = Dr["[object ArrayBuffer]"] = Dr["[object Boolean]"] = Dr["[object DataView]"] = Dr["[object Date]"] = Dr["[object Error]"] = Dr["[object Function]"] = Dr["[object Map]"] = Dr["[object Number]"] = Dr["[object Object]"] = Dr["[object RegExp]"] = Dr["[object Set]"] = Dr["[object String]"] = Dr["[object WeakMap]"] = !1;
...
function jr(e, t) {
    var n = Wt(e)
      ...
      , u = a.length;
    for (var c in e)
        !t && !Fr.call(e, c) || s && ("length" == c || i && ("offset" == c || "parent" == c) || o && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || kr(c, u)) || a.push(c);
    return a
}
...
function Gr(e) {
    ...
    for (var n in Object(e))
        qr.call(e, n) && "constructor" != n && t.push(n);
    return t
}
function Wr(e) {
...
function $r(e) {
    return Wr(e) ? jr(e, !0) : function(e) {
        ...
        var t = Vr(e)
          , n = [];
        for (var r in e)
            ("constructor" != r || !t && Yr.call(e, r)) && n.push(r);
        return n
    }(e)
}
...
function Fi(e, t, n, r, i, o) {
    ...
    if (l) {
        if (s = function(e) {
            ...
            return t && "string" == typeof e[0] && bi.call(e, "index") && (n.index = e.index,
            n.input = e.input),
            n
        }(e),
        !a)
...
Ui["[object Arguments]"] = Ui["[object Array]"] = Ui["[object ArrayBuffer]"] = Ui["[object DataView]"] = Ui["[object Boolean]"] = Ui["[object Date]"] = Ui["[object Float32Array]"] = Ui["[object Float64Array]"] = Ui["[object Int8Array]"] = Ui["[object Int16Array]"] = Ui["[object Int32Array]"] = Ui["[object Map]"] = Ui["[object Number]"] = Ui["[object Object]"] = Ui["[object RegExp]"] = Ui["[object Set]"] = Ui["[object String]"] = Ui["[object Symbol]"] = Ui["[object Uint8Array]"] = Ui["[object Uint8ClampedArray]"] = Ui["[object Uint16Array]"] = Ui["[object Uint32Array]"] = !0,
Ui["[object Error]"] = Ui["[object Function]"] = Ui["[object WeakMap]"] = !1;
var Hi = Math.max;
function Xi(e, t, n) {
    return t = Hi(void 0 === t ? e.length - 1 : t, 0),
    function() {
        for (var r = arguments, i = -1, o = Hi(r.length - t, 0), s = Array(o); ++i < o; )
            s[i] = r[t + i];
        i = -1;
                ...
                if (c)
                    ...
                    if (d) {
                        var h = Wt(u)
                          ...
                          , _ = !h && !f && Ur(u);
                        l = u,
                        h || f || _ ? Wt(a) ? l = a : function(e) {
                            return on(e) && Wr(e)
                        }(a) ? l = ti(a) : f ? (d = !1,
                        l = ei(u, !0)) : _ ? (d = !1,
                        l = Pi(u, !0)) : l = [] : no(u) || Sr(u) ? (l = a,
                        Sr(a) ? l = function(e) {
                            return vr(e, $r(e))
...
let To = function(e) {
    function t(t) {
        var n;
        return (n = e.call(this, t) || this)._videoElement = document.createElement("video"),
    ...
    return n.addVideoEventListeners = function(e=this._videoElement) {
        ...
        e.addEventListener("webkitplaybacktargetavailabilitychanged", e=>{
            ...
            case "available":
                ...
                this.fire(_o.AIRPLAY_AVAILABLE));
                break;
            case "not-available":
                this._available && (this._available = !1,
                this.fire(_o.AIRPLAY_UNAVAILABLE))
            }
        }
        ),
        e.addEventListener("webkitcurrentplaybacktargetiswirelesschanged", e=>{
            if (e.target.webkitCurrentPlaybackTargetIsWireless)
                ...
                void this.fire(_o.AIRPLAY_ACTIVATED);
            this._active = !1,
            this.fire(_o.AIRPLAY_DEACTIVATED)
        }
        )
    }
    ,
    n.showPicker = function() {
        ...
        this.loadMetadata().then(()=>this._videoElement.webkitShowPlaybackTargetPicker()).catch(()=>{}
        )
    }
    ,
...
let Qo = function() {
    function e(e, t={}) {
        ...
        dr(this),
        this.on(lo.LOADED_METADATA, ()=>this._initMediaSessionHandlers()),
        this.on(lo.PLAY, ()=>this._initMediaSessionMetadata());
        ...
        this._video = n,
        t.playRequest && (this._playRequest = t.playRequest,
        this._playRequest.video = n),
    ...
    ue(e, null, [{
        ...
        get: function() {
            const e = [];
            if ("function" != typeof Wo.canPlayType)
                return e;
            for (const t in Ko) {
                const n = Ko[t];
        ...
        get: function() {
            if (Bt.android || Bt.iOS || Bt.iPadOS)
                return !1;
            const e = Wo.volume;
            return Wo.volume = .5 * e,
            Wo.volume !== e
        }
    }, {
    ...
    t.addAudioEventListeners = function(e=this._video) {
        var t;
        (null == e ? void 0 : e.audioTracks) && "function" == typeof (null == (t = e.audioTracks) ? void 0 : t.addEventListener) && (e.audioTracks.addEventListener(ho.ADD_TRACK, this._boundHandleAudioEvent),
    ...
    t.removeAudioEventListeners = function(e=this._video) {
        var t;
        (null == e ? void 0 : e.audioTracks) && "function" == typeof (null == (t = e.audioTracks) ? void 0 : t.removeEventListener) && (e.audioTracks.removeEventListener(ho.ADD_TRACK, this._boundHandleAudioEvent),
    ...
    t.addTextTrack = function(e) {
        let t, n;
        return e.src ? (t = document.createElement("track"),
        t.kind = e.kind,
        t.src = e.src,
        ...
        n = t.track) : (n = this._video.addTextTrack(e.kind, e.label, e.language),
        this._textTracks = this._textTracks || {},
        this._textTracks[`telecine-track-${e.id}`] = n),
        this._addTextTrackListeners(e, n, t),
        n
    }
    ,
    t._addTextTrackListeners = function(e, t, n) {
        t.addEventListener("cuechange", ()=>e.dispatchEvent("cuechange")),
        ...
        const r = ()=>{
          ...
          , i = [];
        if (n ? n.addEventListener("load", r) : r(),
        ["loadeddata", "seeking"].forEach(e=>{
            this._video.addEventListener(e, r),
            i.push([e, r])
        }
        ),
        e._modeHasBeenSet && (t.mode = Yo[e.mode]),
        !$o) {
            let n = [];
            const r = ()=>{
                if (t && "disabled" !== Yo[t.mode]) {
                    if (n.length !== t.activeCues.length)
                        return e.dispatchEvent("cuechange"),
                        void (n = Array.from(t.activeCues));
                    for (let r = 0, i = t.activeCues.length; r < i; r++)
                        if (t.activeCues[r].startTime !== n[r].startTime)
                            return e.dispatchEvent("cuechange"),
                            void (n = Array.from(e.activeCues))
                }
            }
            ;
    ...
    t.setModeForTrack = function(e, t) {
        ...
        return n && n.mode !== Yo[t] && (n.mode = Yo[t],
        $o || "disabled" === t || e.dispatchEvent("cuechange")),
        this
    }
    ,
    t.setSrcForTrack = function(e, t) {
        const n = this._video.querySelector(`#telecine-track-${e.id}`);
        return n && null === n.track.cues && (n.src = t),
        this
    }
    ,
    t.enableAudioTrack = function(e) {
        if (!this.constructor.supportsVideoElementAudioTracks || !this.audioTracks)
            return null;
        if (!e)
            return null;
        if (!this.audioTracks.getTrackById(e))
            return null;
        let t = null;
        for (let n = 0; n < this.audioTracks.length; n++) {
            const r = this.audioTracks[n].id === e;
            this.audioTracks[n].enabled = r,
            r && (t = this.audioTracks[n])
        }
        return t
    }
    ,
    t._createChapterCue = function(e, t, n=null) {
        let r;
        this._chaptersTrack || (this._chaptersTrack = this._video.addTextTrack("chapters"),
    ...
    t.addChapter = function(e, t) {
        ...
        n.push(r),
        n.sort((e,t)=>e.timecode - t.timecode);
    ...
    t.addCuePoint = function(e, t={}) {
        ...
        const n = new Uo(e,t);
        return this._cuePointTrack.addCue(n.vttCue),
        n
    }
    ,
    t.removeCuePoint = function(e) {
        if (!e)
            throw new No("InvalidCuePoint","The specified cue point is not valid.");
    ...
    t.onerror = function() {
        ...
        case this._video.error.MEDIA_ERR_SRC_NOT_SUPPORTED:
            return this._fireVideoError("MediaSrcNotSupportedError", "The media was not suitable."),
            this._switchToNextFile(),
            !1;
        case this._video.error.MEDIA_ERR_DECODE:
            return -1 !== this._lastCurrentTime && Bt.iOS ? (this._video.load(),
            this.currentTime = this._lastCurrentTime,
            this._lastCurrentTime = -1,
            !1) : (this._fireVideoError("MediaDecodeError", "The media could not be decoded."),
            this._switchToNextFile(),
            !1);
        case this._video.error.MEDIA_ERR_NETWORK:
            return this._fireVideoError("MediaNetworkError", "A network error ocurred while fetching the media."),
            !1;
        case this._video.error.MEDIA_ERR_ABORTED:
            return this._fireVideoError("MediaAbortedError", "The user agent aborted the fetching of the media."),
            !1;
        default:
            return this._fireVideoError("MediaUnknownError", "An unknown error occurred."),
            !1
        }
    }
    ,
    ...
    t.seekToTime = function(e) {
        return this.canSeekTo(e) ? (this._video.currentTime = e,
        Promise.resolve(this._video.currentTime)) : new Promise((t,n)=>{
            const r = ()=>{
    ...
    t.takeSnapshot = function() {
        ...
        e.style.display = "";
        const {width: t, height: n, left: r, top: i} = Po(this._video.clientWidth, this._video.clientHeight, this._video.videoWidth, this._video.videoHeight);
    ...
    t.getTrackById = function(e) {
        if (this._textTracks && this._textTracks[e])
            return this._textTracks[e];
    ...
    t.showExternalDisplayPicker = function(e) {
        if (!this._externalDisplays.length)
            throw new No("ExternalDisplayUnvailable","No external displays are available.");
        if (!e)
        ...
        if (!t)
            throw new No("InvalidExternalDisplay","The specified external display is not available.");
        t.showPicker()
    }
    ,
    ...
    t._initMediaSessionHandlers = function() {
        ...
        navigator.mediaSession.setActionHandler("pause", ()=>{
            this.pause(),
            this.fire(go.MEDIASESSION_PAUSE)
        }
        ),
        navigator.mediaSession.setActionHandler("seekforward", ()=>{
            this.currentTime = Math.min(this.duration, this.currentTime + 10),
            this.fire(go.MEDIASESSION_SEEK_FORWARD)
        }
        ),
        navigator.mediaSession.setActionHandler("seekbackward", ()=>{
            this.currentTime = Math.max(0, this.currentTime - 10),
            this.fire(go.MEDIASESSION_SEEK_BACKWARD)
        }
        ))
    }
    ,
    ue(e, [{
        ...
        set: function(t) {
            ...
            if (i || this.takeSnapshot(),
            this._currentFile = t,
            i && (this._video.preload = this._preload),
            this.constructor === e && this._video.readyState > 0 && (this._video.currentTime = 0),
            (Bt.iOS || Bt.android) && this._currentFile.video.title) {
                let e = this._currentFile.video.title;
                this._currentFile.video.subtitle && (e = `${e} ${this._currentFile.video.subtitle}`),
                this._video.setAttribute("title", e)
            } else
                this._video.removeAttribute("title");
            this.setVideoSrc(this._currentFile.src, i),
            this.fire(po.CURRENT_FILE_CHANGE, t),
            Bt.iOS && !i && this.play().catch(this._onPlayError.bind(this)),
            this.constructor !== e || i ? n && this.play().catch(this._onPlayError.bind(this)) : (this.seekToTime(r).then(e=>(n && this.play().catch(this._onPlayError.bind(this)),
            e)).catch(()=>{}
            ),
        ...
        set: function(e) {
            ...
            e ? this._video.setAttribute("playsinline", "") : this._video.removeAttribute("playsinline")
        }
    }, {
        key: "paused",
        get: function() {
        ...
        set: function(e) {
            ...
            this._telecineVideo !== e) {
                ...
                this._telecineVideo = e,
                this._files = e.files.filter(e=>-1 !== this.constructor.supportedVideoTypes.indexOf(e.mime)),
                ...
                this._options.externalDisplays && this._options.externalDisplays.length) {
                    ...
                    this._options.externalDisplays.filter(e=>e.supported && -1 !== n.indexOf(e.displayName)).forEach(t=>{
                        ...
                        n.on(lo.LOADED_METADATA, e=>this.fire(lo.LOADED_METADATA, e)),
                        n.on("available", ()=>this.fire(fo.AVAILABLE, {
                            type: r
                        })),
                        ...
                        n.on("activated", ()=>{
                            "function" == typeof this.onexternaldisplayactivated && this.onexternaldisplayactivated(n),
                            this.fire(fo.ACTIVATED, {
                                type: r
                            })
                        }
                        ),
                        n.on("deactivated", ()=>{
                            "function" == typeof this.onexternaldisplaydeactivated && this.onexternaldisplaydeactivated(n),
                            this.fire(fo.DEACTIVATED, {
                                type: r
                            })
                        }
                        ),
                ...
                this._updateCurrentFile(),
                Bt.iOS && this._externalDisplays.forEach(e=>{
        ...
        get: function() {
            if (Bt.android && So && So.major < 52)
                return !1;
            const e = Wo.playbackRate;
            Wo.playbackRate = .5 * e;
            const t = e !== Wo.playbackRate;
            return Wo.playbackRate = e,
            t
        }
    }]),
    e
...
let us = function() {
    function e(e={}) {
        const {retryCount: t=3, parallel: n=1, includeWithSpeeds: r=!0, timeout: i=0, retryAbortErrors: o=!0} = e;
        this._queue = [],
    ...
    t.abort = function(e=null) {
        this._queue.filter(t=>!e || e === t.stream).forEach(e=>{
            e.reject(new ts("Stream manually aborted")),
    ...
    t._initialize = function() {
        ...
        window.addEventListener("online", ()=>{
            this.start(),
            this._waitUntilOnline && (this._waitUntilOnline.resolve(),
    ...
    t._fetchOne = function() {
        ...
        const e = this._queue.shift()
          , {url: t, byteRange: n, isInitSegmentRequest: r, identifier: i, timeout: o} = e
          , s = {
            stream: e.stream,
            data: {
                url: t,
        ...
        this.fire("downloadstart", i),
        s.request = pt(c).then(this._makeOnRequestLoad(s, e)).catch(this._makeOnRequestError(s, e)),
        this._activeRequests.add(s)
    }
    ,
    ...
    t._saveResponseSpeeds = function(e, t, n) {
        ...
        if (n > 8e3) {
            ...
            rs.length > 100 && rs.shift(),
            this._includeWithSpeeds && r && rs.push(o)
        }
    }
    ,
    ...
    t._feedMuxer = function(e, t) {
        try {
            ...
            return function(e, t) {
                var r = function() {
                    if (!n._transmuxer)
                        return ss(n._loadMux(), (function(e) {
                            n._transmuxer = new e({
        ...
        get: function() {
            ...
            return this._activeRequests.forEach(t=>{
                if (this._pendingFetchMap.get(t)) {
                    ...
                    n.elapsedTime = es() - t.data.requestSendTime,
                    e.push(n)
                }
            }
            ),
  ...
  , cs = function() {
    ...
    return t.addStream = function(e) {
        ...
        e.index = t,
        null === this._activeStreamIndex && (this._setActiveIndex(t),
    ...
    t.switchTo = function(e, t=!0, n={}) {
        ...
        const o = i;
        if (!i && this._needsStreamSwitch && (i = !0),
        i) {
            this._needsStreamSwitch = !1;
        ...
        new Promise(e=>{
            i ? this._resolveSwitchComplete = ()=>{
                this._switchToIndex === r && (this._resolveSwitchComplete = null,
                e(),
        ...
        if (this._sourceBuffer) {
            if (this.activeStream && "closed" !== this._sorcerer._mediaSource.readyState && !this._sourceBuffer.updating)
                if (this._toRemove.length)
                    ...
                    return this._needInitSegment ? (this._needInitSegment = !1,
                    void this._appendInitSegment()) : void this._appendSegment()
        } else
    ...
    t._appendInitSegment = function() {
        ...
        this.activeStream.getInitSegment().then(e=>(this._lastAppended = null,
...
let ds = function() {
    ...
    ,
    t.addSegment = function(t, {identifier: n=null, isFinalSegment: r=!1, loadOnly: i=!1, priority: o=0, includeWithBandwidthChecks: s=!0, excludeConnectTime: a=!1, timeout: u=null, size: c=null}={}) {
        return this._needInitSegment && this.getInitSegment(),
    ...
    t.getInitSegment = function() {
        ...
        return t ? (this._needInitSegment = !1,
        e.isValidSegmentUrl(t) ? this._fetcher.add({
            url: t,
            ...
            priority: 0
        }).then(e=>(this._initSegment = e,
        this._initSegment)) : Promise.resolve(this._initSegment)) : Promise.resolve(null)
    }
    ,
    ue(e, [{
        key: "codec",
  ...
  , hs = function() {
    ...
    ,
    t._attachEvents = function() {
        this._attached || (this._video.addEventListener("playing", this.bound.startCheckingDroppedFrames),
        ...
        document.addEventListener("visibilitychange", this.bound.handleVisibilityChanged),
        this._attached = !0)
    }
    ,
    t._removeEvents = function() {
        ...
        document.removeEventListener("visibilitychange", this.bound.handleVisibilityChanged),
        this._attached = !1
    }
    ,
    ...
    t._checkDroppedFrames = function() {
        if (!this._running || null === this._streamIndex)
            return;
        if (Bt.browser.safari && (document.hidden || "hidden" === document.visibilityState))
            return;
  ...
  , fs = function() {
    function e(e, t={}) {
        ...
        this._options = t,
        dr(this);
        const {fetcherTimeout: n=0, fetcherRetryAbortErrors: r=!0} = this._options;
        this._frameDropper = new hs(e),
        this._mediaSource = new MediaSource,
        this._fetcher = new us({
            parallel: 1,
            timeout: n,
            retryAbortErrors: r
        }),
    ...
    ,
    t.getCurrentSpeed = function({type: e="average", howMany: t=10, weights: n=[], percentile: r=null}={}) {
        ...
        if (!this._buffersForCodec[n]) {
            ...
            this.readyPromise.then(()=>{
                ...
                try {
                    ...
                    if (22 !== Vd.code)
                        return void this.fire("srcnotsupported", Vd);
    ...
    t.checkEndOfStream = function() {
        if (!this._buffers.every(e=>e.hasAppendedFinalSegment()))
            return;
        const e = ()=>{
            this._video.removeEventListener("timeupdate", e),
            this._buffers.every(e=>e.isTimeInBuffer(this._video.currentTime)) && this.endOfStream()
        }
        ;
    ...
    t.destroy = function() {
        ...
        this._fetcher.abort(),
        this._video.src && (this._video.removeAttribute("src"),
        this._video.load())
    }
    ,
    t._attachEvents = function() {
        this.readyPromise = new Promise((e,t)=>{
            ...
            this._mediaSource.addEventListener("sourceopen", this._boundHandleSourceOpen)
        }
        ),
    ...
    t._handleSourceOpen = function() {
        ...
        this._mediaSource.removeEventListener("sourceopen", this._boundHandleSourceOpen),
  ...
  , _s = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t) || this)._options = n,
        r.blacklisted = [],
        r.whitelisted = [],
    ...
    n.filterStreams = function(e, t, n, r=null) {
        ...
        for (let a = 0; a < e.length; a++)
            if (o && o[0] === e[a].width && o[1] === e[a].height)
                i.push(e[a]);
            else {
                if (s)
                    break;
                this.blacklisted[a] && -1 === this.whitelisted.indexOf(a) || this.whitelisted.length && -1 === this.whitelisted.indexOf(a) || (this.whitelisted.length ? i.push(e[a]) : (this._getScaleFromDimensions(t, n, e[a].width, e[a].height, r) >= (n < 1e3 / (window.devicePixelRatio || 1) ? 1.75 : 1) && (s = !0),
                i.push(e[a]),
                o = [e[a].width, e[a].height]))
            }
        return i
    }
    ,
    n.getCurrentSpeed = function() {
        let e = "average"
          , t = 3
          , n = [1, 2, 5];
        return this._options.tests && this._options.tests.harmonic_average && this._options.tests.harmonic_average.group && (e = "harmonicAverage",
    ...
    n._isSegmentInBuffer = function(e, t, n, r) {
        let i = 1;
        return this._hasSeparateStreams(r) && (i = .1),
...
let ps = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t, n) || this).BANDWIDTH_UPSWITCH_THRESHOLD = .85,
        r.BANDWIDTH_DOWNSWITCH_THRESHOLD = .9,
    ...
    n.canPlayFromTimeInStream = function(e, t) {
        if (!this.isTimeInBuffer(e, this.scanner._video.buffered, this.scanner._video.duration))
            return !1;
        if (!t)
            return !1;
  ...
  , ms = function(e) {
    function t(t, n={}) {
        var r, i, o;
        return (o = e.call(this, t, n) || this)._mimirURL = n.tests.ml_brain.data.mimir_url,
        o._geolocation = n.tests.ml_brain.data.geolocation,
        ...
        o._scannerEventsHandlers = [[po.DOWNLOAD_START, o._handleDownloadStart.bind(ye(o))], [po.DOWNLOAD_END, o._handleDownloadEnd.bind(ye(o))], [po.APPEND_BUFFER_END, o._handleAppendBufferEnd.bind(ye(o))], [po.DOWNLOAD_TIMEOUT, o._handleDownloadTimeout.bind(ye(o))]],
        ...
        (r = se.hooks.beforeRequest).push.apply(r, Ee(o._beforeRequestHooks)),
        (i = se.hooks.afterResponse).push.apply(i, Ee(o._afterResponseHooks)),
        o
    }
    he(t, e),
    ue(t, [{
    ...
    ,
    n._handleDownloadStart = function({identifier: e}) {
    ...
    ,
    n._handleDownloadEnd = function({identifier: e, data: {request: t, response: n}}) {
        const r = t.data.duration / 1e3
          , i = n.body.byteLength;
        let o = null;
        n.perfTimings && (o = n.perfTimings.responseStart - n.perfTimings.connectStart),
        e.type === this.STREAM_TYPE_VIDEO && this._segmentInProgressMatchesIdentifer(e, this.STREAM_TYPE_VIDEO) && (this._videoSegInProgress.complete = {
            downloadTime: r,
            byteLength: i,
            ttfb: o,
            uuid: t.data.uuid
        ...
        e.type === this.STREAM_TYPE_AUDIO && this._segmentInProgressMatchesIdentifer(e, this.STREAM_TYPE_AUDIO) && (this._audioSegInProgress.complete = {
            downloadTime: r,
            byteLength: i,
            ttfb: o,
            uuid: t.data.uuid
    ...
    ,
    n._handleDownloadTimeout = function({identifier: e, data: t}) {
    ...
    n._clearInProgress = function() {
        this._videoSegInProgress = null,
        this._audioSegInProgress = null
    }
    ,
    n._handleAppendBufferEnd = function({identifier: e}) {
        if (e.type === this.STREAM_TYPE_VIDEO && (this._videoBufferAppendCount += 1),
    ...
    n._updateModelInputData = function(e) {
        const {streamIndex: t, segmentIndex: n, segmentDLTime: r, segmentLength: i, ttfb: o, segmentRequestID: s, didSegmentTimeout: a} = e
        ...
        this._prevDistancesFromBuffer.push(Fe(this.scanner.currentTime, c.buffered)),
        ...
        this._prevSegmentRequestIDs.push(s),
    ...
    n.shouldPowerUp = function(e, t, n) {
        ...
        1 === this.whitelisted.length)
            return this.whitelisted[0] > r ? Promise.resolve(0) : Promise.resolve(!1);
        if (1 === this.scanner._streams.video.length)
            return Promise.resolve(!1);
        if (!this.canPowerUp(e, r))
            return Promise.resolve(!1);
        ...
        const o = {
          ...
          , s = i.index;
        if (null !== this._pendingModelFetch && this._pendingModelFetch.index === o.index && this._pendingModelFetch.streamIndex === o.streamIndex)
            return Promise.resolve(!1);
        if (!(s in this._segmentToStreamDecisionMap))
            return this._fetchSegmentQualityFromModel(o, e, t).then(e=>e > r && e).catch(console.error);
    ...
    n.shouldPowerDown = function(e, t) {
        ...
        if (1 === this.whitelisted.length)
            return this.whitelisted[0] < n ? Promise.resolve(0) : Promise.resolve(!1);
        if (1 === this.scanner._streams.video.length)
            return Promise.resolve(!1);
        if (!this.canPowerDown(e, n))
            return Promise.resolve(!1);
        ...
        const i = {
          ...
          , o = r.index;
        if (null !== this._pendingModelFetch && this._pendingModelFetch.index === i.index && this._pendingModelFetch.streamIndex === i.streamIndex)
            return Promise.resolve(!1);
        if (!(o in this._segmentToStreamDecisionMap))
            return this._fetchSegmentQualityFromModel(i, e, t).then(e=>e < n && e).catch(console.error);
        ...
        for (let u = 0; u < t.length; u++) {
            ...
            for (let t = 0; t < s.segments.length; t++)
                if (t === e && a in r) {
                    ...
                    let n = 0;
                    l && l.segments[t] && (n = l.segments[t].size),
                    o[r[a]] = e + n
                }
        }
    ...
    n._afterSegmentQualityFetch = function(e, t) {
        return t.duration = wo(e.startTime),
        t
    }
    ,
    n._fetchSegmentQualityFromModel = function(e, t, n) {
        const r = this._getModelInputs(e.index, t);
        return this._pendingModelFetch = e,
        pt.post(this._mimirURL, {
            json: {
                inputs: r
            },
            timeout: 2e3
            ...
            if (this._segmentToStreamDecisionMap[e.index] = s,
            ...
            return this._prevModelInputs = r,
            ...
            if (t instanceof ze) {
                ...
                this.scanner.fire(yo.BRAIN_ML_MODEL_ERR, e),
            ...
            if (t instanceof Je) {
                ...
                this.scanner.fire(yo.BRAIN_ML_MODEL_TIMEOUT, e),
                this._networkIssueCount++
            }
            if (t instanceof Qe) {
                const e = {
                ...
                this.scanner.fire(yo.BRAIN_ML_MODEL_NET_ERR, e),
                this._networkIssueCount++
            }
            this._networkIssueCount >= 2 && this.scanner.resetBrain(!0);
            const n = e.streamIndex;
            return this._segmentToStreamDecisionMap[e.index] = n,
            this._pendingModelFetch = null,
            n
        }
        )
    ...
    n._getFirstLookaheadSegmentNotInBuffer = function(e) {
        ...
        for (let i = 0; i < r.length; i++) {
            const e = r[i].segment;
            if (!this._isSegmentInBuffer(e, n, this.scanner._video.duration, this.scanner._streams))
                return r[i]
        }
        return null
    }
    ...
    n.getSegmentsToLoad = function(e, t, n) {
        ...
        let o = null;
        i && (o = i.buffered),
        this._clearSegmentsNotInBufferFromDecisionMap(r.map(e=>e.index), o);
        const s = [];
  ...
  , vs = function() {
    function e(e, t) {
        this._video = e,
        this._getCurrentStream = t
    }
    var t = e.prototype;
    return t.start = function() {
        return clearInterval(this._checkGapInterval),
        this._checkGapInterval = setInterval(this._checkGap.bind(this), 200),
        this._checkGap()
    }
    ,
    t.stop = function() {
    ...
    t._checkGap = function() {
        ...
        if (0 === this._video.readyState)
            return !1;
        if (this._video.paused)
            return !1;
        const r = this._video.duration;
        if (t >= r)
            return this._video.currentTime = r - .1,
            !0;
        if (e.length <= n)
            return !1;
        const i = e.start(n);
        return !(i >= r || i - t > .5 || 0 !== n || (this.stop(),
...
let gs = function() {
    ...
    t._getLog = function(e, t) {
        let n = {};
        return Object.assign(n, this._getStaticSessionData()),
                    ...
                    return function(o, s) {
                        try {
                            var a = ys(Promise.all(e.map((function(e) {
                                ...
                                if (o) {
                                    if (n = function(e, t) {
                                        return e.filter((e,n)=>Es.every(e=>t[n][e]) || (As(`Stream ${e.quality} is not supported`, t[n]),
                                        !1))
                                    }(e, o),
                                    0 === n.length)
                                        return As("No compatible streams found. Returning all available streams as safeguard."),
                                        t = !0,
                                        {
                                            compatibleStreams: e,
                                    ...
                                    n.length < e.length ? (r = e.filter(e=>-1 === n.indexOf(e)),
                                    i = r.map(Rs),
                                    As("Some streams are not supported. Returning compatible streams.")) : As("All streams are supported.")
                                }
                            }
                            ))
                        } catch (Vd) {
...
let Os = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t, n) || this).reset(),
        r.manifestLoadDurations = [],
        r._preserveCurrentTime = !1,
        n.mediaSourceScanner && (r._maxPreloadStreamIndex = n.mediaSourceScanner.maxPreloadStreamIndex),
        r
    }
    he(t, e),
    ue(t, null, [{
    ...
    n.reset = function() {
        ...
        Bt.browser.safari && (this._gapJumper = new vs(this._video,this._getCurrentStream.bind(this))),
        this.resetBrain(),
    ...
    n.resetBrain = function(e=!1) {
        ...
        const n = Bt.ie;
        if (this._brain && this._brain.destroy(),
        e || n) {
            const e = Mo(this._brain);
            return this._brain = new ps(this,t),
            void ((e || n) && this.fire(yo.BRAIN_ML_SWITCH_TO_SKYFIRE))
        }
    ...
    n.preloadStream = function() {
        if (this._preloadStream)
            return this._preloadStream;
        let e = 0
          , t = 1;
        ...
        const s = (e=!1)=>{
          ...
          , a = n=>{
            e += 1,
            e < t || (n.segment === r && 0 === this._restrictedStreamIndexes.length ? this._getStreamIndexToLoadAndSwitchReason(!0).then(t=>{
                let {index: r, reasonForSwitch: i} = t
                  , a = {
                    reasonForSwitch: i
                };
                if (!1 !== r && r > n.stream) {
                    if (this.sorcerer.video.switchTo(r, !1, a),
        ...
        return this._preloadStream = new Promise((e,t)=>{
            o = ()=>{
                ...
                if (this.currentTime >= r && (this.currentTime = r),
                this.currentTime > t && (this.sorcerer.clear(),
                this._waitingOnSet = new Set),
        ...
        try {
            ...
            return Ps(t.video.metadata.p2pReady, (function() {
                ...
                new Promise(()=>{}
                    ...
                    timeout: 1e4,
                    type: oe.MANIFEST
                }).then(r=>(r.url && r.url !== e && -1 !== r.url.indexOf("live-archive") && (t._baseUrl = r.url.split("/").slice(0, -2).join("/")),
                t.manifestLoadDurations.push({
                    url: e,
                    status: r.status,
                    duration: Date.now() - n
                }),
                t.fire(po.MANIFEST_LOADED),
                r.text())).then(Ds((function(n) {
                    let r;
                    return function(i, o) {
                        var s = function() {
                            if (-1 !== e.indexOf(".mpd"))
                                return Ps(t._loadMediaManifest(), (function({parseMPD: t}) {
                                    r = t(n, e)
                                }
                                ));
                            r = JSON.parse(n)
                    ...
                    t.reset(),
                    r instanceof ze && 410 === r.response.status)
                        return t.fire(po.MEDIA_URL_EXPIRED),
                        new Promise(()=>{}
                        );
                    throw r instanceof ze && 400 === r.response.status ? t.fire(po.MEDIA_URL_BAD_REQUEST, r.response.url) : r instanceof Je && t.fire(po.MANIFEST_TIMEOUT),
                    r
                }
                )
            }
    ...
    n.setVideoSrc = function(e, t, n=!0) {
        if (n && !t && this._onReady) {
            var r;
            if (("metadata" === this._preload || "none" === this._preload && !this.paused) && !this._ready)
                return void this._onReady.then(()=>{
                    const t = this.paused;
                    this.setVideoSrc(e, t, !1)
                }
                ).catch(console.error);
            if ("sd-fallback" === (null == (r = this._telecineVideo.drmHandler) ? void 0 : r.state))
                return void this._onReady.then(()=>{
        ...
        t && this.reset(),
        t || !this.paused || this.sorcerer || (t = !0);
        ...
        this._onReady = this._startPreload(e, this._preload).then(this.loadManifest.bind(this)).then(e=>("string" == typeof this._baseUrl && -1 !== this._baseUrl.indexOf("live-archive") || (this._baseUrl = s),
        e)).then(i.bind(this)),
    ...
    n.lockStreamIndexes = function() {
        ...
        this.sorcerer.removeBuffer(n, r).then(()=>{
            !this._startedPlaying && "auto" === this._preload || this.ended ? this._loadSegments() : (this.seekToTime(this.currentTime),
            t && this.paused && (this._ignorePlayEvent = !0,
            this._video.play()))
        }
        ).catch(console.error)
    }
    ...
    n.seekToTime = function(e) {
        ...
        if (t || (this._lastSeekReject && (this._lastSeekReject(),
        ...
        Promise.all([this._onReady, this._removeBufferPromise]).then(()=>{
            this._loadSegments()
        }
        ).catch(console.error),
        this._paused && 0 === e && this.fire(lo.SEEKING),
    ...
    n.onended = function(t) {
        return e.prototype.onended.call(this, t),
        !0
    }
    ,
    ...
    n._scrubStart = function() {
        ...
        Mo(this._brain) && (this._brain.scrubInProgress = !0))
    }
    ,
    ...
    n.ontimeupdate = function(t) {
        if (!this.sorcerer)
            return !1;
        if (e.prototype.ontimeupdate.call(this),
    ...
    n._loadSegmentsIntervalTick = function() {
        ...
        if (null !== this._preloadSegmentStreamIndex) {
            try {
                ...
                return this._handleLoadSegmentFailures(Vd),
                !1
            }
            return !0
        }
        if (0 === this.currentTime && !this._ready)
            return this._startedPlaying;
        const e = this._loadSegments();
        return e && "function" == typeof e.catch && e.catch(this._handleLoadSegmentFailures.bind(this)),
        !0
    }
    ,
    n._handleLoadSegmentFailures = function(e) {
        e.code === DOMException.INVALID_STATE_ERR ? this.fire(po.SCANNER_ERROR, {
            reason: e
        }) : this.fire(po.LOAD_SEGMENT_FAILED, new No(`${po.LOAD_SEGMENT_FAILED} - ${e.name}`,e.message)),
        clearInterval(this._loadSegmentsInterval)
    }
    ,
    n.onprogress = function() {
        this._brain.canPlayFromTimeInStream(this.currentTime, this._getCurrentStream()) && this._ranIntoBuffer && (this.fire(po.STREAM_BUFFER_END),
        this._ranIntoBuffer = !1)
    }
    ,
    ...
    n.onerror = function() {
        ...
        !1) : this._video.error.code === this._video.error.MEDIA_ERR_SRC_NOT_SUPPORTED ? (this._preserveCurrentTime = !0,
    ...
    ,
    n.play = function() {
        return this._restartLoadSegmentsIntervalWithBackoff(),
        e.prototype.play.call(this, ()=>(this._resolveStartPreload && this._resolveStartPreload(),
        ...
        this._onReady.then(()=>Promise.resolve(this._seekInProgressPromise))))
    }
    ,
    n.onpause = function() {
        return this._ignorePauseEvent ? (this._ignorePauseEvent = !1,
        !1) : (e.prototype.onpause.call(this),
        !0)
    }
    ,
    n.onplay = function() {
    ...
    n._addCallbackToPromise = function(e, t, n=!0) {
        let r = e.then(t);
        return n && (r = this._addCatchToPromise(r)),
        r
    }
    ,
    ...
    n._getSeekReadyPromiseForTime = function(e=this._timeToSeekTo) {
        return new Promise((t,n)=>{
            ...
            r || i ? t(e) : (this._handleBufferForSeek(),
            this._resolveSeek = t)
        }
        ).then(e=>{
            this._timeToSeekTo = null,
    ...
    n._initializeManifest = function(e) {
        ...
        return new Promise(Ds((function(n, r) {
            ...
            e.audio) {
                ...
                if (n > 0)
                    return t.fire(po.AV_DURATION_MISMATCH, n),
                    t.fire(po.SCANNER_ERROR, {
            ...
            return Mo(t._brain) && t._streams.audio.length > 0 && (t._brain.audioStreams = t._streams.audio),
            t._initDrm(t._streams.video, t._streams.audio, t._manifest.key_info),
            t._manifestContainsSegmentSizes(e) || t.resetBrain(!0),
            t.fire(po.STREAMS_LOADED, t._streams),
            Ps(ws(t._streams.video), (function({compatibleStreams: e, incompatibleStreams: r, incompatibleStreamsAttributes: i}) {
                t._streams.video = e,
                r.length && (t.fire(po.AVAILABLE_STREAMS_CHANGED),
                t.fire(po.MEDIA_CAPABILITY_STREAMS_UNSUPPORTED, {
                    incompatibleStreams: r,
                    incompatibleStreamsAttributes: i
                })),
                n()
    ...
    n._initialize = function(e) {
        return this._initializeManifest(e).then(()=>{
            ...
            this._restrictedStreamIndexes.length && (r = this._streams.video[this._restrictedStreamIndexes[0]]),
            void 0 !== this._maxPreloadStreamIndex && n <= this._streams.video.indexOf(e.video[this._maxPreloadStreamIndex]) && (r = this._streams.video[n]),
            ...
            this.sorcerer.on("appendbufferend", this._handleAppendBufferEnd.bind(this)),
            this.sorcerer.on("downloadstart", this._handleDownloadStart.bind(this)),
            this.sorcerer.on("downloadend", this._handleDownloadEnd.bind(this)),
            this.sorcerer.on("downloaderror", this._handleDownloadError.bind(this)),
            this.sorcerer.on("downloadtimeout", this._handleDownloadTimeout.bind(this)),
            this.sorcerer.on("quotaexceedederror", this._handleQuotaExceededError.bind(this)),
            this.sorcerer.video.on("streamchange", this._handleStreamChange.bind(this)),
            this.sorcerer.video.on("streamchangestart", this._handleStreamChangeStart.bind(this)),
    ...
    n._getSegmentUrl = function(e, t, n="video", r=!1) {
        if ("init" === t && !this._streams[n][e].init_segment_range && -1 === this._streams[n][e].init_segment.indexOf("."))
            return function(e) {
                return ko(e).buffer
            }(this._streams[n][e].init_segment);
        let i = this._baseUrl;
        const o = this._manifest.base_url && -1 !== this._manifest.base_url.indexOf("//");
        if (o && (i = this._manifest.base_url),
        this._manifest.base_url && !o && (i += this._manifest.base_url),
        this._streams[n][e].base_url && (i += this._streams[n][e].base_url),
        this._useRangeRequests(e, n))
            return i;
        if ("init" === t)
            return i += this._streams[n][e].init_segment,
            i;
        const s = this._streams[n][e].segments[t];
        s.url && (i += s.url);
        const a = -1 !== i.indexOf("akamaized")
          , u = -1 === i.indexOf("?") ? "?" : "&";
        return r && this.CMCDLogger && a && (i += `${u}${this.CMCDLogger.getLogAsQueryParam(s, n)}`),
        i
    }
    ,
    ...
    n._getCurrentStream = function(e=0, t="video") {
        return void 0 !== this.sorcerer && (e = this.sorcerer[t].activeStreamIndex),
        this._streams[t][e]
    }
    ,
    n._getStreamIndexToLoadAndSwitchReason = function(e) {
        ...
        if (t = this._brain.filterStreams(t, this._video.clientWidth, this._video.clientHeight, n),
        0 === t.length)
            return Promise.resolve({
                index: !1,
                reasonForSwitch: null
            });
        if (this._switching.video && !Mo(this._brain))
            return Promise.resolve({
                index: !1,
                reasonForSwitch: null
            });
    ...
    n._loadSegmentsForType = function(e="video") {
        return this._getStreamIndexToLoadAndSwitchReason(!1).then(t=>{
            ...
            "audio" === e && (!1 === n && (n = this.sorcerer.video.activeStreamIndex),
            n = this._brain.getAudioIndexFromVideo(this._streams.video, this._streams.audio, n),
            this.sorcerer.audio.activeStreamIndex === n && (n = !1));
            let o = !1;
            !1 !== n && (o = n > this.sorcerer[e].activeStreamIndex,
            this._switching[e] = !0,
            this.sorcerer[e].switchTo(n, !0, i).then(()=>{
                this._switching[e] = !1
            }
            ).catch(console.error));
            let s = o;
    ...
    n._loadSegments = function() {
        return this._onReady && this._onReady.then(e=>{
            const t = [];
            for (const n in this._streams)
                this._streams[n].length > 0 && t.push(this._loadSegmentsForType(n));
    ...
    n._handleQueued = function(e) {
        ...
        -1 === this._streamsForSegment[e.segment].indexOf(e.stream) && this._streamsForSegment[e.segment].push(e.stream)
    }
    ,
    ...
    n._handleAppendBufferEnd = function(e) {
        ...
        this._clearBufferAtTime = this._streams.video[e.stream].segments[e.segment].start),
        this._streamsForSegment[e.segment] && this._clearWaitingOn(e);
        const t = this._brain.canPlayFromTimeInStream(this._timeToSeekTo, this._getCurrentStream());
        null !== this._timeToSeekTo && this._resolveSeek && t && (this._resolveSeek(this._timeToSeekTo),
        this._resolveSeek = null),
    ...
    n._handleDownloadError = function(e, t) {
        ...
        410 === t && (n = po.MEDIA_URL_EXPIRED),
        502 === t && this.video.metadata.drm && (n = po.DRM_FAILURE),
        this.fire(n, {
            identifier: e,
            status: t
        })
    ...
    n._handleDownloadTimeout = function(e, t) {
        ...
        this._streamsForSegment[e.segment] && this._clearWaitingOn(e),
        "video" === e.type ? this._switching.video = !1 : "audio" === e.type && (this._switching.audio = !1)
    }
    ,
    ...
    n._handleStreamChange = function(e, t) {
        e > this._lastStreamIndex && this.currentTime > 0 && (this._checkSwitchUp = !0),
    ...
    n._initDrm = function(e=[], t=[], n={}) {
        ...
        r.init(this, i, n),
        r.setFallbackCallback(()=>this.pause())
    }
    ,
    ...
    ue(t, [{
        ...
        set: function(e=[]) {
            ...
            this._onReady.then(()=>this.lockStreamIndexes()).catch(console.error))
        }
    }, {
        key: "currentTime",
        get: function() {
  ...
  , Ls = function() {
    function e(e) {
        this._scanner = e,
        this._currentTime = 0,
        this._latencyInterval = setInterval(this._onLatencyInterval.bind(this), 500)
    }
    var t = e.prototype;
    return t.destroy = function() {
    ...
    t._onLatencyInterval = function() {
        ...
        null !== n && (this._latency = n,
        this._scanner.fire(mo.LATENCY_UPDATED, n),
        this._scanner.lowLatencyMode && (Bt.browser.ie || Bt.browser.safari || null !== this._scanner.presentationDelay && (e.playbackRate = 1)))
    }
    ,
...
let Ms = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t, n) || this)._UPSHIFT_BANDWIDTH_THRESHOLD = .4,
        r._DOWNSHIFT_BANDWIDTH_THRESHOLD = .6,
    ...
    return n.optimalStream = function(e, t) {
        ...
        for (let f = 0; f < e.length; f++)
            i * this._UPSHIFT_BANDWIDTH_THRESHOLD > e[f].bandwidth && (o = f),
            i * this._DOWNSHIFT_BANDWIDTH_THRESHOLD > e[f].bandwidth && (s = f);
        const a = t < o ? o : s;
        this._clearConsecutiveStreamIndexes(a),
        this.consecutiveStreamIndex[a]++;
        ...
        return d && 0 !== d.length ? d.end(d.length - 1) - l.currentTime < c ? {
            index: 0 !== t ? t - 1 : 0,
            reasonForSwitch: 1
        } : t > 0 && !isNaN(h) && this.hasTooManyDroppedFrames(t, this.scanner.getCurrentStream(), h) ? (this.blacklist(t),
        this.scanner.fire(po.DROPPED_FRAME_PERCENT_EXCEEDED),
        {
            index: t - 1,
            reasonForSwitch: 2
    ...
    n.getSegmentsToLoad = function(e, t, n) {
        var r, i, o, s;
        const {currentTime: a, liveTailTime: u, sorcerer: c, bufferTarget: l, atLiveEdge: d} = this.scanner
          , h = null == (r = c[t]) || null == (i = r.sourceBuffer) ? void 0 : i.buffered
          , f = (null == h ? void 0 : h.length) ? h.start(h.length - 1) : 0
          , _ = je(Math.max(a, f), h);
        if (!e && _ >= l)
            return [];
        const p = Math.max(a, u)
          , m = d ? n.edge : p
          ...
          , E = [].concat(Ee(n.segments), Ee(null !== (s = n.parts) && void 0 !== s ? s : []))
          , T = (y ? n.parts : E).filter(t=>!!t.uri && (e || !this.scanner.isSegmentAdded(t)) && !(t.end < v || t.start > g));
        return y && T.forEach((e,t)=>{
            for (; e = e.dependentOn; )
                T.includes(e) || this.scanner.isStreamSegmentAdded(e) || T.splice(t, 0, e)
        }
        ),
        c[t].activeStreamIndex,
        T
    }
    ,
...
const Ns = ["disabled", "hidden", "showing"]
  ...
  , js = new WeakMap;
let Bs = function() {
    function e({kind: e, src: t=null, label: n="", language: r="", id: i=Ro()}, o) {
        if (-1 === xs.indexOf(e))
            throw Fo(12, "SYNTAX_ERR", "Syntax Error");
        dr(this),
    ...
    ue(e, [{
        ...
        set: function(e) {
            js.set(this, e),
            this.video.fire(po.TEXT_SRC_UPDATE, this)
        }
    }, {
        key: "cues",
        get: function() {
...
function $s(e, t) {
    if (!t)
        return e && e.then ? e.then(Ws) : Promise.resolve()
}
const zs = Bt.browser.ie || Bt.browser.edge ? .5 : .2;
let Qs = function(e) {
    function t(t, n={}) {
        var r, i, o, s, a, u, c, l;
        return (l = e.call(this, t, n) || this)._playInitiated = !1,
        l._captionsVisible = !1,
        l._captionsLoading = !1,
        l._atLiveEdge = !0,
        l._atLiveTail = !1,
        l._STREAM_SWITCH_CHECK_INTERVAL = 2e3,
        l._DOWN_SHIFT_CHECK_INTERVAL = 1e4,
        l.reset(),
        l.defaultPresentationDelay = null !== (r = n.presentationDelay) && void 0 !== r ? r : n.lowLatencyMode ? 3 : 12,
        l.defaultBufferTarget = n.lowLatencyMode ? 3 : 12,
        l.bufferTarget = l.defaultBufferTarget,
        l.presentationDelay = l.defaultPresentationDelay,
        l.lowLatencyMode = null !== (i = n.lowLatencyMode) && void 0 !== i && i,
        l.disableDeltaUpdates = null !== (o = n.disableDeltaUpdates) && void 0 !== o && o,
        Object.defineProperty(ye(l), "eventIsLowLatency", {
        ...
        l._timeoutTest = null == (u = l._options.tests) || null == (c = u.llhls_timeout) ? void 0 : c.group,
        window.addEventListener("online", ()=>{
            l.play()
        }
        ),
    ...
    n.reset = function() {
        ...
        this._timeToSeekTo = null,
        this._resolveSeek = null,
        this._abr = new Ms(this,this._options),
        this._latencyController = new Ls(this),
        this._restrictedStreamIndexes = [],
        this._switching = {},
        this._segmentsAdded = {},
        this._captionsAddedToTextTrack = {},
        this._captionsAddedToTranscript = {},
        this._fetchedCues = {}
    }
    ,
    n.endLive = function() {
        ...
        this.eventHasDVREnabled && !this.atLiveEdge || (null == (t = this._manifestLoader) || t.stop(),
        this._sorcerer && (this._sorcerer.abortFetches(),
        this._sorcerer.endOfStream()),
        this.eventHasDVREnabled || e.prototype.deactivate.call(this),
        this.fire(lo.ENDED))
    }
    ,
    n._signalOnline = function() {
        this._isOnline || (this._isOnline = !0,
        this.fire(mo.STREAM_ONLINE))
    }
    ,
    n._signalOffline = function() {
        this._isOnline && (this._isOnline = !1,
    ...
    n._loadManifest = function(e) {
        try {
            const t = this;
            if (t._hasLiveEventEnded)
                return;
            t._manifestLoader && (t._manifestLoader.stop(),
            t._manifestLoader.off());
            let n = [t._loadMediaManifest()];
            return t.video.metadata.p2pReady && n.push(t.video.metadata.p2pReady),
            Xs(Promise.allSettled(n), (function([n]) {
                const {M3U8Loader: r, PLAYLIST_UPDATE: i, PLAYLIST_ERROR: o, convertTsCodecs: s} = n.value;
                return t._manifestLoader = new r({
                    disableDeltaUpdates: t.disableDeltaUpdates
                }),
                t._manifestLoader.lowLatencyMode = t.lowLatencyMode,
                t._manifestLoader.dvrEnabled = t.eventHasDVREnabled,
                t._manifestLoader.on(i, t._onPlaylistUpdate.bind(t)),
                t._manifestLoader.on(o, e=>{
                    t._signalOffline()
                }
                ),
                Gs(qs((function() {
                    ...
                    t._streams.audio = Js(Ae(Ie(t._streams.video, ({audio: e})=>e)));
                    const {index: n, reasonForSwitch: r} = t._getStream("video", !0);
                    let i = {
                        reasonForSwitch: r
                    };
                    return Xs(t._manifestLoader.switchTo("video", n), (function() {
                        ...
                        if (t._streams.audio.length) {
                            ...
                            e = n,
                            r.push(t._manifestLoader.switchTo("audio", e))
                        }
                        ...
                        return Xs(Promise.all(r), (function() {
                            ...
                            t.fire(po.STREAMS_LOADED, t._streams),
                            t.manifest.captions && t.manifest.captions.length > 0 && (t.manifest.captions.forEach(t._loadTextTrack.bind(t)),
                            t.fire(po.TEXT_TRACKS_AVAILABLE)),
                            t._setUpMediaSorcererEvents(),
                            t._sorcerer.video.switchTo(n, !1, i),
                            t._streams.audio.length && (null == (o = t._sorcerer.audio) || o.switchTo(e, !1))
                        }
                        ))
                    }
                    ))
    ...
    n._setUpMediaSorcererEvents = function() {
        this._sorcerer.video.on("streamchange", this._handleStreamChange.bind(this)),
        this._sorcerer.video.on("streamchangestart", this._handleStreamChangeStart.bind(this)),
        this._sorcerer.on("downloadend", this._handleDownloadEnd.bind(this)),
        this._sorcerer.on("downloadtimeout", this._handleDownloadTimeout.bind(this)),
        this._sorcerer.on("downloadabort", this._handleDownloadAbort.bind(this)),
        this._sorcerer.on("appendbufferend", this._handleBufferAppend.bind(this))
    }
    ,
    n._handleDownloadEnd = function(e, t) {
        if (e && e.isInitSegmentRequest)
            return;
    ...
    ,
    n._handleDownloadTimeout = function(e, t) {
        e && e.isInitSegmentRequest || (this._key(e),
    ...
    n._handleBufferAppend = function(e) {
        var t;
        const {type: n, stream: r} = e
          , i = this.sorcerer[n].sourceBuffer.buffered
          , o = this._getSegmentById(e);
        if (o && i.length && (this._streams[n][r].playlist.timeOffset = i.end(i.length - 1) - (o.end - o.timeOffset)),
        null === this._timeToSeekTo || !this._resolveSeek)
            return;
        const s = this._firstBufferAheadIndex(this.currentTime, i)
          , a = null !== (t = null == i ? void 0 : i.start(s)) && void 0 !== t ? t : 0
          , u = je(a, i);
        void 0 !== s && u > this.bufferTarget ? (Number((a - this.currentTime).toFixed(3)),
        this.currentTime = a) : (this._timeToSeekTo < this.liveTailTime && (this._timeToSeekTo = this.liveTailTime),
        this._abr.canPlayFromTimeInStream(this._timeToSeekTo, this._getCurrentStream()) && (this._resolveSeek(this._timeToSeekTo),
        this._resolveSeek = null))
    }
    ,
    ...
    ,
    n._getSegmentById = function({type: e, stream: t, segment: n, part: r}) {
    ...
    n._onPlaylistUpdate = function(e, t) {
        try {
            ...
            const i = this
              , {type: o} = e;
            var r;
            return null == (n = i._sorcerer) || n.setLiveSeekableRange(i.liveTailTime, i.liveEdgeTime),
            i.fire(po.STREAM_UPDATED, e),
            "subtitles" === o ? void ((i._captionsVisible || i._captionsLoading) && (null == (r = i.manifest.captions) ? void 0 : r.length) > 0 && i._addTextTrackCue()) : (t || i._loadSegmentsForType(o),
            i._toggleConnection(i._hasNewSegments(o) || !i._atDurationEnd()),
            i._checkForPlaybackGap(),
            (i.lowLatencyMode || i.video.metadata.p2pReady) && i._checkForPlaybackStall(),
            Xs())
        } catch (Vd) {
            return Promise.reject(Vd)
        }
    ...
    n._loadTextTrack = function({label: e, language: t}, n) {
        if (!this._captionsTrack) {
            ...
            this._telecineVideo.textTracks = Ao([r]),
    ...
    n._getSegmentCues = function(e) {
        try {
            ...
            return Ks((function() {
                if (!t._fetchedCues[n])
                    return Xs(pt(e.url).text(), (function(e) {
                        const r = Hs(e)
                          , i = function(e) {
                            const t = e.match(/=MPEGTS:(\d+),/);
                            return (t && t[1] || 0) / 9e4
                        }(e)
                          , o = r.map(e=>(e.startTime = i + e.startTime,
                        e.endTime = i + e.endTime,
                        new (window.VTTCue || window.TextTrackCue)(e.startTime,e.endTime,e.text)));
                        t._fetchedCues[n] = o
                    }
                    ))
            }
            ...
            return Xs(e._videoReady, (function() {
                e.manifest.captions && e.manifest.captions[0].segments.forEach(Ys((function(t) {
                    ...
                    return function(o) {
                        var s = function() {
                            if (r || i)
                                return Xs(e._getSegmentCues(t), (function(t) {
                                    r && (e._captionsAddedToTextTrack[n] = !0,
                                    t.forEach(t=>{
                                        e._captionsTrack.addCue(t)
                                    }
                                    )),
                                    i && (e._captionsAddedToTranscript[n] = !0,
                                    e.fire(po.SEGMENT_CUES_LOADED, t))
                                }
                                ))
                        }();
                        if (s && s.then)
            ...
            return Xs(t._videoReady, (function() {
                ...
                return Ks((function() {
                    if (n >= 0 && n !== t.sorcerer[e].activeStreamIndex)
                        return i = n > t.sorcerer[e].activeStreamIndex,
                        t._switching[e] = !0,
                        Xs(t._manifestLoader.switchTo(e, n), (function() {
                            let i = {
                                reasonForSwitch: r
                            };
    ...
    n._preventExpiredSegmentUsage = function(e) {
        ...
        return r && n && !n.startsWith(r) && (n = `${r}${e.uri}`),
        n
    }
    ,
    n._getStream = function(e, t=!1) {
        var n, r;
        if (this._switching[e])
            return {
                index: -1,
                reasonForSwitch: null
            };
        ...
        if (!t && wo(this._timeSinceLastStreamSwitchCheck) < this._STREAM_SWITCH_CHECK_INTERVAL)
            return {
        ...
        const {index: s, reasonForSwitch: a} = this._abr.optimalStream(o, this._lastStreamIndex)
          , u = o[s]
          , c = this._streams.video.indexOf(u);
        if (c >= 0 && (t || c !== this._lastStreamIndex)) {
            if (c > this._lastStreamIndex && wo(this._timeSinceLastDownShift) < this._DOWN_SHIFT_CHECK_INTERVAL)
                return {
                    index: this._lastStreamIndex,
                    reasonForSwitch: a
                };
            ...
            return this.fire(po.STREAM_TARGET_CHANGE, e),
    ...
    n._getCurrentStream = function(e="video", t=0) {
        return void 0 !== this._sorcerer && null !== this._sorcerer && (t = this._sorcerer[e].activeStreamIndex),
        this._streams[e][t]
    }
    ,
    ...
    n.ontimeupdate = function() {
        ...
        this._shouldSnapToLiveEdge(this._video.currentTime) ? this.atLiveEdge = !0 : (this._video.playbackRate < 1 || this._hasDriftedBehindLiveEdge()) && (this.atLiveEdge = !1),
        this.fire(po.DROPPED_FRAMES, this._sorcerer.getDroppedFrameTotal());
        ...
        !this._isOnline && this._atDurationEnd() && this.fire(mo.STREAM_OFFLINE),
        !this.lowLatencyMode && wo(this._timeSinceLastStreamSwitchCheck) > this._STREAM_SWITCH_CHECK_INTERVAL && this._loadSegments()
    }
    ,
    ...
    n._getSeekReadyPromiseForTime = function(e=this._timeToSeekTo) {
        ...
        ).then(e=>(this._timeToSeekTo = null,
        this._seekInProgressPromise = null,
        this._video.currentTime = e,
        new Promise((e,t)=>{
            this._lastSeekReject = t;
    ...
    ,
    n.seekToTime = function(e) {
        if (!this.eventHasDVREnabled || e === this.currentTime)
            return Promise.resolve();
        const t = null === this._timeToSeekTo;
        let n;
        if (t || (this._lastSeekReject && (this._lastSeekReject(),
        ...
        return this._seekInProgressPromise = this._getSeekReadyPromiseForTime(e),
        Promise.all([this._videoReady, n]).then(()=>(this._loadSegments(),
        t || this.play().catch(this._onPlayError.bind(this)),
        this._seekInProgressPromise)).catch(e=>{}
        )
    }
    ,
    n.onpause = function() {
        ...
        this.eventHasDVREnabled ? this.atLiveEdge = !1 : (null == (t = this._manifestLoader) || t.stop(),
        this._sorcerer && (this._sorcerer.abortFetches(),
        this._segmentsAdded = {},
    ...
    ,
    n.pause = function() {
        this.eventHasDVREnabled && (this.atLiveEdge = !1),
        e.prototype.pause.call(this)
    }
    ,
    n.play = function() {
        ...
        return e.prototype.play.call(this, Ys((function() {
            return t._preloadReady.resolve(),
            null !== t._timeToSeekTo ? Promise.resolve(t._seekInProgressPromise) : Ks((function() {
                if (t._playInitiated && !t.eventHasDVREnabled)
                    return t._segmentsAdded = {},
                    Gs(qs((function() {
                ...
                return Xs(t._videoReady, (function() {
                    return t._loadSegments(),
                    Xs(t._bufferAvailable(), (function() {
                        const e = Math.max(t._latencyController.liveSyncPosition, t._video.buffered.start(0));
                        return t._atLiveEdge ? t.currentTime = e : t.currentTime = t._video.currentTime,
                        t._playInitiated = !0,
                        Promise.resolve()
                    }
                    ))
    ...
    n._bufferAvailable = function() {
        return new Promise(e=>{
            const t = ()=>{
                this.buffered.length && (this._sorcerer.off("appendbufferend", t),
                e())
            }
            ;
            this._sorcerer.on("appendbufferend", t),
            t()
        }
        )
    }
    ...
    ue(t, [{
        ...
        set: function(e) {
            this._video.readyState <= 0 || (this.eventHasDVREnabled && this._playInitiated ? this._shouldSnapToLiveEdge(e) ? (this.atLiveEdge = !0,
            this.seekToTime(this.liveEdgeTime)) : (this.atLiveEdge = !1,
            this.seekToTime(Math.max(e, this.liveTailTime))) : this._video.currentTime = e)
        }
    }, {
        key: "liveEdgeTime",
        get: function() {
        ...
        set: function(e) {
            this.atLiveEdge !== e && this.eventHasDVREnabled && (this._atLiveEdge = e,
            this._video.playbackRate > 1 && e && (this._video.playbackRate = 1),
            this.lowLatencyMode = !!this.eventIsLowLatency && e,
            this.bufferTarget = e ? this.defaultBufferTarget : 18,
            e && (this.presentationDelay = this.defaultPresentationDelay))
        }
    }, {
        key: "atLiveTail",
        get: function() {
        ...
        set: function(e) {
            this.atLiveTail !== e && this.eventHasDVREnabled && (this._atLiveTail = e,
            this._video.playbackRate < 1 && e && (this._video.playbackRate = 1))
        }
    }, {
        key: "liveTailTime",
...
let ta = function(e) {
    function t(t, n={}) {
        var r, i;
        return (i = e.call(this, t, n) || this)._apiManifestUrl = null,
        i._playInitiated = !1,
        i._atLiveEdge = !0,
        i._atLiveTail = !1,
        i._secondsBehindPlaylistStart = 0,
        i._playlistOffsetSet = !1,
        i.reset(),
        i.dvrEnabled = null !== (r = n.dvrEnabled) && void 0 !== r && r,
        i.getLiveEventStartTimeEpoch = n.getLiveEventStartTimeEpoch,
        window.addEventListener("online", ()=>{
            i.play()
        }
        ),
    ...
    ue(t, null, [{
        ...
        get: function() {
            const e = [];
            if ("function" != typeof Zs.canPlayType)
                return e;
            for (const t in ea) {
                const n = ea[t];
    ...
    ,
    n.reset = function() {
        this._manifestRefreshTimeout && clearTimeout(this._manifestRefreshTimeout),
        this._onReady = null,
    ...
    n._refreshLiveApiPlaylistUrl = function(e=0) {
        ...
        return pt(t).json().then(n=>{
            if (!("url"in n))
                throw new Error(`Error parsing 'url' key from player live API refresh endpoint: ${t} ${n}`);
            return this._loadNativeHlsManifest(n.url.hls).then(()=>(this.play(),
            this._checkHlsAvailability(5e3),
            null)).catch(()=>this._refreshLiveApiPlaylistUrl(++e))
        }
        ).catch(()=>{
            if (e >= 3)
                throw new Error(`Manifest failed to load after ${e} attempts.`);
            return ++e,
            this._refreshLiveApiPlaylistUrl(e)
        }
        )
    }
    ,
    ...
    n._setUpNativeHls = function(e) {
        return this._setUpLiveEventListeners(),
        this._isOnline = !0,
        this.fire(mo.STREAM_ONLINE),
        this._checkHlsAvailability(5e3),
        Promise.resolve(e)
    ...
    n._loadNativeHlsManifest = function(e) {
        return this._apiManifestUrl = e,
        /json=1/.test(e) ? pt(e).json().then(e=>{
            if (!("url"in e))
                throw new Error(`Error parsing 'url' key from Live API manifest endpoint: ${this._apiManifestUrl} ${e}`);
            this._video.src = this._getUrlWithMinSecondsParam(e.url),
            ...
            return pt(t).json().then(e=>{
                if (!("url"in e))
                    throw new Error(`Error parsing 'url' key from player live API refresh endpoint: ${t} ${e}`);
                this._apiManifestUrl = e.url.ios,
                this._video.src = this._getUrlWithMinSecondsParam(e.url.ios),
                this._setUpRefreshTimer()
            }
            )
        }
        ) : (this._video.src = this._getUrlWithMinSecondsParam(e),
        this._setUpRefreshTimer(),
        Promise.resolve())
    }
    ,
    n._getUrlWithMinSecondsParam = function(e) {
        if (this.dvrEnabled)
            return e;
        const t = new URL(e);
        return t.searchParams.set("min_seconds", "30"),
        t.toString()
    }
    ,
    ...
    n._loadTextTrack = function(e) {
        if (e && !this._captionsTrack) {
            const {label: t, kind: n, language: r, id: i} = e
              , o = new Bs({
                label: t,
                kind: n,
                language: r,
            ...
            this._telecineVideo.textTracks = Ao([o]),
            this._addTextTrackListeners(o, e),
            this.fire(po.TEXT_TRACKS_AVAILABLE),
            this._captionsTrack = e
        }
    }
    ,
    n.setModeForTrack = function(e, t) {
        return this._captionsTrack && this._captionsTrack.mode !== t && (this._captionsTrack.mode = t),
        this
    }
    ,
    ...
    n.addTextTrack = function(e) {
        return this._captionsTrack || this._loadTextTracks(),
        this._captionsTrack
    }
    ,
    n._checkHlsAvailability = function(e) {
        "number" == typeof Bt.iOS && Bt.iOS < 9 || this._hlsAvailabilityCheckTimeout || (this._hlsAvailabilityCheckTimeout = setTimeout(()=>{
            ...
            e.onload = ()=>{
                410 !== e.status ? (200 !== e.status && this.fire(mo.STREAM_OFFLINE),
            ...
            /json=1/.test(this._apiManifestUrl) ? pt(this._apiManifestUrl).json().then(t=>{
                "url"in t || this.fire(mo.STREAM_OFFLINE),
                e.open("GET", t.url),
                e.send()
            }
            ).catch(()=>{
                e.open("GET", this._apiManifestUrl),
                e.send()
            }
            ) : (e.open("GET", this._apiManifestUrl),
            e.send())
    ...
    ,
    n.setVideoSrc = function(e) {
        this._onReady = this._setUpNativeHls(e).then(()=>(this._apiManifestUrl = e,
        this._loadNativeHlsManifest(e)))
    }
    ,
    n.ontimeupdate = function() {
    ...
    ,
    n.onprogress = function() {
        this._hlsAvailabilityCheckTimeout && (clearTimeout(this._hlsAvailabilityCheckTimeout),
        this._hlsAvailabilityCheckTimeout = null)
    }
    ,
    n.onstalled = function() {
    ...
    ,
    n.pause = function() {
        this.dvrEnabled && (this.atLiveEdge = !1),
        e.prototype.pause.call(this)
    }
    ,
    n.play = function() {
    ...
    ue(t, [{
        ...
        set: function(e) {
            this.dvrEnabled && (this._atLiveEdge = e,
            this._video.playbackRate > 1 && e && (this._video.playbackRate = 1))
        }
    }, {
        key: "atLiveTail",
        ...
        set: function(e) {
            this.dvrEnabled && (this._atLiveTail = e,
            this._video.playbackRate < 1 && e && (this._video.playbackRate = 1))
        }
    }, {
        key: "liveTailTime",
...
const ra = new WeakMap
  , ia = new WeakMap;
let oa = function() {
    function e({src: e, mime: t, id: n=Ro(), priority: r=0, metadata: i={}}, o) {
        if (!e)
    ...
    return ue(e, [{
        ...
        set: function(e) {
            if (!("number" == typeof (e = parseInt(e, 10)) && isFinite(e) && Math.floor(e) === e && e >= 0))
        ...
        set: function(e) {
            ia.set(this, e),
            this.video.fire(po.FILE_SRC_UPDATE, this)
        }
    }, {
        key: "restrictedStreamIndexes",
        get: function() {
  ...
  , sa = function() {
    function e({enabled: e=!1, id: t=Ro(), kind: n="", label: r="", language: i=""}, o) {
        this._enabled = e,
        dr(this),
        Object.defineProperties(this, {
            kind: {
...
function la(e, t, n, r) {
    const i = r.audio || []
      ...
      , a = Object.keys(e).map(r=>{
        ...
        return navigator.requestMediaKeySystemAccess(i, s).then(e=>e.createMediaKeys()).catch(e=>{}
        ).then(e=>({
            name: i,
            keySystem: e
        }))
...
let ha = function() {
    ...
    return t.init = function(e, t={}) {
        ...
        this._scanner = e,
        aa() ? (this._licenseRequestMetadata = function(e, t) {
            const n = {}
              , r = `${window.screen.availWidth}x${window.screen.availHeight}`
              , i = window.devicePixelRatio;
            return n.merchant = "vimeo",
        ...
        la(this._cdms, this._useHls, !1, t).then(e=>{
            if (e.forEach(e=>{
                e.keySystem && (this._preferredKeySystem = e)
            }
            ),
            !this._preferredKeySystem)
                return this._scanner.fire(po.EME_UNSUPPORTED),
                !1;
            const t = da(this._cdms, this._preferredKeySystem);
            return this._encryptedEventName = "encrypted",
            this._licenseUrl = t.license_url,
            this._useHls && (this._certificateUrl = t.certificate_url,
            this._encryptedEventName = "webkitneedkey"),
            this._video.addEventListener(this._encryptedEventName, this._boundGenerateRequest),
            this._useHls ? (this._video.webkitSetMediaKeys(this._preferredKeySystem.keySystem),
            !0) : this._video.mediaKeys ? (this._keySession = this._video.mediaKeys.createSession(),
            this._keySession.addEventListener("message", e=>this._getLicense(e)),
            !0) : (this._keySession = this._preferredKeySystem.keySystem.createSession(),
            this._keySession.addEventListener("message", e=>this._getLicense(e)),
            this._video.setMediaKeys(this._preferredKeySystem.keySystem),
            !0)
        }
        )) : (this._scanner.fire(po.EME_UNSUPPORTED),
        !1)
    }
    ,
    t.destroy = function() {
    ...
    t._generateRequest = function(e) {
        return "com.apple.fps.1_0" === this._preferredKeySystem.name ? (this._loadFairPlayCertificate().then(t=>{
            ...
            return this._keySession = this._preferredKeySystem.keySystem.createSession("video/mp4", n),
            this._keySession.addEventListener("webkitkeymessage", e=>this._getLicense(e)),
            t
        }
        ).catch(e=>{
    ...
    t._getLicense = function(e) {
        return new Promise((t,n)=>{
            ...
            r.setRequestHeader("dt-custom-data", window.btoa(JSON.stringify(this._licenseRequestMetadata)));
            let i = e.message;
                    ...
                    if (r.status >= 400)
                        ...
                        try {
                            ...
                            "com.apple.fps.1_0" === this._preferredKeySystem.name && (n = function(e) {
                                ...
                                new Uint8Array(atob(t).split("").map(e=>e.charCodeAt(0)))
    ...
    t._loadFairPlayCertificate = function() {
        return new Promise((e,t)=>{
            ...
            n.setRequestHeader("dt-custom-data", window.btoa(JSON.stringify(this._licenseRequestMetadata))),
            n.onload = ()=>{
                if (403 !== n.status)
                    if (n.status >= 400)
                        t({
  ...
  , fa = function() {
    ...
    t.closeAllKeySessions = function() {
        for (let e in this._keySessions)
            this._keySessions[e] && this._keySessions[e].sessionId && this._keySessions[e].close()
    }
    ,
    ue(e, [{
        key: "state",
  ...
  , _a = function() {
    function e(e, t) {
        ...
        this._hasFallbackAssets && this._keyChain.addCdms(e.fallback_cdms, this._keyTypes.KEYCHAIN_SD_FALLBACK)
    }
    var t = e.prototype;
    return t.init = function(e, t={}, n={}) {
        ...
        aa() || this._useMs ? this._keyChain.state === this._keyTypes.KEYCHAIN_SD_FALLBACK ? this.setUpKeySystem(t, n, this._keyTypes.KEYCHAIN_SD_FALLBACK).then(()=>{
            this._scanner.currentTime = this._currentTime,
            this._scanner.play()
        }
        ) : this.setUpKeySystem(t, n).then(()=>this.setUpKeySystem(t, n, this._keyTypes.KEYCHAIN_SD_FALLBACK)) : (this._scanner.fire(po.EME_UNSUPPORTED),
        Promise.reject())
    }
    ,
    t.setUpKeySystem = function(e, t, n=this._keyTypes.KEYCHAIN_DEFAULT) {
        return new Promise((r,i)=>{
            ...
            return o || i(),
            la(o, this._useHls, this._useMs, e).then(e=>{
    ...
    t.destroy = function() {
        ...
        this._video && this._video.removeEventListener(this._encryptedEventName, this._boundGenerateRequest)
    }
    ,
    t._switchKeyChainState = function(e) {
        return new Promise(t=>{
            this._keyChain.state = e,
            this._keyChain.activeKeySession.addEventListener("message", e=>this._getLicense(e)),
            t()
        }
        )
    }
    ...
    t._addEncryptedHandler = function(e, t) {
        ...
        this._useHls ? (this._certificateUrl = e.certificate_url,
        this._encryptedEventName = "webkitneedkey") : this._useMs && (this._encryptedEventName = "msneedkey"),
        this._video.addEventListener(this._encryptedEventName, this._boundGenerateRequest)
    }
    ,
    t._setMediaKeys = function(e) {
        return new Promise(t=>{
            if (this._useMs) {
                const e = ()=>{
                    this._video.msSetMediaKeys(this._keyChain.activeKeySystem.keySystem),
                ...
                if (this._useHls)
                    this._video.webkitSetMediaKeys(this._keyChain.activeKeySystem.keySystem);
                else {
                    ...
                    e === this._keyChain.state && this._keyChain.activeKeySession.addEventListener("message", e=>this._getLicense(e)),
                    this._video.mediaKeys || this._video.setMediaKeys(this._keyChain.activeKeySystem.keySystem)
                }
                t()
            }
        }
    ...
    t._generateRequest = function(e, t) {
        ...
        return "com.apple.fps.1_0" === this._keyChain.activeKeySystem.name ? (this._loadFairPlayCertificate(this._certificateUrl).then(r=>{
            ...
            return this._keyChain.addKeySession(this._createSession(this._keyChain.activeKeySystem.keySystem, "video/mp4", i), t),
            this._keyChain.activeKeySession.contentId = this._contentId,
            this._keyChain.activeKeySession.addEventListener("webkitkeymessage", e=>this._getLicense(e)),
            this._keyChain.activeKeySession.addEventListener("webkitkeyerror", e=>{
                throw n
            }
            ),
            r
        ...
        !0) : "com.microsoft.playready" === this._keyChain.activeKeySystem.name ? (this._keyChain.addKeySession(this._createSession(this._video.msKeys, "video/mp4", e.initData), t),
        this._keyChain.activeKeySession.addEventListener("mskeymessage", e=>this._getLicense(e)),
        this._keyChain.activeKeySession.addEventListener("mskeyerror", e=>{
            throw n
        }
        ),
        !0) : !this._keyChain.activeKeySession.sessionId && !this._activeKeySession && (this._keyChain.activeKeySession.addEventListener("keystatuseschange", this._boundOnKeyStatus),
        this._activeKeySession = this._keyChain.activeKeySession.generateRequest(e.initDataType, e.initData).catch(()=>{
            this._scanner.fire(po.DRM_FAILURE)
        }
        ),
        !0)
    ...
    t._onKeyStatus = function() {
        ...
        t.every(e=>"output-restricted" === e)) {
            if (this._hasFallbackAssets)
                return this._currentTime = this._scanner.currentTime,
                void this._switchKeyChainState(this._keyTypes.KEYCHAIN_SD_FALLBACK).then(()=>{
                    this._fallbackCallback(),
                    this._scanner.fire(po.DRM_KEY_SWITCH, this._keyTypes.KEYCHAIN_SD_FALLBACK)
                }
                ).catch(e=>{
    ...
    t._getLicense = function(e) {
        return this._getLicenseUrl(this._keyChain.activeLicenseTokenUrl).then(t=>new Promise((n,r)=>{
            ...
            "com.apple.fps.1_0" === this._keyChain.activeKeySystem.name && (o = new Uint8Array(o),
            i.setRequestHeader("Content-type", "application/octet-stream")),
            i.onload = ()=>{
                if (403 !== i.status)
                    if (i.status >= 400)
                        r(new No(po.DRM_FAILURE));
                    else
                        try {
                            this._scanner.fire(po.DRM_AUTH_SUCCESS);
                            const e = new Uint8Array(i.response);
                            i.keySession.update(e),
                            n()
                        } catch (Vd) {
                            r(new No(po.DRM_FAILURE,`Error updating key session: ${Vd}`))
                        }
                else
                    r(new No(po.DRM_AUTH_FAILURE))
            }
            ,
            i.onerror = r,
            i.send(o)
...
let ma = function() {
    function e({files: e, id: t=Ro(), title: n=null, subtitle: r=null, metadata: i={}, textTracks: o=Ao(), audioTracks: s=Ao(), externalDisplayFiles: a={}, chapters: u=[], duration: c}) {
        if (!e || !Array.isArray(e))
            throw new TypeError("Must provide files for the video.");
        dr(this);
        const l = function(e=[]) {
            return e.getFileById = bo,
            e
        }(e.map(e=>e instanceof oa ? (e.video = this,
        e) : new oa(e,this)))
          , d = Ao(o.map(e=>e instanceof Bs ? (e.video = this,
        e) : new Bs(e,this)));
        this._audioTracksFromConfig = s,
    ...
    return e.prototype.deactivate = function() {
        ...
        this.textTracks.forEach(e=>this.currentScanner.removeTextTrack(e))
    }
    ,
    ue(e, [{
        key: "drmHandler",
        ...
        set: function(e) {
            this.currentScanner && this.currentScanner.constructor.supportsTextTracks && this.textTracks.forEach(e=>this.currentScanner.removeTextTrack(e)),
            e.constructor.supportsTextTracks && this.textTracks.forEach(t=>e.addTextTrack(t)),
            pa.set(this, e)
        }
    }, {
        key: "chapters",
        ...
        key: "audioTracks",
        get: function() {
            return Ao((this.currentScanner.constructor.supportsVideoElementAudioTracks ? Array.from(this.currentScanner.audioTracks) : this._audioTracksFromConfig).map(e=>e instanceof sa ? (e.video = this,
            e) : new sa(e,this)))
        }
    }]),
    e
  ...
  , va = function() {
    function e(e, t={}) {
        ...
        this._lastBufferCheckVideoTime = this._options.embedTime ? this._options.embedTime : 0,
        this._isBuffering = !1,
        this._isSeeking = !1,
    ...
    t._toggleEvents = function(e) {
        e(lo.PAUSE, this._boundOnPause),
        e(lo.PLAYING, this._boundEndBuffering),
        e(lo.SEEKING, this._boundOnSeeking),
        e(lo.SEEKED, this._boundOnSeeked),
        e(mo.STREAM_ONLINE, this._boundOnLiveOnline),
        e(mo.STREAM_OFFLINE, this._boundOnLiveOffline)
    }
    ,
    t._onPause = function() {
    ...
    t._setUpRebufferMonitor = function() {
        clearInterval(this._bufferInterval),
        this._bufferInterval = setInterval(this.runIntervalCheck.bind(this), this._checkInterval)
    }
    ,
    t.runIntervalCheck = function() {
        if (!this._telecine.video)
            return;
        ...
        if (this.playInitiated && (!this._isSeeking || t) && (!this._telecine.paused || this.userPlayState) && !this._isBuffering && n < this._lastBufferCheckVideoTime + r) {
            if (t && !this._isLiveStreamOnline)
                return;
            const e = this._telecine.buffered;
            for (let t = 0; t < e.length; t++)
                if (n >= e.start(t) && n + .2 <= e.end(t))
                    return;
            if (n + r >= this._telecine.duration)
                return;
            this._isBuffering = !0,
            this.fire(po.BUFFER_STARTED)
        }
        (this.playInitiated && this._isBuffering && n > this._lastBufferCheckVideoTime + r || t && !this._isLiveStreamOnline && this._isBuffering) && (this._isBuffering = !1,
        this.fire(po.BUFFER_ENDED)),
    ...
    ue(e, [{
        ...
        set: function(e) {
            this._userPlayState = e,
            e || this._endBuffering()
        }
    }]),
    e
}();
function ga() {
    ...
    return {
        ...
        start: function(o=Promise.resolve.bind(Promise)) {
            ...
            o().then(n).then(r).catch(i),
            t
        },
        cancel: function() {
            t && (t.reject(new No("PlayInterrupted","The play() request was interrupted by a call to pause()")),
            t = null)
        }
    }
}
let ya = function() {
    function e(e, t, n={}) {
        ...
        this._textTracks = Ao(),
        this._properties = {},
        this._currentScanner = new Qo(e),
        this._options.playRequest = new ga,
    ...
    t.deactivateEffect = function(e) {
        return this._activeEffects.some((t,n)=>t.constructor === e && (t.deactivate(),
        this._activeEffects.splice(n, 1),
        !0))
    }
    ,
    ...
    t.play = function() {
        if (!this._video || this._video.files.length < 1)
            throw new No("NoFiles","There are no files to play.");
        this._rebufferMonitor.playInitiated || (this._rebufferMonitor.playInitiated = !0),
    ...
    t.pause = function() {
        if (!this._video || this._video.files.length < 1)
            throw new No("NoFiles","There are no files to play.");
        return this._rebufferMonitor.userPlayState = !1,
    ...
    t._findScanner = function({textTrackSupport: e=!1}={}) {
        ...
        for (const r in t) {
            ...
            for (const t in n) {
                let r = n[t];
                if (r.supported && (!e || r.supportsTextTracks) && -1 === this._blacklistedScanners.indexOf(this._getScannerName(r)) && r.supportedVideoTypes.some(e=>i.mime === e))
                    return r
            }
        }
        return null
    ...
    t.reactivate = function() {
        var e;
        (null == (e = this._currentScanner) ? void 0 : e.reactivate) && this._currentScanner.reactivate(),
        this.play()
    }
    ,
    t.checkRebuffer = function(e, t) {
        this._rebufferMonitor && (this._rebufferMonitor.playInitiated = e,
    ...
    t._initScanner = function(e, t) {
        ...
        this._switchingVideo ? (this._previousScanner = this._currentScanner,
        this._previousScanner._switchingVideo = !0,
        this._snapshotDisplayed || (this._previousScanner.takeSnapshot(),
        this._snapshotDisplayed = !0),
        this._previousScanner.deactivate()) : this._currentScanner.deactivate();
        ...
        this.fire(po.SCANNER_CHANGE, this._getScannerName(this._currentScanner)),
        this._currentScanner.on(["canplay", "playing"], ()=>{
            this._previousScanner && (this._previousScanner._switchingVideo = !1,
    ...
    t._resetScanner = function() {
        ...
        this._currentScanner = new Qo(this._element)
    }
    ,
    t._handleEvent = function(e, t, n) {
        if (n === this._currentScanner) {
            ...
            case po.SCANNER_ERROR:
                this._fireVideoError("ScannerError", `The current scanner can no longer be used because ${t.reason}`),
                this._blacklistedScanners.push(this._getScannerName(this._currentScanner)),
                this._updateScanner([]);
                break;
            case po.FILE_ERROR:
                this._fireVideoError("FileError", `The current file can no longer be used because ${t.reason}`),
    ...
    t._setUpRebufferMonitor = function() {
        ...
        this._rebufferMonitor = new va(this,this._options),
        this._rebufferMonitor.on(po.BUFFER_STARTED, ()=>{
            this.fire(po.BUFFER_STARTED)
        }
        ),
    ...
    ue(e, [{
        ...
        set: function(e) {
            if ("string" == typeof e && (e = this._files.filter(t=>t.id === e)[0]),
            !e)
                throw new No("FileNotValid","The file is not valid.");
        ...
        get: function() {
            ...
            return null == e ? this._previousLiveEdgeTime : (this._previousLiveEdgeTime = e,
            e)
        }
    }, {
        key: "atLiveEdge",
        ...
        get: function() {
            ...
            return null == e ? this._previousLiveTailTime : (this._previousLiveTailTime = e,
            e)
        }
    }, {
        key: "atLiveTail",
        ...
        set: function(e) {
            ...
            null === e ? (this._video = null,
            this._resetScanner()) : (this._video = new ma(e),
            this._updateScanner())
        }
    }, {
        key: "videoWidth",
        ...
        set: function(e) {
            if (e < 0 || e > 1)
                throw new No("IndexSizeError",`Failed to set the 'volume' property: The volume provided (${e}) is outside of the range [0, 1].`);
  ...
  , Ea = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t, n) || this)._activated = !1,
  ...
  , ba = function() {
    function e(e, t, n) {
        switch (this.isStereo = t !== Sa.Mono,
        this._leftEye = null,
        this._rightEye = null,
        e) {
        case Ta.Equirect:
    ...
    return t.createEquirectProjection = function(e, t) {
        t !== Sa.Mono ? (this._leftEye = this._createEquirectangularSphereMesh(e),
        this._rightEye = this._createEquirectangularSphereMesh(e),
        this._leftEye.layers.set(1),
        this._rightEye.layers.set(2),
        t === Sa.TopBottom && (this._chopGeometryUvs(this._leftEye.geometry, .5, .5),
        this._chopGeometryUvs(this._rightEye.geometry, .5, 0)),
        t === Sa.LeftRight && (this._chopGeometryUvs(this._leftEye.geometry, .5, 0, 0),
        this._chopGeometryUvs(this._rightEye.geometry, .5, .5, 0))) : this._leftEye = this._createEquirectangularSphereMesh(e)
    }
    ,
  ...
  , Aa = function() {
    ...
    return t.hasVRHeadset = function() {
        return Bt.webvr ? navigator.getVRDisplays().then(e=>e.length > 0 ? (this._renderer.vr.setDevice(e[0]),
        e[0]) : null) : null
    }
    ,
    t.enter = function() {
  ...
  , Ia = function(e) {
    ...
    ue(t, [{
        ...
        set: function(e) {
            e !== this._isUserInteracting && (this._isUserInteracting = e,
            e ? this._options.isMobile || this._telecine.fire(vo.MOTION_START) : this._options.isMobile || this._telecine.fire(vo.MOTION_END))
        },
        get: function() {
        ...
        get: function() {
            try {
                ...
                return this._telecine._currentScanner.fire(vo.SPATIAL_UNSUPPORTED),
                !1
            }
        }
    }, {
    ...
    n._initialize = function() {
        this._activated = !0,
        this._camera = new THREE.PerspectiveCamera(this._options.fieldOfView,this._video.clientWidth / this._video.clientHeight,1,2 * ba.SPHERE_RADIUS),
        ...
        this._projector = new ba(this._options.projection,this._options.stereoMode,this._texture),
        ...
        this._webvr = new Aa(this._renderer),
        this._webvr.supported && this._webvr.hasVRHeadset().then(e=>{
            setTimeout(()=>{
    ...
    n.toggleVR = function() {
        if (this._webvr.isPresenting)
            this._webvr.exit().then(()=>{
                this.adjustRenderSize()
            }
            ).catch(e=>{}
            );
        else {
            if (this._telecine._currentScanner.paused)
                return;
    ...
    n.snapToCenter = function() {
        ...
        this._rotation = 0;
        for (let n = 0; n < 50; n++)
            this._motionTimeouts.push(setTimeout(()=>{
                0 === n && (this._movingAutomatically = !0,
                this._options.isMobile || (this._maxTimeBetweenWrites = 1e3 / this._writeSpeeds.motionRenderSpeed)),
                49 === n && (this._movingAutomatically = !1,
                this._options.isMobile || (this._maxTimeBetweenWrites = 1e3 / this._writeSpeeds.videoFps)),
                this._updateViewpoint(this._coordinates.lat + t / Math.pow(1.1, n), this._coordinates.long + e / Math.pow(1.1, n)),
                this._offset.lat = THREE.Math.radToDeg(this._gyroVector.x) + this._coordinates.lat + t / Math.pow(1.1, n),
                this._offset.long = THREE.Math.radToDeg(this._gyroVector.y) + this._coordinates.long + t / Math.pow(1.1, n)
            }
    ...
    n.moveDevice = function(e, t, n, r) {
        ...
        i.setFromEuler(u),
        i.multiply(l),
        i.multiply(c.setFromAxisAngle(a, -s)),
        ...
        this._telecine.fire(vo.MOTION_START),
    ...
    n.keyPress = function(e) {
        this._options.keyboardDisabled || (this._keyIsDown() || (this.isUserInteracting = !0,
        this._motionTimeouts && this._motionTimeouts.forEach(e=>clearTimeout(e))),
        ...
        if (e >= 20) {
            ...
            for (let e = 1; e < 50; e++)
                this._motionTimeouts.push(setTimeout(()=>{
                    ...
                    49 === e && (this._movingAutomatically = !1,
                    this._maxTimeBetweenWrites = 1e3 / this._writeSpeeds.videoFps);
                    const n = 2 / Math.pow(e, 1.5);
                    this._offset.lat = THREE.Math.radToDeg(this._gyroVector.x) + this._coordinates.lat + t.lat,
                    this._offset.long = THREE.Math.radToDeg(this._gyroVector.y) + this._coordinates.long + t.long,
                    this._updateViewpoint(this._coordinates.lat + t.lat * n, this._coordinates.long + t.long * n)
                }
    ...
    n._update = function() {
        if (!this.isVRPresenting) {
            ...
            this._camera.position.set(Math.sin(this._phi) * Math.cos(this._theta), Math.cos(this._phi), Math.sin(this._phi) * Math.sin(this._theta)),
            this._camera.lookAt(this._camera.target),
            this._camera.rotation.z += this._rotation;
            const e = this.cameraProps;
            this._telecine.fire(vo.CAMERA_UPDATE, e),
            this._previousCameraProps.yaw === e.yaw && this._previousCameraProps.pitch === e.pitch && this._previousCameraProps.roll === e.roll && this._previousCameraProps.fov === e.fov || (this._previousCameraProps = e,
            this._telecine.fire(vo.CAMERA_CHANGE, e))
        }
    ...
    n.adjustRenderSize = function() {
        if (this.isVRPresenting)
            this._camera.aspect = this._video.clientWidth / this._video.clientHeight,
            this._camera.updateProjectionMatrix(),
            this._renderer.setSize(this._video.clientWidth, this._video.clientHeight);
        else {
            this._video.clientWidth > this._video.clientHeight ? this._camera.aspect = Math.max(1, Math.min(2, this._video.clientWidth / this._video.clientHeight)) : this._camera.aspect = Math.max(1 / 3, Math.min(3, this._video.clientWidth / this._video.clientHeight)),
            this._camera.updateProjectionMatrix();
    ...
    n._startRendering = function() {
        this._renderer.setAnimationLoop(()=>{
            this._keyIsDown() && this._moveFromKeyPress(),
            this._update()
        }
        )
    }
    ...
    ue(t, [{
        ...
        set: function(e) {
            if (e < -180 || e > 180)
                throw new RangeError("Roll should be a float between -180 and 180.");
  ...
  , wa = function(e) {
    function t(t, n={}) {
        var r;
        return (r = e.call(this, t, n) || this).connected = !1,
        r._context = null,
        r._source = null,
        r._mirror = null,
        r._rotator = null,
    ...
    return n.activate = function() {
        ...
        new Promise((e,t)=>{
            if ("undefined" != typeof ambisonics)
                return void e();
            const n = document.createElement("script");
    ...
    n._disconnect = function(e=!1) {
        ...
        e && this._context && (this._context.close(),
        this._context = null),
        this._source = null,
        this._mirror = null,
        this._rotator = null,
    ...
    n.updateRotation = function(e, t, n) {
        this._rotator && (this._rotator.yaw !== e || this._rotator.pitch !== t || this._rotator.roll !== n) && (this._rotator.yaw = e,
...
function vu(e, t) {
    ...
    const r = null == (n = e.request.files.hls) ? void 0 : n.default_cdn
      , {signature: i, timestamp: o, expires: s} = e.request;
...
function yu(e) {
    if (null == e)
        return !0;
    if (Wr(e) && (Wt(e) || "string" == typeof e || "function" == typeof e.splice || wr(e) || Ur(e) || Sr(e)))
        return !e.length;
    var t = Si(e);
...
function bu(e, t) {
    ...
    const n = e.request.files
      ...
      , o = e.request.cookie.quality || i || function(e) {
        ...
        if (n) {
            const e = t.map(Su);
            -1 !== e.indexOf("1080p") && -1 === e.indexOf("720p") && (r = "1080p")
        }
        return e.request.cookie.hd || e.video.default_to_hd ? r : "360p"
    }(e);
    let s = function({files: e=[], preference: t="360p", priorityOffset: n=0}) {
        (e = Array.from(e)).sort(xu());
        const r = e.map(Su);
        if (t) {
            -1 === r.indexOf(t) && (r.push(t),
            r.sort((e,t)=>Cu(t) - Cu(e)));
            const e = r.indexOf(t)
              , n = r.splice(0, e);
            n.reverse(),
            r.push.apply(r, Ee(n))
    ...
    return n.hls && (s = s.concat(wu(e, !1, t)),
    e.request.drm && Bt.browser.safari) || n.dash && (s = s.concat(Ru(e, !1, t))),
    s
}
function Au(e, t=!1, n=!1) {
    let r = e.url;
    if ("avc_url"in e && (r = e.avc_url),
    n)
        return r;
    const i = Bt.hevc && (!t || Bt.spatialHEVC)
      , o = Bt.hdr && Bt.hevcMain10 && (!t || Bt.spatialHEVC);
    return Bt.dolbyVision && "hevc_dvh1_url"in e ? r = e.hevc_dvh1_url : o && "hevc_hdr_url"in e ? r = e.hevc_hdr_url : i && "hevc_sdr_url"in e ? r = e.hevc_sdr_url : Bt.av1 && "av1_url"in e && (r = e.av1_url),
    r
}
function Iu(e) {
...
function ku(e) {
    if (yu(e.progressive))
        return [];
    let t = e.progressive;
    return "progressive_avc"in e && (t = e.progressive_avc),
    t.filter(Du(t))
}
function Pu(e) {
    if ("number" == typeof e)
...
function ju(e, t) {
    ...
    if (t.video) {
        ...
        if (i === Ra.hlsLive)
            return t.manifest.video.map(e=>de(de({}, e), {}, {
                quality: `${e.height}p`
            }));
        if ([Ra.dash, Ra.dashMpd].includes(i)) {
            ...
            n = function(e, t=!1, n=!1) {
                ...
                return Bt.dolbyVision && "streams_hevc_dvh1"in e ? r = e.streams_hevc_dvh1 : o && "streams_hevc_hdr"in e ? r = e.streams_hevc_hdr : i && "streams_hevc_sdr"in e ? r = e.streams_hevc_sdr : Bt.av1 && "streams_av1"in e && (r = e.streams_av1),
                n && "streams_fallback"in e && (r = e.streams_fallback),
                r
            }(e.request.files.dash, e.video.spatial, o),
            !i && (null == t || null == (r = t.currentScanner) ? void 0 : r.manifestLoaded) && (n = function(e, t) {
            ...
            n = t.video.files.filter(e=>"progressive" === ka[e.mime])
    }
...
function Wu(e, t, n) {
    ...
    function l(e) {
        var t, r, i, o, s, a;
        const {embed: u} = e;
        n.disablePictureInPicture = !(null === (t = null !== (r = u.pip) && void 0 !== r ? r : null == (i = u.settings) ? void 0 : i.pip) || void 0 === t || t),
        n.autoPictureInPicture = null === (o = null !== (s = u.auto_pip) && void 0 !== s ? s : null == (a = u.settings) ? void 0 : a.auto_pip) || void 0 === o || o
    }
    function d(e) {
        if (!u && n.buffered && n.buffered.length > 0) {
            ...
            a && o && i === n.duration)
                return void (o && n.paused && n.play().catch(Gu.captureException))
        }
    }
    function h(t) {
        if ("auto" === t)
            return void (n.video.currentFile.restrictedStreamIndexes = []);
        const r = ju(e, n).reverse().map(e=>e.quality).indexOf(t);
        -1 !== r && (Gu.captureBreadcrumb(`Switched to ${t}`, {}, "video"),
    ...
    return t.on(Qa, (function() {
        ...
        n.lowLatencyMode = null == (t = e.video.live_event) ? void 0 : t.low_latency
    }
    )),
    t.on(qa, (function() {
        u = !0,
    ...
    n.on(lo.PLAY, (function() {
        u = !1,
        t.fire(lo.PLAY, n.currentTime)
    }
    )),
    n.on(lo.PAUSE, (function() {
        o = !1,
        t.fire(lo.PAUSE, n.currentTime, n.ended)
    }
    )),
    ...
    n.on(lo.TIME_UPDATE, (function() {
        if (u)
            return;
        const {currentTime: e, liveEdgeTime: r, atLiveEdge: i, liveTailTime: o, atLiveTail: s, duration: a, playbackRate: c} = n
          , l = e / a;
    ...
    n.on(lo.ENDED, (function(e) {
        n.loop ? n.play().catch(Gu.captureException) : (o = !1,
        t.fire(lo.ENDED, e))
    }
    )),
    n.on(lo.LOADED_METADATA, (function(t) {
        const r = n.duration;
        if (isFinite(r) && r > 0) {
            if (r < e.video.duration - 1 || r > e.video.duration + 1)
                return;
            e.video.duration = r
        }
    ...
    t.on(Xa, (function(t) {
        n.isLive() && 0 === n.liveEdgeTime || (t = function(e, t, n) {
            return void 0 === n && (n = t,
            t = void 0),
            void 0 !== n && (n = (n = Ma(n)) == n ? n : 0),
            void 0 !== t && (t = (t = Ma(t)) == t ? t : 0),
            function(e, t, n) {
                return e == e && (void 0 !== n && (e = e <= n ? e : n),
                void 0 !== t && (e = e >= t ? e : t)),
                e
            }(Ma(e), t, n)
        }(t, ja(n.isLive() ? n.liveTailTime : 0), ja(n.isLive() ? n.liveEdgeTime : n.duration || e.video.duration)),
        n.currentTime = t)
    }
    )),
    ...
    n.on(po.CURRENT_FILE_CHANGE, (function(r) {
        ...
        r.metadata.quality,
        [Ra.dash, Ra.dashMpd].includes(r.mime) && f(),
        [Ra.hlsLive].includes(r.mime) ? n.once(po.STREAMS_LOADED, ()=>{
            f()
        }
        ) : function(n) {
            const r = Mu(e);
    ...
    ),
    {
        ...
        set quality(r) {
            !function(r) {
                ...
                if ([Ra.dash, Ra.dashMpd, Ra.hlsLive].includes(i))
                    h(r);
                else {
                    const t = ju(e, n).filter(e=>e.metadata.quality === r);
                    t.length > 0 && (u = !0,
                    n.video.currentFile = t[0])
                }
                c = r,
                t.fire(Za, r)
            }(r)
...
function Yu(e, t, n) {
    let r = null;
    t.on(Qa, (function() {
        r && (n.deactivateEffect(Ea),
        r = null),
        e.video.canvas && (e.request.drm || n.supportsEffect(Ea) && (r = n.activateEffect(Ea)))
    }
    ))
}
...
let Ju = function() {
    function e(e, t, n, r) {
        dr(this),
        this._liveEventHasID = new Ue,
        this._liveEvent = ji(e),
        this._sessionUrl = e.session_url || e.sessionUrl,
        this._subtitleUrl = e.subtitleUrl,
        this._sessionRefreshUrl = t,
        this._subtitleRefreshUrl = r,
        this._appPollUrl = n,
        this._forcedPoll = !1,
        this._disabled = !1,
            ...
            return Qu((function() {
                return zu(pt({
                    ...
                    if (!(null == e ? void 0 : e.url))
                        throw new Error("No webvtt url was available to fetch");
    ...
    t._pollLiveApi = function() {
        try {
            ...
            function(e, t) {
                ...
                if (e._dvrEnabled && (t.dvr = e._dvrEnabled),
                t.status !== e._liveEvent.status) {
                    if (pu(t) && "provision_expire" === t.terminate_reason)
                        return e._sessionUrl = null,
                ...
                return function(r, i) {
                    var o = function() {
                        if (null !== t.ingest.session_id)
                            return e._liveEventHasID.resolve(),
                            e._liveEvent.id = t.ingest.session_id,
                            zu(e._refreshSessionUrl(), (function() {
                                e._pollLiveApi(),
                                n = !0
                            }
                            ))
...
function tc(e, t, n) {
    ...
    return t.on($a, (function() {
        i && !e.isNewVideo() || (i = !0,
        l(),
        e.video.live_event && !hu(e.video.live_event) && (function(n) {
...
function sc(e, t, n) {
    ...
    return t.on($a, (function() {
        var t;
        e.isNewVideo() && (l = !1),
        !0 !== e.preload || !1 !== h || "kollective" !== f ? l || ("pending" !== (null == (t = e.video.live_event) ? void 0 : t.status) ? (l = !0,
        v(),
        f && (_ = {
            hive: a,
            kollective: s
...
function ac(e, t, n) {
    let r = null;
    function i() {
        n.deactivateEffect(wa),
        r = null
    }
    t.on(Ja, (function() {
        var t;
        r && i(),
        (null == (t = e.video.channel_layout) ? void 0 : t.startsWith("ambisonic")) && n.supportsEffect(wa) && (r = n.activateEffect(wa, {
            ambisonicsUrl: e.request.urls.ambisonics_js
        }))
    }
    )),
    n.on(vo.CAMERA_UPDATE, (function({yaw: e, pitch: t, roll: n}) {
...
function uc(e, t=[]) {
    ...
    const [n,r] = e.split(".")
      , [i] = n.split(/[-_]/)
      , o = n !== i
      , s = t.filter(e=>o && e.language === n || e.language === i).sort((e,t)=>{
...
function cc(e) {
    ...
    return t.forEach(e=>{
        let t = e.match(/<[a-zA-Z]+ ?.*?>/g) || []
          , i = e.match(/<\/[a-zA-Z]+ ?.*?>/g) || [];
        const o = r.map(({startTag: e})=>e);
        r = [],
        t = o.concat(t),
        t.forEach(e=>{
            let[t] = e.replace(/<|>/g, "").split(" ");
            const n = i.indexOf(`</${t}>`);
            -1 !== n ? i.splice(n, 1) : r.push({
                startTag: e,
                closeTag: `</${t}>`
            })
        }
        );
        const s = r.map(({closeTag: e})=>e).reverse().join("")
          , a = `${o.join("")}${e}${s}`;
        n.push(a)
    }
    ),
...
function dc(e, t, n, r) {
            ...
            t.video.textTracks.language) {
                ...
                if (n !== r) {
                    const n = `${t.video.textTracks.language}.subtitles`
                      , {track: r} = uc(n, t.video.textTracks);
                    if (r)
                        return void e.fire(Wa, n)
                }
            }
            e.fire(Ka)
        } else
    ...
    function a(t) {
        ...
        for (var s = 0, a = r.length; s < a; s++)
            "" !== r[s].text.replace(/^\s+|\s+$/gm, "") && (o = document.createElement("span"),
            o.appendChild(r[s].getCueAsHTML()),
            i.push({
                html: cc(o.innerHTML),
                text: lc(r[s].text)
            }));
    ...
    e.on(Wa, (function(n) {
        ...
        let r = t.video.textTracks.getTrackById(n)
          , s = !0;
        r || ({track: r, exactMatch: s} = uc(n, t.video.textTracks)),
        r !== i && setTimeout(()=>{
    ...
    e.on(po.TEXT_TRACKS_AVAILABLE, s),
    e.on([lo.ENTER_PICTURE_IN_PICTURE, lo.LEAVE_PICTURE_IN_PICTURE], (function() {
        !function(e) {
            i && i.mode !== e && (i.mode = e)
        }(o())
    }
...
function mc(e, t, n) {
    ...
    function d({files: i, textTracks: a, audioTracks: c=[], switchingVideo: l=!1, startTime: d}) {
        var h, f;
        ...
        l ? r.checkRebuffer(u, g) : t.fire(Qa),
    ...
    r.on(po.STREAMS_LOADED, (function(t) {
        t.video.forEach(t=>{
            ...
            n ? (t.profile = n.profile,
            t.quality = n.quality,
            t.fps = n.fps) : (t.profile = null,
    ...
    r.on(po.STREAM_CHANGE, (function({index: e, streams: n, metadata: r}) {
        const i = n[e];
        Gu.captureBreadcrumb("Stream changed", i, "video"),
        t.fire(po.STREAM_CHANGE, i, e, n, r)
    }
    )),
    r.on(po.STREAM_TARGET_CHANGE, (function({index: e, streams: n}) {
        const r = n[e];
        t.fire(po.STREAM_TARGET_CHANGE, r, e, n)
    }
    )),
    r.on(po.DRM_KEY_SWITCH, (function() {
        if (!e.request.drm.fallback_asset)
            return;
        const t = Hu(e);
        l(function(e) {
            const t = e.request.files;
            ...
            return (t.hls && (Bt.iPhone || Bt.iPad) || r) && (n = n.concat(wu(e, !0))),
            t.dash && !r && (n = n.concat(Ru(e, !0))),
            n
        }(e), t)
    }
    )),
    ...
    t.on(Ya, (function(n) {
        var i, o;
        if (!(null == (i = e.embed) || null == (o = i.settings) ? void 0 : o.audio_tracks))
            return;
...
function yc(e, t) {
    ...
    const c = {
        ...
        set currentTime(e) {
            if (e = parseFloat(e),
            isNaN(e) || e < 0)
                throw new vc("Seconds must be a positive number less than the duration of the video.","RangeError","setCurrentTime");
            r.fire(Xa, e)
        },
        get liveEdgeTime() {
        ...
        reactivate() {
            var e;
            return (null == (e = o) ? void 0 : e.reactivate) && o.reactivate(),
            this
        },
        unload() {
            return r.fire(qa),
        ...
        enableTextTrack(e, t=null) {
            ...
            if (Fa(e))
                ...
                if ([n,i=t] = e.split("."),
                !this.hasTextTrack(e))
                    throw new vc(`There are no tracks for “${n.toUpperCase()}”.`,"InvalidTrackLanguageError","enableTextTrack");
                s = uc(i ? `${n}.${i}` : n, a).track
            }
            if (!s || i && s.kind !== i)
                throw new vc(`There are no ${i} tracks for “${n.toUpperCase()}”.`,"InvalidTrackError","enableTextTrack");
            o.setCaptionsShouldDisplay(!0),
            r.fire(Wa, s.id)
        },
        disableTextTrack() {
            s = null,
            o.setCaptionsShouldDisplay(!1),
            r.fire(Ka)
        },
        enableAudioTrack(e) {
            r.fire(Ya, e)
        ...
        set volume(e) {
            if (e = parseFloat(e),
            isNaN(e) || e < 0 || e > 1)
                throw new vc("Volume should be a number between 0 and 1.","RangeError","setVolume");
            o.volume = e
        },
        get videoId() {
            return a.video.id
        ...
        get pictureInPictureEnabled() {
            ...
            return t && o.once(lo.LOADED_DATA, ()=>r.fire(iu)),
            !t && !e && o.pictureInPictureEnabled
        },
        get audioTracks() {
            var e, t;
...
function Sc(...e) {
    ...
    if (1 === e.length) {
        ...
        const {hex: t, alpha: n} = function(e) {
            let t = 1;
            return 4 === (e = e.replace("#", "")).length && (t = Tc(e.slice(3) + e.slice(3)),
            e = e.slice(0, 3)),
            8 === e.length && (t = Tc(e.slice(6, 8)),
            e = e.slice(0, 6)),
            {
                hex: e,
                alpha: t
    ...
    if (3 === e.length || 4 === e.length) {
        for (var n = 0; n < 3; n++)
            if (isNaN(parseInt(e[n], 10)) || parseInt(e[n], 10) < 0 || parseInt(e[n], 10) > 255)
                throw new Error("Invalid rgb value");
...
Sc.prototype = {
    ...
    set hex(e) {
        return this.rgba = Sc.hexToRgb(e),
        this
    },
    get hsl() {
    ...
    lighten: function(e, t, n) {
        ...
        t && n)
            for (var r = n.contrast(this).ratio; r < t && (this.lighten(5),
    ...
    darken: function(e, t, n) {
        ...
        t && n)
            for (var r = n.contrast(this).ratio; r < t && (this.darken(5),
            r = n.contrast(this).ratio,
            !(this.lightness <= 0)); )
                ;
        return this
...
Sc.hexToRgb = function(e) {
    var t;
    return 3 === (e = String(e)).length || 4 === e.length ? (t = /^#?([A-Fa-f0-9])([A-Fa-f0-9])([A-Fa-f0-9])$/i.exec(e)) && (t[1] += t[1],
    t[2] += t[2],
...
Sc.rgbToHsl = function(e, t, n) {
    ...
    t /= 255,
    n /= 255;
    var r, i = Math.max(e, t, n), o = Math.min(e, t, n), s = (i + o) / 2, a = s;
    if (i === o)
        return {
            hue: 0,
            saturation: 0,
    ...
    var u = i - o;
    return r = a > .5 ? u / (2 - i - o) : u / (i + o),
    i === e ? s = (t - n) / u + (t < n ? 6 : 0) : i === t ? s = (n - e) / u + 2 : i === n && (s = (e - t) / u + 4),
    s /= 6,
    {
...
Sc.hslToRgb = function(e, t, n) {
    function r(e, t, n) {
        return n < 0 && (n += 1),
        n > 1 && (n -= 1),
        6 * n < 1 ? e + 6 * (t - e) * n : 2 * n < 1 ? t : 3 * n < 2 ? e + 6 * (2 / 3 - n) * (t - e) : e
    }
    if (e /= 360,
    n /= 100,
    0 == (t /= 100))
...
function kc(e) {
    ...
    function h() {
        ...
        if (0 === n && 0 === r)
            return;
        let i = "satisfied";
        if (t.width > n && t.height > r && (n / t.width < .4 ? i = "satisfied" : n / t.width < 1 ? i = "tolerable" : n / t.width > 1 && (i = "frustrated")),
        u) {
            const e = Ac(u);
            l[c] += e
        }
    ...
    function p() {
        return d ? (i = r / Ac(d),
        t >= 4 || i >= .12 ? 0 : t < 4 && 0 !== t ? i < .12 ? .5 : 0 : 1) : null
    }
    function m() {
        if (-1 === s)
            return null;
        switch (h(),
        Object.keys(l).reduce((e,t)=>l[e] > l[t] ? e : t)) {
        case "satisfied":
            return 1;
        case "tolerable":
            return .5;
...
function Dc(e, t) {
    ...
    function v() {
        ...
        p = {
            ...
            videoBufferCheck: ()=>{
                setInterval(()=>{
                    let t = e.currentTime;
                    l && !h && !e.paused && !p.bufferTracker.isVideoBuffering() && t < s + .125 && p.bufferTracker.trackBufferStart(y),
                    l && !e.paused && p.bufferTracker.isVideoBuffering() && t > s + .125 && (p.bufferTracker.trackBufferEnd(E),
            ...
            playbackSessionTimer: ()=>{
                let t = bc();
                setInterval(()=>{
                    (!e.paused && c || h || p.bufferTracker.isVideoBuffering()) && (u += Ac(t) / 1e3),
                    t = bc()
                }
                , 500)
            }
    ...
    function g(e, n={}) {
        0 === m && (n = Object.assign(n, p.addEventData(e)),
        t(e, n))
    }
    function y(e={}) {
        f.trackBufferStart(),
        g(wc.VIDEO_BUFFER_START, e)
    }
    function E(e={}) {
        f.trackBufferEnd(),
        g(wc.VIDEO_BUFFER_END, e)
    }
    return v(),
    g(wc.VIDEO_READY),
    function() {
        ...
        setInterval(()=>{
            ...
            !e.paused && c && (n++,
            (null == (s = p.customMinuteTracker) || null == s.shouldCount ? void 0 : s.shouldCount()) && r++,
            l(i, n) && (n = 0,
            i++,
            g(wc.VIDEO_MINUTE_WATCHED)),
            l(o, r) && (null == (a = p.customMinuteTracker) || null == a.shouldCount ? void 0 : a.shouldCount()) && (r = 0,
            o++,
            null == (u = p.customMinuteTracker) || null == u.onCount || u.onCount(o)))
        }
        , 1e3)
    }(),
    ...
    e.addEventListener("canplay", ()=>{
        h || p.bufferTracker.isVideoBuffering() && !c && (p.bufferTracker.trackBufferEnd(E),
        p.bufferTracker.resetLastBufferTime())
    }
    ),
    {
        ...
        handleExternalError: function(e, t) {
            c = !1,
            f.onError(t),
            g(l ? wc.VIDEO_PLAYBACK_ERROR : l ? wc.VIDEO_START_FAILURE : wc.VIDEO_LOAD_FAILURE, e)
        },
        reset: v
    }
}
var Oc = function() {
  ...
  , Cc = Math.min;
function Mc(e, t, n) {
    var r, i, o, s, a, u, c = 0, l = !1, d = !1, h = !0;
    if ("function" != typeof e)
        throw new TypeError("Expected a function");
    function f(t) {
        var n = r
    ...
    return t = Ma(t) || 0,
    cn(n) && (l = !!n.leading,
    o = (d = "maxWait"in n) ? Lc(Ma(n.maxWait) || 0, t) : o,
...
function Nc(e, t, n) {
    ...
    if ("function" != typeof e)
        throw new TypeError("Expected a function");
    return cn(n) && (r = "leading"in n ? !!n.leading : r,
...
let Uc = function() {
    ...
    var t = e.prototype;
    return t.init = function({receiverApplicationId: e="", resumeSavedSession: t=!0, language: n=null, autoJoinPolicy: r="TAB_AND_ORIGIN_SCOPED"}={}) {
        ...
        this.CastState = Object.assign(this.CastState, cast.framework.CastState),
    ...
    t.initRemotePlayer = function() {
        ...
        return this.remotePlayer = new cast.framework.RemotePlayer,
    ...
    t.setup = function({loadLibrary: e=!0}={}) {
        return new Promise((t,n)=>{
            if (this.isGCastApiAvailable)
                return this.AutoJoinPolicy = chrome.cast.AutoJoinPolicy,
                void t(!0);
            window.__onGCastApiAvailable = (e,r)=>{
                if (r) {
                    ...
                    this.AutoJoinPolicy = chrome.cast.AutoJoinPolicy,
                    t(e);
                else {
            ...
            try {
                if (!1 === e)
                    throw new ReferenceError("Cast is not available. Make sure the library has been loaded.");
    ...
    ,
    t.loadMedia = function({contentId: e, contentType: t, currentTime: n=0, duration: r=0, requestCustomData: i=null, mediaCustomData: o=null, autoRequest: s=!1, tracks: a=[], ottCastOptions: u}) {
    ...
    ,
    t.loadMediaOnSession = function(e, {contentId: t, contentType: n, currentTime: r=0, duration: i, requestCustomData: o=null, mediaCustomData: s=null, tracks: a=[], ottCastOptions: u}) {
        if (e && e instanceof cast.framework.CastSession) {
            const c = e.getSessionState();
            if (c !== this.SessionState.SESSION_STARTING && c !== this.SessionState.SESSION_STARTED && c !== this.SessionState.SESSION_RESUMED)
                return Promise.reject(new ReferenceError("Session must be established."));
            const l = this.createLoadRequest(t, n, r, i, o, s, a, u);
            return null !== this.currentLoadRequestId && this.currentLoadRequestId === l.requestId || (this.currentLoadRequestId = l.requestId,
    ...
    ,
    t.sendMessage = function({namespace: e, data: t={}, autoRequest: n=!1}) {
    ...
    t.createCastButton = function(e) {
        ...
        return e && e.style && (null === e.style["--disconnected-color"] && (e.style["--disconnected-color"] = "#00ADEF"),
        null === e.style["--connected-color"] && (e.style["--connected-color"] = "#E5E500")),
    ...
    t.createLoadRequest = function(e, t, n, r, i, o, s, a) {
        ...
        return l.customData = a ? a.customData : i,
        l.currentTime = n || 0,
        a && (l.credentials = a.credentials,
...
function Vc() {
    if (!jc && (jc = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto),
    !jc))
        throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
    return jc(Bc)
}
var Hc = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function Xc(e) {
    return "string" == typeof e && Hc.test(e)
}
const qc = [];
for (let z_ = 0; z_ < 256; ++z_)
    qc.push((z_ + 256).toString(16).slice(1));
function Gc(e, t=0) {
    return qc[e[t + 0]] + qc[e[t + 1]] + qc[e[t + 2]] + qc[e[t + 3]] + "-" + qc[e[t + 4]] + qc[e[t + 5]] + "-" + qc[e[t + 6]] + qc[e[t + 7]] + "-" + qc[e[t + 8]] + qc[e[t + 9]] + "-" + qc[e[t + 10]] + qc[e[t + 11]] + qc[e[t + 12]] + qc[e[t + 13]] + qc[e[t + 14]] + qc[e[t + 15]]
}
let Wc, Kc, Yc = 0, $c = 0;
function zc(e) {
    if (!Xc(e))
...
function el(e, t, n, r, i, o) {
    return Zc(function(e, t) {
        return e << t | e >>> 32 - t
    }(Zc(Zc(t, e), Zc(r, o)), i), n)
}
function tl(e, t, n, r, i, o, s) {
    return el(t & n | ~t & r, e, t, i, o, s)
}
function nl(e, t, n, r, i, o, s) {
    return el(t & r | n & ~r, e, t, i, o, s)
}
function rl(e, t, n, r, i, o, s) {
    return el(t ^ n ^ r, e, t, i, o, s)
}
function il(e, t, n, r, i, o, s) {
    return el(n ^ (t | ~r), e, t, i, o, s)
}
const ol = Qc("v3", 48, (function(e) {
    if ("string" == typeof e) {
    ...
    return function(e) {
        ...
        for (let s = 0; s < e.length; s += 16) {
            const t = n
              ...
              , u = i
              , c = o;
            n = tl(n, r, i, o, e[s], 7, -680876936),
            o = tl(o, n, r, i, e[s + 1], 12, -389564586),
            i = tl(i, o, n, r, e[s + 2], 17, 606105819),
            r = tl(r, i, o, n, e[s + 3], 22, -1044525330),
            n = tl(n, r, i, o, e[s + 4], 7, -176418897),
            o = tl(o, n, r, i, e[s + 5], 12, 1200080426),
            i = tl(i, o, n, r, e[s + 6], 17, -1473231341),
            r = tl(r, i, o, n, e[s + 7], 22, -45705983),
            n = tl(n, r, i, o, e[s + 8], 7, 1770035416),
            o = tl(o, n, r, i, e[s + 9], 12, -1958414417),
            i = tl(i, o, n, r, e[s + 10], 17, -42063),
            r = tl(r, i, o, n, e[s + 11], 22, -1990404162),
            n = tl(n, r, i, o, e[s + 12], 7, 1804603682),
            o = tl(o, n, r, i, e[s + 13], 12, -40341101),
            i = tl(i, o, n, r, e[s + 14], 17, -1502002290),
            r = tl(r, i, o, n, e[s + 15], 22, 1236535329),
            n = nl(n, r, i, o, e[s + 1], 5, -165796510),
            o = nl(o, n, r, i, e[s + 6], 9, -1069501632),
            i = nl(i, o, n, r, e[s + 11], 14, 643717713),
            r = nl(r, i, o, n, e[s], 20, -373897302),
            n = nl(n, r, i, o, e[s + 5], 5, -701558691),
            o = nl(o, n, r, i, e[s + 10], 9, 38016083),
            i = nl(i, o, n, r, e[s + 15], 14, -660478335),
            r = nl(r, i, o, n, e[s + 4], 20, -405537848),
            n = nl(n, r, i, o, e[s + 9], 5, 568446438),
            o = nl(o, n, r, i, e[s + 14], 9, -1019803690),
            i = nl(i, o, n, r, e[s + 3], 14, -187363961),
            r = nl(r, i, o, n, e[s + 8], 20, 1163531501),
            n = nl(n, r, i, o, e[s + 13], 5, -1444681467),
            o = nl(o, n, r, i, e[s + 2], 9, -51403784),
            i = nl(i, o, n, r, e[s + 7], 14, 1735328473),
            r = nl(r, i, o, n, e[s + 12], 20, -1926607734),
            n = rl(n, r, i, o, e[s + 5], 4, -378558),
            o = rl(o, n, r, i, e[s + 8], 11, -2022574463),
            i = rl(i, o, n, r, e[s + 11], 16, 1839030562),
            r = rl(r, i, o, n, e[s + 14], 23, -35309556),
            n = rl(n, r, i, o, e[s + 1], 4, -1530992060),
            o = rl(o, n, r, i, e[s + 4], 11, 1272893353),
            i = rl(i, o, n, r, e[s + 7], 16, -155497632),
            r = rl(r, i, o, n, e[s + 10], 23, -1094730640),
            n = rl(n, r, i, o, e[s + 13], 4, 681279174),
            o = rl(o, n, r, i, e[s], 11, -358537222),
            i = rl(i, o, n, r, e[s + 3], 16, -722521979),
            r = rl(r, i, o, n, e[s + 6], 23, 76029189),
            n = rl(n, r, i, o, e[s + 9], 4, -640364487),
            o = rl(o, n, r, i, e[s + 12], 11, -421815835),
            i = rl(i, o, n, r, e[s + 15], 16, 530742520),
            r = rl(r, i, o, n, e[s + 2], 23, -995338651),
            n = il(n, r, i, o, e[s], 6, -198630844),
            o = il(o, n, r, i, e[s + 7], 10, 1126891415),
            i = il(i, o, n, r, e[s + 14], 15, -1416354905),
            r = il(r, i, o, n, e[s + 5], 21, -57434055),
            n = il(n, r, i, o, e[s + 12], 6, 1700485571),
            o = il(o, n, r, i, e[s + 3], 10, -1894986606),
            i = il(i, o, n, r, e[s + 10], 15, -1051523),
            r = il(r, i, o, n, e[s + 1], 21, -2054922799),
            n = il(n, r, i, o, e[s + 8], 6, 1873313359),
            o = il(o, n, r, i, e[s + 15], 10, -30611744),
            i = il(i, o, n, r, e[s + 6], 15, -1560198380),
            r = il(r, i, o, n, e[s + 13], 21, 1309151649),
            n = il(n, r, i, o, e[s + 4], 6, -145523070),
            o = il(o, n, r, i, e[s + 11], 10, -1120210379),
            i = il(i, o, n, r, e[s + 2], 15, 718787259),
            r = il(r, i, o, n, e[s + 9], 21, -343485551),
            n = Zc(n, t),
            r = Zc(r, a),
            i = Zc(i, u),
            o = Zc(o, c)
...
const cl = Qc("v5", 80, (function(e) {
    ...
    for (let s = 0; s < i; ++s) {
        ...
        for (let n = 0; n < 16; ++n)
            t[n] = e[64 * s + 4 * n] << 24 | e[64 * s + 4 * n + 1] << 16 | e[64 * s + 4 * n + 2] << 8 | e[64 * s + 4 * n + 3];
        o[s] = t
    }
    ...
    for (let s = 0; s < i; ++s) {
        ...
        for (let t = 0; t < 16; ++t)
            e[t] = o[s][t];
        for (let t = 16; t < 80; ++t)
            e[t] = ul(e[t - 3] ^ e[t - 8] ^ e[t - 14] ^ e[t - 16], 1);
        let r = n[0]
          , i = n[1]
          , a = n[2]
          , u = n[3]
        ...
        for (let n = 0; n < 80; ++n) {
            const o = Math.floor(n / 20)
              , s = ul(r, 5) + al(o, i, a, u) + c + t[o] + e[n] >>> 0;
            c = u,
            u = a,
            a = ul(i, 30) >>> 0,
            i = r,
...
var ll, dl = function(e) {
    ...
    v1: function(e, t, n) {
        ...
        let o = (e = e || {}).node || Wc
          , s = void 0 !== e.clockseq ? e.clockseq : Kc;
        if (null == o || null == s) {
            const t = e.random || (e.rng || Vc)();
            null == o && (o = Wc = [1 | t[0], t[1], t[2], t[3], t[4], t[5]]),
            null == s && (s = Kc = 16383 & (t[6] << 8 | t[7]))
        }
        let a = void 0 !== e.msecs ? e.msecs : Date.now()
          , u = void 0 !== e.nsecs ? e.nsecs : $c + 1;
        const c = a - Yc + (u - $c) / 1e4;
        if (c < 0 && void 0 === e.clockseq && (s = s + 1 & 16383),
        (c < 0 || a > Yc) && void 0 === e.nsecs && (u = 0),
        u >= 1e4)
    ...
    t.getCookie = function(e) {
        ...
        if (!t || 0 == t.length || void 0 === t.index)
            return null;
    ...
    var c = function() {
        ...
        e.configure = function(t) {
            e.conf = t,
            e.WAIT_QUEUE.length > 0 && (e.WAIT_QUEUE.map((function(t) {
                        ...
                        i = r.next(); !i.done; i = r.next())
                            ...
                            c in n) {
                                if (l instanceof Object)
                                    return n[c]instanceof Object ? (e.updateObject(l, n[c]),
                                    [2]) : (n[c] = l,
                                    [2]);
                                n[c] = l
                            }
        ...
        e.updateContext = function(t) {
            return r(this, void 0, void 0, (function() {
                return o(this, (function(n) {
                    return "global" == t.context && e.conf.globalBPO && e.updateObject(t.fields, e.conf.globalBPO.fields),
                    [2]
                }
                ))
            }
        ...
        e.sendEvent = function(t, n) {
            return r(this, void 0, void 0, (function() {
                ...
                return o(this, (function(o) {
                    ...
                    case 0:
                        if (null == t)
                            throw new Error("Required parameter event was null or undefined when calling sendEvent.");
                        return e.isInitalized ? (r = JSON.stringify(ml.ObjectSerializer.serialize([new hl.Envelope(t,this.conf.globalBPO)], "Array<Envelope>")),
                        i = (0,
                        vl.formatRequestEvent)(t.name),
                        s = "".concat(this.conf.service, "/add/").concat(encodeURIComponent(i)),
                        navigator.sendBeacon && !n ? [3, 2] : (a = {
                            method: "POST",
                            headers: {
                        ...
                        [4, fetch(s, a)])) : (e.WAIT_QUEUE.push(t),
                        e.waitAndFlushQueue(),
                        [2]);
                    case 1:
                        return o.sent(),
                ...
                return o(this, (function(o) {
                    ...
                    case 0:
                        if (null == t)
                            throw new Error("Required parameter event was null or undefined when calling sendEvent.");
                        if (!e.isInitalized)
                            return e.WAIT_QUEUE.push(t),
                            e.waitAndFlushQueue(),
                            [2];
                        r = new hl.Envelope(t,this.conf.globalBPO),
                        (i = ml.ObjectSerializer.serialize([r], "Array<Envelope>"))[0].contexts = {};
                        try {
                            for (u = s(Object.entries(n)),
                            c = u.next(); !c.done; c = u.next())
                                l = a(c.value, 2),
                                d = l[0],
                                h = l[1],
                                f = ml.ObjectSerializer.serialize(h, "EventContext"),
                                i[0].contexts[d] = f
                        } catch (T) {
                            y = {
                                error: T
                        ...
                        p = (0,
                        vl.formatRequestEvent)(t.name),
                        m = "".concat(this.conf.service, "/add/").concat(encodeURIComponent(p)),
                        navigator.sendBeacon ? [3, 2] : (v = {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "User-Agent": navigator.userAgent,
...
function Il(e, t, n) {
    return "_root" == t ? n : e !== n ? function(e) {
        return ll || (ll = e.matches ? e.matches : e.webkitMatchesSelector ? e.webkitMatchesSelector : e.mozMatchesSelector ? e.mozMatchesSelector : e.msMatchesSelector ? e.msMatchesSelector : e.oMatchesSelector ? e.oMatchesSelector : Pl.matchesSelector)
    }(e).call(e, t) ? e : e.parentNode ? (Tl++,
    Il(e.parentNode, t, n)) : void 0 : void 0
}
function wl(e, t, n, r) {
    bl[e.id] || (bl[e.id] = {}),
    bl[e.id][t] || (bl[e.id][t] = {}),
    bl[e.id][t][n] || (bl[e.id][t][n] = []),
    bl[e.id][t][n].push(r)
}
function Rl(e, t, n, r) {
    if (bl[e.id])
        if (t)
            ...
            for (var o in bl[e.id])
                bl[e.id].hasOwnProperty(o) && (bl[e.id][o] = {})
}
function kl(e, t, n, r) {
    if (this.element) {
        ...
        for (i = 0; i < e.length; i++)
            r ? Rl(this, e[i], t, n) : (bl[o] && bl[o][e[i]] || Pl.addEvent(this, e[i], s(e[i])),
            wl(this, e[i], t, n));
        return this
    }
    function s(e) {
        return function(t) {
            !function(e, t, n) {
                if (bl[e][n]) {
                    var r, i, o = t.target || t.srcElement, s = {}, a = 0, u = 0;
                    for (r in Tl = 0,
                    bl[e][n])
                        bl[e][n].hasOwnProperty(r) && (i = Il(o, r, Al[e].element)) && Pl.matchesEvent(n, Al[e].element, i, "_root" == r, t) && (Tl++,
                        bl[e][n][r].match = i,
                        s[Tl] = bl[e][n][r]);
                    ...
                    a = 0; a <= Tl; a++)
                        if (s[a])
                            for (u = 0; u < s[a].length; u++) {
                                if (!1 === s[a][u].call(s[a].match, t))
                                    return void Pl.cancel(t);
                                if (t.cancelBubble)
                                    return
                            }
                }
...
,
Pl.matchesSelector = function() {}
,
Pl.cancel = function(e) {
    e.preventDefault(),
    e.stopPropagation()
}
,
...
Pl.addEvent = function(e, t, n) {
    Ol && Ll[t] && (t = Ll[t]),
    "transitionend" === t && (Dl(e, "webkitTransitionEnd", n),
    Dl(e, "otransitionend", n)),
    "mouseenter" === t && (t = "mouseover"),
    "mouseleave" === t && (t = "mouseout"),
    "MSPointerEnter" !== t || Cl || (t = "MSPointerOver"),
    "MSPointerLeave" !== t || Ml || (t = "MSPointerOut"),
    Dl(e, t, n)
}
,
...
var xl = o((function(e, t) {
    ...
    function i(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : n
          ...
          , o = null;
        return function() {
            return r(t, i, arguments) || (o = e.apply(null, arguments)),
            i = arguments,
            o
        }
    }
  ...
  , Xl = function() {
    ...
    e.prototype.connect_ = function() {
        Fl && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_),
        window.addEventListener("resize", this.refresh),
        Hl ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
    ...
    e.prototype.disconnect_ = function() {
        Fl && this.connected_ && (document.removeEventListener("transitionend", this.onTransitionEnd_),
...
function zl(e) {
    return Fl ? $l(e) ? function(e) {
        ...
        var r = Gl(e).getComputedStyle(e)
          ...
          , a = Kl(r.width)
          , u = Kl(r.height);
        if ("border-box" === r.boxSizing && (Math.round(a + o) !== t && (a -= Yl(r, "left", "right") + o),
        Math.round(u + s) !== n && (u -= Yl(r, "top", "bottom") + s)),
        !function(e) {
  ...
  , ed = function() {
    ...
    return e.prototype.observe = function(e) {
        ...
        if ("undefined" != typeof Element && Element instanceof Object) {
            if (!(e instanceof Gl(e).Element))
                throw new TypeError('parameter 1 is not of type "Element".');
            var t = this.observations_;
            t.has(e) || (t.set(e, new Jl(e)),
...
function dd() {
    ...
    function u(e, ...t) {
        ...
        return t && void 0 !== t[0] && (n.data = t[0]),
        n
    }
    function c(e) {
    ...
    return window.addEventListener("message", (function(t) {
        ...
        let i = n.parseMessage(t.data)
          , {method: o, value: s, id: a} = i;
        if (!(void 0 === o || "string" != typeof o || o.indexOf("_") > -1))
            try {
                let r = function(e, t) {
                    if (!e)
                        return null;
                    ...
                    return n = Object.getOwnPropertyDescriptor(t, i),
                    "get" === r && n && "function" == typeof n.get ? n.get : "set" === r && n && "function" == typeof n.set ? n.set : null
                }(o, e);
                if (!r)
                    throw new id(`“${t}” is not a valid method. Valid methods are: ${function(e) {
                        return Object.keys(e).reduce((t,n)=>{
                            if (n.indexOf("_") > -1)
                                return t;
                            const r = Object.getOwnPropertyDescriptor(e, n);
                            return "function" == typeof r.value ? (t.push(n),
                            t) : ("function" == typeof r.get && t.push("get" + n.charAt(0).toUpperCase() + n.slice(1)),
                            "function" == typeof r.set && t.push("set" + n.charAt(0).toUpperCase() + n.slice(1)),
                            t)
                        }
                        , []).sort()
                    }(e).join(", ")}.`,"TypeError",o);
                ld.captureBreadcrumb("API message received", i, "api"),
                Promise.resolve(r.call(t, s, a)).then(e=>c({
                    method: o,
                    value: null == e ? s : e
                })).catch(n.logError)
            } catch (u) {
...
var Ad = function(e) {
    ...
    t && (e !== t.element && e !== Ed || !t.hasEntered) && ("VIDEO" === e.tagName && (Ed = e),
    1 === Sd.length && Rd.onenter(Rd.element),
    t.enter.call(t.element, e || t.element),
    t.hasEntered = !0,
    vd(_d.ENTER, Rd.element))
}
  , Id = function() {
    Ed = null;
    var e = Sd.pop();
    e && (e.exit.call(e.element),
    vd(_d.EXIT, e.element),
    Rd.element || (Sd.forEach((function(e) {
...
fd.change && document.addEventListener(fd.change, (function(e) {
    if (Rd.onchange(Rd.element),
    vd(_d.CHANGE, Rd.element),
    Rd.element) {
...
document.addEventListener("webkitbeginfullscreen", (function(e) {
    ...
    Rd.onchange(e.srcElement),
    vd(_d.CHANGE, Rd.srcElement),
    Ad(e.srcElement)
}
), !0),
document.addEventListener("webkitendfullscreen", (function(e) {
    Rd.onchange(e.srcElement),
    vd(_d.CHANGE, e.srcElement),
    Id(e.srcElement)
}
), !0),
fd.error && document.addEventListener(fd.error, (function(e) {
    wd("not_allowed")
}
), !1);
    ...
    !function() {
        ...
        function f(e, t) {
            for (var n = (e = c(e)).next(); !n.done; n = e.next())
                if (n = n.value,
                t.includes(n.nodeName.toLowerCase()) || f(n.children, t))
                    return !0;
            return !1
        }
        function _(e, t) {
            ...
            for (var n = [], r = (t = c(t)).next(); !r.done; r = t.next())
                r = r.value,
                n.push({
                    timestamp: r.start,
                    type: "requestStart"
            ...
            for (r = (t = c(e)).next(); !r.done; r = t.next())
                n.push({
                    timestamp: r.value,
                    type: "requestStart"
                });
        ...
        function p(e) {
            ...
            function(e, t) {
                ...
                fetch = function(r) {
                    ...
                    return new Promise((function(r, o) {
                        var s = d++;
                        e(s),
                        n.apply(null, [].concat(l(i))).then((function(e) {
                            t(s),
                            r(e)
                        }
                        ), (function(e) {
            ...
            this.w && (this.h = function(e) {
                var t = new MutationObserver((function(t) {
                    for (var n = (t = c(t)).next(); !n.done; n = t.next())
                        ("childList" == (n = n.value).type && f(n.addedNodes, h) || "attributes" == n.type && h.includes(n.target.tagName.toLowerCase())) && e(n)
                }
                ));
        ...
        function v(e, t) {
            !e.i || e.v > t || (clearTimeout(e.j),
            e.j = setTimeout((function() {
                var t = performance.timing.navigationStart
                  , n = _(e.g, e.b);
                if (t = (window.a && window.a.A ? 1e3 * window.a.A().C - t : 0) || performance.timing.domContentLoadedEventEnd - t,
                e.u)
                    var r = e.u;
                else
                    r = performance.timing.domContentLoadedEventEnd ? (r = performance.timing).domContentLoadedEventEnd - r.navigationStart : null;
                var i = performance.now();
                null === r && v(e, Math.max(n + 5e3, i + 1e3));
                var o = e.a;
                (n = 5e3 > i - n || 5e3 > i - (n = o.length ? o[o.length - 1].end : t) ? null : Math.max(n, r)) && (e.s(n),
                clearTimeout(e.j),
                e.i = !1,
                e.c && e.c.disconnect(),
                e.h && e.h.disconnect()),
                v(e, performance.now() + 1e3)
            }
            ), t - performance.now()),
            e.v = t)
        }
        p.prototype.getFirstConsistentlyInteractive = function() {
            ...
            return new Promise((function(t) {
                e.s = t,
                "complete" == document.readyState ? m(e) : window.addEventListener("load", (function() {
                    m(e)
                }
                ))
            }
        ...
        var g = {
            getFirstConsistentlyInteractive: function(e) {
                return e = e || {},
                "PerformanceLongTaskTiming"in window ? new p(e).getFirstConsistentlyInteractive() : Promise.resolve(null)
            }
        };
...
function Md(e, t) {
    ...
    function u(e) {
        ...
        o.restoreCustomPlaybackStateOnAdBreakComplete = !0,
        o.uiElements = [],
        i = e.getAdsManager(t.videoPlayer, o),
        n.fire(Cd.ADS_MANAGER_LOADED),
    ...
    function v(e) {
        n.fire(Cd.AD_ERROR, e.getError()),
        i && i.destroy()
    }
    const g = {
        start: (e,t)=>(a.initialize(),
        i.init(e, t, r.ViewMode.NORMAL),
        i.start()),
        stop: ()=>i.stop(),
        pause: ()=>i.pause(),
        play: ()=>i.resume(),
    ...
    return function(e, t, n) {
        if (document.getElementById("vp-ima-sdk"))
            n();
        else {
        ...
        o = new r.AdsLoader(a),
        o.addEventListener(r.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, u),
        o.addEventListener(r.AdErrorEvent.Type.AD_ERROR, v),
        s = new r.AdsRequest,
        t.adUrl && (s.adTagUrl = t.adUrl),
        s.linearAdSlotWidth = t.width.linear,
        s.linearAdSlotHeight = t.height.linear,
        s.nonLinearAdSlotWidth = t.width.nonlinear,
        s.nonLinearAdSlotHeight = t.height.nonlinear,
        o.requestAds(s)
    }
    )),
    Ld(this, g)
...
var Vd, Hd, Xd, qd, Gd, Wd, Kd, Yd, $d, zd, Qd, Jd = function(e) {
    ...
    var n, r = ah(), i = Zd("FCP"), o = function(e) {
        "first-contentful-paint" === e.name && (a && a.disconnect(),
        e.startTime < r.firstHiddenTime && (i.value = e.startTime,
        i.entries.push(e),
        n(!0)))
    }, s = window.performance && performance.getEntriesByName && performance.getEntriesByName("first-contentful-paint")[0], a = s ? null : eh("paint", o);
    (s || a) && (n = rh(e, i, t),
    s && o(s),
    nh((function(r) {
        i = Zd("FCP"),
    ...
    if (e.cancelable) {
        ...
        "pointerdown" == e.type ? function(e, t) {
            var n = function() {
              ...
              , i = function() {
                removeEventListener("pointerup", n, hh),
                removeEventListener("pointercancel", r, hh)
            };
            addEventListener("pointerup", n, hh),
            addEventListener("pointercancel", r, hh)
        }(t, e) : _h(t, e)
    }
}, vh = function(e) {
    ...
    var n, r = ah(), i = Zd("FID"), o = function(e) {
    ...
    var n, r = ah(), i = Zd("LCP"), o = function(e) {
        var t = e.startTime;
...
}, Th = {}, Sh = [], bh = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function Ah(e, t) {
    for (var n in t)
        e[n] = t[n];
    return e
...
function wh(e, t, n) {
    ...
    if (arguments.length > 2 && (s.children = arguments.length > 3 ? Gd.call(arguments, 2) : n),
...
function Rh(e, t, n, r, i) {
    ...
    return null == i && null != Wd.vnode && Wd.vnode(o),
    o
}
function kh(e) {
    return e.children
...
function Dh(e, t) {
    if (null == t)
        return e.__ ? Dh(e.__, e.__.__k.indexOf(e) + 1) : null;
...
function Ch() {
    for (var e; Ch.__r = Yd.length; )
        e = Yd.sort((function(e, t) {
        ...
        e.some((function(e) {
            ...
            (s = t.__P) && (n = [],
            (r = Ah({}, i)).__v = i.__v + 1,
            Hh(s, i, r, t.__n, void 0 !== s.ownerSVGElement, null != i.__h ? [o] : null, n, null == o ? Dh(i) : o, i.__h),
            Xh(n, i),
            i.__e != o && Oh(i)))
        }
        ))
...
function Mh(e, t, n, r, i, o, s, a, u, c) {
    var l, d, h, f, _, p, m, v = r && r.__k || Sh, g = v.length;
    for (n.__k = [],
    l = 0; l < t.length; l++)
        if (null != (f = n.__k[l] = null == (f = t[l]) || "boolean" == typeof f ? null : "string" == typeof f || "number" == typeof f || "bigint" == typeof f ? Rh(null, f, null, null, f) : Array.isArray(f) ? Rh(kh, {
            ...
            Hh(e, f, h = h || Th, i, o, s, a, u, c),
            _ = f.__e,
            (d = f.ref) && h.ref != d && (m || (m = []),
            h.ref && m.push(h.ref, null, f),
            m.push(d, f.__c || _, f)),
            null != _ ? (null == p && (p = _),
            "function" == typeof f.type && f.__k === h.__k ? f.__d = u = Nh(f, u, e) : u = Uh(e, f, h, v, _, u),
            "function" == typeof n.type && (n.__d = u)) : u && h.__e == u && u.parentNode != e && (u = Dh(h))
        }
    for (n.__e = p,
    l = g; l--; )
        null != v[l] && ("function" == typeof n.type && null != v[l].__e && v[l].__e == n.__d && (n.__d = Dh(r, l + 1)),
        Wh(v[l], v[l]));
    if (m)
...
function Nh(e, t, n) {
    for (var r, i = e.__k, o = 0; i && o < i.length; o++)
        (r = i[o]) && (r.__ = e,
        t = "function" == typeof r.type ? Nh(r, t, n) : Uh(n, r, r, i, r.__e, t));
    return t
}
function xh(e, t) {
    return t = t || [],
...
function jh(e, t, n, r, i) {
    ...
    e: if ("style" === t)
        if ("string" == typeof n)
            ...
            r)
                for (t in r)
                    n && t in n || Fh(e.style, t, "");
            if (n)
                for (t in n)
                    r && n[t] === r[t] || Fh(e.style, t, n[t])
        }
    else if ("o" === t[0] && "n" === t[1])
        ...
        e.l || (e.l = {}),
        e.l[t + o] = n,
        n ? r || e.addEventListener(t, o ? Vh : Bh, o) : e.removeEventListener(t, o ? Vh : Bh, o);
...
function Hh(e, t, n, r, i, o, s, a, u) {
    ...
    try {
        e: if ("function" == typeof E) {
            ...
            n.__c ? p = (l = t.__c = n.__c).__ = l.__E : ("prototype"in E && E.prototype.render ? t.__c = l = new E(m,g) : (t.__c = l = new Ph(m,g),
            l.constructor = E,
            l.render = Kh),
            v && v.sub(l),
            l.props = m,
            ...
            null != E.getDerivedStateFromProps && (l.__s == l.state && (l.__s = Ah({}, l.__s)),
            Ah(l.__s, E.getDerivedStateFromProps(m, l.__s))),
            h = l.props,
            f = l.state,
            d)
                ...
                if (null == E.getDerivedStateFromProps && m !== h && null != l.componentWillReceiveProps && l.componentWillReceiveProps(m, g),
                !l.__e && null != l.shouldComponentUpdate && !1 === l.shouldComponentUpdate(m, l.__s, g) || t.__v === n.__v) {
                    l.props = m,
                    l.state = l.__s,
                    t.__v !== n.__v && (l.__d = !1),
                    l.__v = t,
            ...
            l.state = l.__s,
            null != l.getChildContext && (r = Ah(Ah({}, r), l.getChildContext())),
            d || null == l.getSnapshotBeforeUpdate || (_ = l.getSnapshotBeforeUpdate(h, f)),
            y = null != c && c.type === kh && null == c.key ? c.props.children : c,
            Mh(e, Array.isArray(y) ? y : [y], t, n, r, i, o, s, a, u),
            l.base = t.__e,
            t.__h = null,
            l.__h.length && s.push(l),
            p && (l.__E = l.__ = null),
            ...
            t.__e = n.__e) : t.__e = qh(n.__e, t, n, r, i, o, s, u);
        (c = Wd.diffed) && c(t)
    } catch (e) {
        t.__v = null,
        (u || null != o) && (t.__e = a,
...
function qh(e, t, n, r, i, o, s, a) {
    var u, c, l, d = n.props, h = t.props, f = t.type, _ = 0;
    if ("svg" === f && (i = !0),
    null != o)
        for (; _ < o.length; _++)
    ...
    if (null == e) {
        ...
        e = i ? document.createElementNS("http://www.w3.org/2000/svg", f) : document.createElement(f, h.is && h),
        o = null,
        a = !1
    }
    if (null === f)
        d === h || a && e.data === h || (e.data = h);
    else {
        if (o = o && Gd.call(e.childNodes),
        c = (d = n.props || Th).dangerouslySetInnerHTML,
        ...
        if (function(e, t, n, r, i) {
            var o;
            for (o in n)
                "children" === o || "key" === o || o in t || jh(e, o, null, n[o], r);
            for (o in t)
                i && "function" != typeof t[o] || "children" === o || "key" === o || "value" === o || "checked" === o || n[o] === t[o] || jh(e, o, t[o], n[o], r)
        }(e, h, d, i, a),
        l)
            t.__k = [];
        else if (_ = t.props.children,
        Mh(e, Array.isArray(_) ? _ : [_], t, n, r, i && "foreignObject" !== f, o, s, o ? o[0] : n.__k && Dh(n, 0), a),
        null != o)
            for (_ = o.length; _--; )
                null != o[_] && Ih(o[_]);
        a || ("value"in h && void 0 !== (_ = h.value) && (_ !== e.value || "progress" === f && !_ || "option" === f && _ !== d.value) && jh(e, "value", _, d.value, !1),
        "checked"in h && void 0 !== (_ = h.checked) && _ !== e.checked && jh(e, "checked", _, d.checked, !1))
    }
    return e
}
function Gh(e, t, n) {
...
function Wh(e, t, n) {
    var r, i;
    if (Wd.unmount && Wd.unmount(e),
    (r = e.ref) && (r.current && r.current !== e.__e || Gh(r, null, t)),
    null != (r = e.__c)) {
    ...
    if (r = e.__k)
        for (i = 0; i < r.length; i++)
            r[i] && Wh(r[i], t, "function" != typeof e.type);
    n || null == e.__e || Ih(e.__e),
    e.__e = e.__d = void 0
}
function Kh(e, t, n) {
...
function Yh(e, t, n) {
    ...
    o = [],
    Hh(t, e = (!r && n || t).__k = wh(kh, null, [e]), i || Th, Th, void 0 !== t.ownerSVGElement, !r && n ? [n] : i ? null : t.firstChild ? Gd.call(t.childNodes) : null, o, !r && n ? n : i ? i.__e : t.firstChild, r),
    Xh(o, e)
}
function $h(e, t) {
    Yh(e, t, $h)
...
function zh(e, t, n) {
    ...
    for (o in t)
        "key" == o ? r = t[o] : "ref" == o ? i = t[o] : s[o] = t[o];
    return arguments.length > 2 && (s.children = arguments.length > 3 ? Gd.call(arguments, 2) : n),
    Rh(e.type, s, r || e.key, i || e.ref, null)
}
function Qh(e, t) {
    var n = {
        __c: t = "__cC" + Qd++,
...
Kd = 0,
Ph.prototype.setState = function(e, t) {
    var n;
    n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = Ah({}, this.state),
    "function" == typeof e && (e = e(Ah({}, n), this.props)),
    e && Ah(n, e),
...
,
Ph.prototype.render = kh,
Yd = [],
$d = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout,
Ch.__r = 0,
Qd = 0;
var Jh, Zh, ef, tf = 0, nf = [], rf = Wd.__b, of = Wd.__r, sf = Wd.diffed, af = Wd.__c, uf = Wd.unmount;
function cf(e, t) {
    Wd.__h && Wd.__h(Zh, e, tf || t),
    tf = 0;
    var n = Zh.__H || (Zh.__H = {
        __: [],
        __h: []
...
function df(e, t, n) {
    var r = cf(Jh++, 2);
    return r.t = e,
    r.__c || (r.__ = [n ? n(t) : If(void 0, t), function(e) {
        var t = r.t(r.__[0], e);
...
function yf(e) {
    var t = cf(Jh++, 10)
      , n = lf();
    return t.__ = e,
    Zh.componentDidCatch || (Zh.componentDidCatch = function(e) {
        t.__ && t.__(e),
        n[1](e)
    }
    ),
...
function Ef() {
    for (var e; e = nf.shift(); )
        if (e.__P)
            try {
                e.__H.__h.forEach(Sf),
                e.__H.__h.forEach(bf),
                e.__H.__h = []
            } catch (nh) {
                e.__H.__h = [],
                Wd.__e(nh, e.__v)
...
(kf.prototype = new Ph).isPureReactComponent = !0,
kf.prototype.shouldComponentUpdate = function(e, t) {
...
xf.prototype.render = function(e, t) {
    if (this.__b) {
        if (this.__v.__k) {
            ...
            this.__v.__k[0] = function e(t, n, r) {
                ...
                t.__c.__H = null),
                null != (t = wf({}, t)).__c && (t.__c.__P === r && (t.__c.__P = n),
                t.__c = null),
                t.__k = t.__k && t.__k.map((function(t) {
                    return e(t, n, r)
                }
    ...
    return i && (i.__h = null),
    [wh(kh, null, t.__e ? null : e.children), i]
}
;
...
Wd.vnode = function(e) {
    ...
    if ("string" == typeof t) {
        ...
        e.props = r,
        n.class != n.className && (Jf.enumerable = "className"in n,
        null != n.className && (r.class = n.className),
        Object.defineProperty(r, "className", Jf))
    }
    e.$$typeof = Xf,
    Zf && Zf(e)
}
...
var n_ = {
    ...
    memo: function(e, t) {
        function n(e) {
            ...
            t ? !t(this.props, e) || !r : Rf(this.props, e)
        }
        function r(t) {
...
function i_(e) {
    const t = "function" == typeof e ? function(e) {
      ...
      , n = (e=t.getState,n=Object.is)=>{
        ...
        let d = !1;
        (o.current !== i || s.current !== e || a.current !== n || u.current) && (l = e(i),
        d = !n(c.current, l)),
        r_(()=>{
            d && (c.current = l),
            o.current = i,
        ...
        r_(()=>{
            const e = ()=>{
                try {
                    const e = t.getState()
                      , n = s.current(e);
                    a.current(c.current, n) || (o.current = e,
                    c.current = n,
                    r())
                } catch (e) {
                    u.current = !0,
...
var c_, l_ = function() {}, d_ = setTimeout(l_), h_ = function(e) {
    var t = e.children
      , n = e.in
      , r = void 0 !== n && n
      , i = e.appear
      ...
      , k = lf((function() {
        return R = !0,
        r ? o ? s_.APPEAR : s_.APPEARED : s_.EXITED
    }
    ))
      , P = k[0]
      , D = k[1];
...
function A_(e, t, n, r, i, o) {
    ...
    o.set(t, e); ++l < a; ) {
        var f = e[l]
          , _ = t[l];
        if (r)
            var p = s ? r(_, f, l, t, e, o) : r(f, _, l, e, t, o);
        if (void 0 !== p) {
            if (p)
                continue;
            d = !1;
...
function O_(e, t, n, r, i) {
    return e === t || (null == e || null == t || !on(e) && !on(t) ? e != e && t != t : function(e, t, n, r, i, o) {
        ...
        if (h && !l)
            return o || (o = new hr),
            s || Ur(e) ? A_(e, t, n, r, i, o) : function(e, t, n, r, i, o, s) {
                switch (n) {
                case "[object DataView]":
        ...
        function(e, t, n, r, i, o) {
            ...
            for (var f = s; ++c < u; ) {
                var _ = e[l = a[c]]
                  , p = t[l];
                if (r)
                    var m = s ? r(p, _, l, t, e, o) : r(_, p, l, e, t, o);
...
function N_(e, t) {
    ...
    function a() {
        ...
        return o.insertAdjacentElement(s, e),
        e
    }
}
        ...
        return e = {
            ...
            463: (e,t,n)=>{
                ...
                function A(e, t) {
                    ...
                    (t.KEYFORMAT || t.KEYFORMATVERSIONS) && e.compatibleVersion < 5 && (e.compatibleVersion = 5)
                }
                function I(e) {
                    var t = a.splitByCommaWithPreservingQuotes(e)
                      , n = {};
                    return t.forEach((function(e) {
                        var t, r, o = i(a.splitAt(e, "="), 2), s = o[0], u = o[1], c = T(u);
                        switch (s) {
                        case "URI":
                            n[s] = c;
                            break;
                        ...
                        case "IV":
                            n[s] = (t = c,
                            16 !== (r = a.hexToByteSequence(t)).length && a.INVALIDPLAYLIST("IV must be a 128-bit unsigned integer"),
                            r);
                            break;
                        case "BYTERANGE":
                            n[s] = b(c);
                ...
                function R(e, t, n) {
                    ...
                    new c({
                        ...
                        channels: i.CHANNELS
                    })), s = e[a.camelify(n)], u = function(e, t) {
                        var n, i = !1, o = r(e);
                        try {
                            for (o.s(); !(n = o.n()).done; ) {
                                var s = n.value;
                    ...
                    s.push(o),
                    o.isDefault && (e.currentRenditions[a.camelify(n)] = s.length - 1)
                }
                function k(e, t, n, i, o) {
                    ...
                    try {
                        for (c.s(); !(s = c.n()).done; ) {
                            ...
                            if ("EXT-X-MEDIA" === d.name) {
                                var h = d.attributes
                                  , f = h.TYPE;
                                if (f && h["GROUP-ID"] || a.INVALIDPLAYLIST("EXT-X-MEDIA TYPE attribute is REQUIRED."),
                                t[f] === h["GROUP-ID"] && (R(u, d, f),
                                "CLOSED-CAPTIONS" === f)) {
                    ...
                    return function(e, t, n) {
                        ["AUDIO", "VIDEO", "SUBTITLES", "CLOSED-CAPTIONS"].forEach((function(r) {
                            "CLOSED-CAPTIONS" === r && "NONE" === e[r] ? (n.isClosedCaptionsNone = !0,
                            t.closedCaptions = []) : e[r] && !t[a.camelify(r)].find((function(t) {
                ...
                function D(e, t, n, r, i, o, s) {
                    for (var u = new g({
                        ...
                        var n = e[t]
                          ...
                          , o = n.attributes;
                        if ("EXTINF" === r)
                            !Number.isInteger(i.duration) && s.compatibleVersion < 3 && (s.compatibleVersion = 3),
                            Math.round(i.duration) > s.targetDuration && a.INVALIDPLAYLIST("EXTINF duration, when rounded to the nearest integer, MUST be less than or equal to the target duration"),
                            u.duration = i.duration,
                            u.title = i.title;
                        else if ("EXT-X-BYTERANGE" === r)
                            s.compatibleVersion < 4 && (s.compatibleVersion = 4),
                            u.byterange = i;
                        else if ("EXT-X-DISCONTINUITY" === r)
                            u.parts.length > 0 && a.INVALIDPLAYLIST("EXT-X-DISCONTINUITY must appear before the first EXT-X-PART tag of the Parent Segment."),
                            u.discontinuity = !0;
                        else if ("EXT-X-KEY" === r)
                            u.parts.length > 0 && a.INVALIDPLAYLIST("EXT-X-KEY must appear before the first EXT-X-PART tag of the Parent Segment."),
                            A(s, o),
                            u.key = new h({
                                method: o.METHOD,
                                uri: o.URI,
                            ...
                            u.parts.length > 0 && a.INVALIDPLAYLIST("EXT-X-MAP must appear before the first EXT-X-PART tag of the Parent Segment."),
                            s.compatibleVersion < 5 && (s.compatibleVersion = 5),
                            s.hasMap = !0,
                            u.map = new f({
                                uri: o.URI,
                        ...
                        else if ("EXT-X-CUE-OUT-CONT" === r || "EXT-X-CUE" === r || "EXT-OATCLS-SCTE35" === r || "EXT-X-ASSET" === r || "EXT-X-SCTE35" === r)
                            u.markers.push(new p({
                                type: "RAW",
                                tagName: r,
                                value: i
                            ...
                            if ("EXT-X-PRELOAD-HINT" === r && "PART" === o.TYPE && l)
                                a.INVALIDPLAYLIST("Servers should not add more than one EXT-X-PRELOAD-HINT tag with the same TYPE attribute to a Playlist.");
                            else if ("EXT-X-PART" !== r && "EXT-X-PRELOAD-HINT" !== r || o.URI) {
                                if ("EXT-X-PRELOAD-HINT" === r && "MAP" === o.TYPE)
                                    c && a.INVALIDPLAYLIST("Servers should not add more than one EXT-X-PRELOAD-HINT tag with the same TYPE attribute to a Playlist."),
                                    c = !0,
                                    s.hasMap = !0,
                                    u.map = new f({
                                        hint: !0,
                                    ...
                                    "EXT-X-PART" !== r || o.DURATION || a.INVALIDPLAYLIST("EXT-X-PART: DURATION attribute is mandatory"),
                                ...
                                a.INVALIDPLAYLIST("EXT-X-PART / EXT-X-PRELOAD-HINT: URI attribute is mandatory");
                        else
                            a.INVALIDPLAYLIST("EXT-X-PRELOAD-HINT: TYPE attribute is mandatory")
                    }, m = n; m <= r; m++)
                        d(m);
                    return u
                }
                function O(e, t, n, r, i) {
                    var o = t.discontinuity
                      ...
                      , c = t.byterange
                      , l = t.uri;
                    if (o && (t.discontinuitySequence = n + 1),
                    s || (t.key = r),
                    u || (t.map = i),
                    c && -1 === c.offset) {
                        var d = e.segments;
                        if (d.length > 0) {
                            ...
                            a.INVALIDPLAYLIST("If offset of EXT-X-BYTERANGE is not present, a previous Media Segment MUST appear in the Playlist file")
                    }
                    return e.segments.push(t),
                    [t.discontinuitySequence, t.key, t.map]
                }
                function L(e, t) {
                    var n = i(function(e) {
                        var t = e.indexOf(":");
                    ...
                    if (function(e, t) {
                        if ("Segment" === e || "MediaPlaylist" === e)
                            return void 0 === t.isMasterPlaylist ? void (t.isMasterPlaylist = !1) : void (t.isMasterPlaylist && w());
                        if ("MasterPlaylist" === e) {
                    ...
                    "Unknown" === s)
                        return null;
                    "MediaPlaylist" === s && "EXT-X-RENDITION-REPORT" !== r && (t.hash[r] && a.INVALIDPLAYLIST("There MUST NOT be more than one Media Playlist tag of each type in any Media Playlist"),
                    t.hash[r] = !0);
                      ...
                      , n = function(e, t) {
                        ...
                        return t.isMasterPlaylist ? n = function(e, t) {
                                ...
                                for (s.s(); !(n = s.n()).done; ) {
                                    ...
                                    if ("EXT-X-VERSION" === f)
                                        ...
                                        "EXT-X-SESSION-DATA" === f ? function() {
                                            ...
                                            )) && a.INVALIDPLAYLIST("A Playlist MUST NOT contain more than one EXT-X-SESSION-DATA tag with the same DATA-ID attribute and the same LANGUAGE attribute."),
                                            o.sessionDataList.push(e)
                                            ...
                                            )) && a.INVALIDPLAYLIST("A Master Playlist MUST NOT contain more than one EXT-X-SESSION-KEY tag with the same METHOD, URI, IV, KEYFORMAT, and KEYFORMATVERSIONS attribute values."),
                                            A(t, p),
                                            o.sessionKeyList.push(e)
                                        }() : "EXT-X-INDEPENDENT-SEGMENTS" === f ? (o.independentSegments && a.INVALIDPLAYLIST("EXT-X-INDEPENDENT-SEGMENTS tag MUST NOT appear more than once in a Playlist"),
                                        o.independentSegments = !0) : "EXT-X-START" === f && (o.start && a.INVALIDPLAYLIST("EXT-X-START tag MUST NOT appear more than once in a Playlist"),
                                        "number" != typeof p["TIME-OFFSET"] && a.INVALIDPLAYLIST("EXT-X-START: TIME-OFFSET attribute is REQUIRED"),
                                        o.start = {
                            ...
                            if (t.isClosedCaptionsNone) {
                                ...
                                try {
                                    for (T.s(); !(E = T.n()).done; )
                                        E.value.closedCaptions.length > 0 && a.INVALIDPLAYLIST("If there is a variant with CLOSED-CAPTIONS attribute of NONE, all EXT-X-STREAM-INF tags MUST have this attribute with a value of NONE")
                                } catch (e) {
                                    T.e(e)
                                } finally {
                                    T.f()
                            ...
                            var n, o = new v, s = -1, u = 0, c = !1, l = 0, d = null, h = null, f = !1, _ = r(e.entries());
                            try {
                                for (_.s(); !(n = _.n()).done; ) {
                                    var p = i(n.value, 2)
                                      , m = p[0]
                                    ...
                                    if ("Segment" !== g.category) {
                                        if ("EXT-X-VERSION" === y)
                                            void 0 === o.version ? o.version = T : a.INVALIDPLAYLIST("A Playlist file MUST NOT contain more than one EXT-X-VERSION tag.");
                                        else if ("EXT-X-TARGETDURATION" === y)
                                            o.targetDuration = t.targetDuration = T;
                                        else if ("EXT-X-MEDIA-SEQUENCE" === y)
                                            o.segments.length > 0 && a.INVALIDPLAYLIST("The EXT-X-MEDIA-SEQUENCE tag MUST appear before the first Media Segment in the Playlist."),
                                            o.mediaSequenceBase = u = T;
                                        else if ("EXT-X-DISCONTINUITY-SEQUENCE" === y)
                                            o.segments.length > 0 && a.INVALIDPLAYLIST("The EXT-X-DISCONTINUITY-SEQUENCE tag MUST appear before the first Media Segment in the Playlist."),
                                            c && a.INVALIDPLAYLIST("The EXT-X-DISCONTINUITY-SEQUENCE tag MUST appear before any EXT-X-DISCONTINUITY tag."),
                                            o.discontinuitySequenceBase = l = T;
                                        else if ("EXT-X-ENDLIST" === y)
                                            o.endlist = !0;
                                        else if ("EXT-X-PLAYLIST-TYPE" === y)
                                            o.playlistType = T;
                                        else if ("EXT-X-I-FRAMES-ONLY" === y)
                                            t.compatibleVersion < 4 && (t.compatibleVersion = 4),
                                            o.isIFrame = !0;
                                        else if ("EXT-X-INDEPENDENT-SEGMENTS" === y)
                                            o.independentSegments && a.INVALIDPLAYLIST("EXT-X-INDEPENDENT-SEGMENTS tag MUST NOT appear more than once in a Playlist"),
                                            o.independentSegments = !0;
                                        else if ("EXT-X-START" === y)
                                            o.start && a.INVALIDPLAYLIST("EXT-X-START tag MUST NOT appear more than once in a Playlist"),
                                            "number" != typeof S["TIME-OFFSET"] && a.INVALIDPLAYLIST("EXT-X-START: TIME-OFFSET attribute is REQUIRED"),
                                            o.start = {
                                                offset: S["TIME-OFFSET"],
                                                precise: S.PRECISE || !1
                                            };
                                        else if ("EXT-X-SERVER-CONTROL" === y)
                                            S["CAN-BLOCK-RELOAD"] || a.INVALIDPLAYLIST("EXT-X-SERVER-CONTROL: CAN-BLOCK-RELOAD=YES is mandatory for Low-Latency HLS"),
                                            o.lowLatencyCompatibility = {
                                            ...
                                            S["PART-TARGET"] || a.INVALIDPLAYLIST("EXT-X-PART-INF: PART-TARGET attribute is mandatory"),
                                            o.partTargetDuration = S["PART-TARGET"];
                                        else if ("EXT-X-RENDITION-REPORT" === y)
                                            S.URI || a.INVALIDPLAYLIST("EXT-X-RENDITION-REPORT: URI attribute is mandatory"),
                                            0 === S.URI.search(/^[a-z]+:/) && a.INVALIDPLAYLIST("EXT-X-RENDITION-REPORT: URI must be relative to the playlist uri"),
                                            o.renditionReports.push(new E({
                                                uri: S.URI,
                                                lastMSN: S["LAST-MSN"],
                                                lastPart: S["LAST-PART"]
                                            }));
                                        else if ("EXT-X-SKIP" === y)
                                            S["SKIPPED-SEGMENTS"] || a.INVALIDPLAYLIST("EXT-X-SKIP: SKIPPED-SEGMENTS attribute is mandatory"),
                                            t.compatibleVersion < 9 && (t.compatibleVersion = 9),
                                            o.skip = S["SKIPPED-SEGMENTS"],
                                            u += o.skip;
                                        else if ("string" == typeof g) {
                                            -1 === s && a.INVALIDPLAYLIST("A URI line is not preceded by any segment tags"),
                                            o.targetDuration || a.INVALIDPLAYLIST("The EXT-X-TARGETDURATION tag is REQUIRED");
                            ...
                            if (-1 !== s) {
                                ...
                                if (I) {
                                    var w = I.parts;
                                    w.length > 0 && !o.endlist && !w[w.length - 1].hint && a.INVALIDPLAYLIST("If the Playlist contains EXT-X-PART tags and does not contain an EXT-X-ENDLIST tag, the Playlist must contain an EXT-X-PRELOAD-HINT tag with a TYPE=PART attribute"),
                                    O(o, I, d, h),
                            ...
                            return function(e) {
                                for (var t = new Map, n = new Map, i = !1, o = !1, s = e.length - 1; s >= 0; s--) {
                                    ...
                                    l && l.start) {
                                        i = !0,
                                        l.endOnNext && (l.end || l.duration) && a.INVALIDPLAYLIST("An EXT-X-DATERANGE tag with an END-ON-NEXT=YES attribute MUST NOT contain DURATION or END-DATE attributes.");
                                        var d = l.start.getTime()
                                          , h = l.duration || 0;
                                        l.end && l.duration && d + 1e3 * h !== l.end.getTime() && a.INVALIDPLAYLIST("END-DATE MUST be equal to the value of the START-DATE attribute plus the value of the DURATION"),
                            ...
                            o.lowLatencyCompatibility && function(e, t) {
                                var n = e.lowLatencyCompatibility
                                  ...
                                  , d = n.holdBack
                                  , h = n.partHoldBack;
                                if (l < 6 * o && a.INVALIDPLAYLIST("The Skip Boundary must be at least six times the EXT-X-TARGETDURATION."),
                                d < 3 * o && a.INVALIDPLAYLIST("HOLD-BACK must be at least three times the EXT-X-TARGETDURATION."),
                                t) {
                                    void 0 === s && a.INVALIDPLAYLIST("EXT-X-PART-INF is required if a Playlist contains one or more EXT-X-PART tags"),
                                    void 0 === h && a.INVALIDPLAYLIST("EXT-X-PART: PART-HOLD-BACK attribute is mandatory"),
                                    h < s && a.INVALIDPLAYLIST("PART-HOLD-BACK must be at least PART-TARGET");
                                    var f, _ = r(u.entries());
                                    try {
                                        for (_.s(); !(f = _.n()).done; ) {
                                            var p = i(f.value, 2)
                                            ...
                                            try {
                                                for (y.s(); !(g = y.n()).done; ) {
                                                    var E = i(g.value, 2)
                                                      , T = E[0]
                                                      , S = E[1].duration;
                                                    void 0 !== S && (S > s && a.INVALIDPLAYLIST("PART-TARGET is the maximum duration of any Partial Segment"),
                                                    T < v.length - 1 && S < .85 * s && a.INVALIDPLAYLIST("All Partial Segments except the last part of a segment must have a duration of at least 85% of PART-TARGET"))
                                                }
                                            } catch (e) {
                                                y.e(e)
                                            } finally {
                                ...
                                try {
                                    for (A.s(); !(b = A.n()).done; ) {
                                        var I = b.value
                                          , w = u[u.length - 1];
                                        I.lastMSN || (I.lastMSN = w.mediaSequenceNumber),
                                        !I.lastPart && w.parts.length > 0 && (I.lastPart = w.parts.length - 1)
                                    }
                                } catch (e) {
                                    A.e(e)
                                } finally {
                            ...
                            o
                        }(e, t)).isIFrame && t.hasMap && t.compatibleVersion < 6 && (t.compatibleVersion = 6),
                        t.compatibleVersion > 1 && (!n.version || n.version < t.compatibleVersion) && a.INVALIDPLAYLIST("EXT-X-VERSION needs to be ".concat(t.compatibleVersion, " or higher.")),
                        n
                    }(function(e, t) {
                        var n = [];
                        return e.split("\n").forEach((function(e) {
                        ...
                        0 !== n.length && "EXTM3U" === n[0].name || a.INVALIDPLAYLIST("The EXTM3U tag MUST be the first line."),
                        n
                    }(e, t), t);
                    return n.source = e,
                    n
            ...
            367: (e,t,n)=>{
                    ...
                    return (r = [{
                        ...
                        value: function() {
                            ...
                            for (var i = function() {
                                var t = a[s];
                                if (!t.startsWith("#"))
                                    return u(_(o.prototype), "push", e).call(e, t),
                                    "continue";
                ...
                function T(e) {
                    ...
                    return e.language && t.push('LANGUAGE="'.concat(e.language, '"')),
                    e.value ? t.push('VALUE="'.concat(e.value, '"')) : e.uri && t.push('URI="'.concat(e.uri, '"')),
                    "#EXT-X-SESSION-DATA:".concat(t.join(","))
                }
                function S(e, t) {
                    var n = t ? "#EXT-X-SESSION-KEY" : "#EXT-X-KEY"
                      , r = ["METHOD=".concat(e.method)];
                    return e.uri && r.push('URI="'.concat(e.uri, '"')),
                    e.iv && (16 !== e.iv.length && p.INVALIDPLAYLIST("IV must be a 128-bit unsigned integer"),
                    r.push("IV=".concat(p.byteSequenceToHex(e.iv)))),
                    e.format && r.push('KEYFORMAT="'.concat(e.format, '"')),
                    e.formatVersion && r.push('KEYFORMATVERSIONS="'.concat(e.formatVersion, '"')),
                    "".concat(n, ":").concat(r.join(","))
                }
                function b(e, t) {
                    var n = t.isIFrameOnly ? "#EXT-X-I-FRAME-STREAM-INF" : "#EXT-X-STREAM-INF"
                      , r = ["BANDWIDTH=".concat(t.bandwidth)];
                    if (t.averageBandwidth && r.push("AVERAGE-BANDWIDTH=".concat(t.averageBandwidth)),
                    t.isIFrameOnly && r.push('URI="'.concat(t.uri, '"')),
                    t.codecs && r.push('CODECS="'.concat(t.codecs, '"')),
                    t.resolution && r.push("RESOLUTION=".concat(t.resolution.width, "x").concat(t.resolution.height)),
                    ...
                    if (p.getOptions().allowClosedCaptionsNone && 0 === t.closedCaptions.length)
                ...
                function A(e) {
                    ...
                    return void 0 !== e.isDefault && t.push("DEFAULT=".concat(e.isDefault ? "YES" : "NO")),
                    void 0 !== e.autoselect && t.push("AUTOSELECT=".concat(e.autoselect ? "YES" : "NO")),
                    void 0 !== e.forced && t.push("FORCED=".concat(e.forced ? "YES" : "NO")),
                    e.language && t.push('LANGUAGE="'.concat(e.language, '"')),
                    e.assocLanguage && t.push('ASSOC-LANGUAGE="'.concat(e.assocLanguage, '"')),
                    e.instreamId && t.push('INSTREAM-ID="'.concat(e.instreamId, '"')),
                    e.characteristics && t.push('CHARACTERISTICS="'.concat(e.characteristics, '"')),
                ...
                function I(e, t, n, r) {
                    var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1
                      , o = !1;
                    if (t.byterange && e.push("#EXT-X-BYTERANGE:".concat(R(t.byterange))),
                    ...
                    if (t.programDateTime && e.push("#EXT-X-PROGRAM-DATE-TIME:".concat(p.formatDate(t.programDateTime))),
                    t.dateRange && e.push(k(t.dateRange)),
                    t.markers.length > 0 && P(e, t.markers),
                    t.parts.length > 0 && (o = D(e, t.parts)),
                    o)
                        return [n, r];
                    var u = i < 3 ? Math.round(t.duration) : y(t.duration, E(t.duration));
                    return e.push("#EXTINF:".concat(u, ",").concat(unescape(encodeURIComponent(t.title || "")))),
                    Array.prototype.push.call(e, "".concat(t.uri)),
                    [n, r]
                }
                function w(e) {
                    var t = ['URI="'.concat(e.uri, '"')];
                    return e.byterange && t.push('BYTERANGE="'.concat(R(e.byterange), '"')),
                ...
                function k(e) {
                    ...
                    return e.start && t.push('START-DATE="'.concat(p.formatDate(e.start), '"')),
                    e.end && t.push('END-DATE="'.concat(e.end, '"')),
                    e.duration && t.push("DURATION=".concat(e.duration)),
                    e.plannedDuration && t.push("PLANNED-DURATION=".concat(e.plannedDuration)),
                    ...
                    try {
                        for (i.s(); !(n = i.n()).done; ) {
                            ...
                            if (s.hint) {
                                ...
                                var d = [];
                                d.push("DURATION=".concat(s.duration)),
                                d.push('URI="'.concat(s.uri, '"')),
                                s.byterange && d.push("BYTERANGE=".concat(R(s.byterange))),
                                s.independent && d.push("INDEPENDENT=YES"),
                                s.gap && d.push("GAP=YES"),
                ...
                e.exports = function(e) {
                    ...
                    var t = new g(e.uri);
                    return t.push("#EXTM3U"),
                    e.version && t.push("#EXT-X-VERSION:".concat(e.version)),
                    e.independentSegments && t.push("#EXT-X-INDEPENDENT-SEGMENTS"),
                    e.start && t.push("#EXT-X-START:TIME-OFFSET=".concat(y(e.start.offset)).concat(e.start.precise ? ",PRECISE=YES" : "")),
                    e.isMasterPlaylist ? function(e, t) {
                        ...
                        var n = ""
                          , r = "";
                        if (t.targetDuration && e.push("#EXT-X-TARGETDURATION:".concat(t.targetDuration)),
                        ...
                        t.partTargetDuration && e.push("#EXT-X-PART-INF:PART-TARGET=".concat(t.partTargetDuration)),
                        t.mediaSequenceBase && e.push("#EXT-X-MEDIA-SEQUENCE:".concat(t.mediaSequenceBase)),
                        t.discontinuitySequenceBase && e.push("#EXT-X-DISCONTINUITY-SEQUENCE:".concat(t.discontinuitySequenceBase)),
                        t.playlistType && e.push("#EXT-X-PLAYLIST-TYPE:".concat(t.playlistType)),
                        t.isIFrame && e.push("#EXT-X-I-FRAMES-ONLY"),
                        t.skip > 0 && e.push("#EXT-X-SKIP:SKIPPED-SEGMENTS=".concat(t.skip));
                        ...
                        try {
                            for (m.s(); !(p = m.n()).done; ) {
                                ...
                                void 0 !== v.lastPart && g.push("LAST-PART=".concat(v.lastPart)),
                                e.push("#EXT-X-RENDITION-REPORT:".concat(g.join(",")))
                            }
                        } catch (e) {
                            m.e(e)
                        } finally {
            ...
            890: (e,t,n)=>{
                ...
                var c = n(771)
                  ...
                  , d = function(e) {
                    ...
                    var t = o(n);
                    function n(e) {
                        var r, i = e.isMasterPlaylist, o = e.uri, s = e.version, a = e.independentSegments, l = void 0 !== a && a, d = e.start, h = e.source;
                        return u(this, n),
                  ...
                  , f = function(e) {
                    ...
                    function n() {
                        ...
                        var i = r.targetDuration
                          ...
                          , T = void 0 === E ? 0 : E
                          , S = r.hash;
                        return e.targetDuration = i,
                        e.mediaSequenceBase = s,
                  ...
                  , _ = function(e) {
                    ...
                    var t = o(n);
                    function n(e) {
                        var r, i = e.uri, o = e.mimeType, s = e.data, a = e.duration, c = e.title, l = e.byterange, d = e.discontinuity, h = e.mediaSequenceNumber, f = void 0 === h ? 0 : h, _ = e.discontinuitySequence, p = void 0 === _ ? 0 : _, m = e.key, v = e.map, g = e.programDateTime, y = e.dateRange, E = e.markers, T = void 0 === E ? [] : E, S = e.parts, b = void 0 === S ? [] : S;
                        return u(this, n),
                  ...
                  , p = function(e) {
                    ...
                    var t = o(n);
                    function n(e) {
                        var r, i = e.hint, o = void 0 !== i && i, s = e.uri, a = e.duration, l = e.independent, d = e.byterange, h = e.gap;
                        return u(this, n),
                        r = t.call(this, "part"),
                        c.PARAMCHECK(s),
                        r.hint = o,
                ...
                e.exports = {
                    Rendition: function e(t) {
                        ...
                        u(this, e),
                        c.PARAMCHECK(n, i, a),
                        c.CONDITIONALASSERT(["SUBTITLES" === n, r], ["CLOSED-CAPTIONS" === n, f], ["CLOSED-CAPTIONS" === n, !r], [h, "SUBTITLES" === n]),
                        this.type = n,
                        this.uri = r,
                        this.groupId = i,
                        this.language = o,
                        this.assocLanguage = s,
                        this.name = a,
                        this.isDefault = l,
                        this.autoselect = d,
                        this.forced = h,
                    ...
                    SessionData: function e(t) {
                        ...
                        u(this, e),
                        c.PARAMCHECK(n, r || i),
                        c.ASSERT("SessionData cannot have both value and uri, shoud be either.", !(r && i)),
                        this.id = n,
                        this.value = r,
                        this.uri = i,
                        this.language = o
                    ...
                    Key: function e(t) {
                        ...
                        c.CONDITIONALASSERT(["NONE" === n, !(r || i || o || s)]),
                        this.method = n,
                        this.uri = r,
                        this.iv = i,
                        this.format = o,
                        this.formatVersion = s
                    },
                    ...
                    DateRange: function e(t) {
                        ...
                        c.CONDITIONALASSERT([o, i], [o, i <= o], [s, s >= 0], [a, a >= 0]),
                        this.id = n,
                        this.classId = r,
                        this.start = i,
                        this.end = o,
            ...
            771: e=>{
                ...
                e.exports = {
                    ...
                    byteSequenceToHex: function(e) {
                        ...
                        for (var r = [], i = t; i < n; i++)
                            r.push("0".concat((255 & e[i]).toString(16).toUpperCase()).slice(-2));
                    ...
                    splitByCommaWithPreservingQuotes: function(e) {
                        for (var t = [], n = !0, r = 0, i = [], o = 0; o < e.length; o++) {
                            var s = e[o];
                            n && "," === s ? (t.push(e.slice(r, o).trim()),
                            r = o + 1) : '"' !== s && "'" !== s || (n ? (i.push(s),
                            n = !1) : s === i[i.length - 1] ? (i.pop(),
                            n = !0) : i.push(s))
                        }
                        return t.push(e.slice(r).trim()),
                        t
                    },
                    camelify: function(e) {
                        var t, r = [], i = !1, o = n(e);
                        try {
                            for (o.s(); !(t = o.n()).done; ) {
                                var s = t.value;
                                "-" !== s && "_" !== s ? i ? (r.push(s.toUpperCase()),
                                i = !1) : r.push(s.toLowerCase()) : i = !0
                            }
                        } catch (e) {
                            o.e(e)
                        } finally {
...
var F_, j_ = ["bottom", "height", "left", "right", "top", "width"], B_ = new Map, V_ = "undefined" != typeof window ? n_.useLayoutEffect : n_.useEffect;
function H_(e, t) {
    void 0 === t && (t = {
        width: 0,
        height: 0
                ...
                return {
                    ...
                    unobserve: function() {
                        ...
                        if (n) {
                            ...
                            n.callbacks.length || B_.delete(e),
                            B_.size || cancelAnimationFrame(F_)
                        }
                    }
                }
            }(r, (function(e) {
...
var q_ = function() {
  ...
  , K_ = function(e) {
    for (var t = Math.max(e.start - e.overscan, 0), n = Math.min(e.end + e.overscan, e.size - 1), r = [], i = t; i <= n; i++)
        r.push(i);
    return r
};
function Y_(e) {
    var t, n = e.size, r = void 0 === n ? 0 : n, i = e.estimateSize, o = void 0 === i ? q_ : i, s = e.overscan, a = void 0 === s ? 1 : s, u = e.paddingStart, c = void 0 === u ? 0 : u, l = e.paddingEnd, d = void 0 === l ? 0 : l, h = e.parentRef, f = e.horizontal, _ = e.scrollToFn, p = e.useObserver, m = e.initialRect, v = e.onScrollElement, g = e.scrollOffsetFn, y = e.keyExtractor, E = void 0 === y ? G_ : y, T = e.measureSize, S = void 0 === T ? W_ : T, b = e.rangeExtractor, A = void 0 === b ? K_ : b, I = f ? "width" : "height", w = f ? "scrollLeft" : "scrollTop", R = n_.useRef({
        scrollOffset: 0,
        measurements: []
    }), k = n_.useState(0), P = k[0], D = k[1];
    ...
    R.current.measurements = j,
    R.current.totalSize = B;
    ...
    var z = n_.useCallback((function(e, t) {
        var n = (void 0 === t ? {} : t).align
          ...
          , o = i.scrollOffset
          , s = i.outerSize;
        "auto" === r && (r = e <= o ? "start" : e >= o + s ? "end" : "start"),
        "start" === r ? _(e) : "end" === r ? _(e - s) : "center" === r && _(e - s / 2)
    }
    ), [_])
...
export {Nl as $, Qa as A, au as B, Sc as C, uu as D, fo as E, eu as F, Pl as G, ou as H, du as I, vo as J, yo as K, Rc as L, go as M, Xo as N, qo as O, Ja as P, Za as Q, su as R, ru as S, po as T, Ho as U, lo as V, Vo as W, Oe as X, Cn as Y, ln as Z, Ee as _, Ge as a, ye as a$, xl as a0, o as a1, rd as a2, id as a3, De as a4, dd as a5, kd as a6, Rd as a7, no as a8, wc as a9, ar as aA, lr as aB, ur as aC, He as aD, yc as aE, Le as aF, ld as aG, y_ as aH, mo as aI, Ce as aJ, Fe as aK, Qh as aL, vf as aM, mf as aN, L_ as aO, xh as aP, zh as aQ, E_ as aR, yt as aS, yf as aT, Hf as aU, N_ as aV, At as aW, ie as aX, x_ as aY, Ae as aZ, Ie as a_, Od as aa, Dc as ab, je as ac, Ic as ad, xu as ae, We as af, Dd as ag, Md as ah, Cd as ai, Jd as aj, gh as ak, dh as al, Eh as am, u_ as an, o_ as ao, i_ as ap, ge as aq, lf as ar, _f as as, hf as at, kh as au, Of as av, wh as aw, p_ as ax, Yh as ay, Gu as az, Ke as b, ze as b0, se as b1, $e as b2, Y_ as b3, pf as b4, ji as c, Xe as d, yu as e, oe as f, qn as g, be as h, Ec as i, de as j, ue as k, Mc as l, $u as m, dr as n, he as o, qe as p, Uc as q, pt as r, Bt as s, Nc as t, El as u, nu as v, tu as w, Ze as x, iu as y, za as z};
