...
*/
    ...
    var Ua = function(a) {
        ...
        return a.replace(Ta, function(d, e) {
            ...
            if (!g) {
                ...
                "SCRIPT" === e || "STYLE" === e))
                    throw Error("SCRIPT" === e ? "Use safeScriptEl.setTextContent with a SafeScript." : "Use safeStyleEl.setTextContent with a SafeStyleSheet.");
                g instanceof G && g.constructor === G ? g = g.g : (za("expected object of type SafeHtml, got '" + g + "' of type " + la(g)),
    ...
    chrome.cast.hb = function(a, b, c, d) {
        this.label = a;
        a = b;
        xa.test(a) && (-1 != a.indexOf("&") && (a = a.replace(ra, "&amp;")),
    ...
    f.Ub = function(a, b, c, d) {
        ...
        if (!(0 > e))
            if (0 > b)
                d && d(new chrome.cast.Error(chrome.cast.v.INVALID_PARAMETER));
            else if (e == b)
                c && c();
            else {
                var g = null;
    ...
    f.Jb = function() {
        if (this.breakStatus && void 0 !== this.breakStatus.currentBreakTime)
            return this.playerState == chrome.cast.media.A.PLAYING && 0 <= this.g ? this.breakStatus.currentBreakTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakTime
    }
    ;
    f.Ib = function() {
        if (this.breakStatus && void 0 !== this.breakStatus.currentBreakClipTime)
            return this.playerState == chrome.cast.media.A.PLAYING && 0 <= this.g ? this.breakStatus.currentBreakClipTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakClipTime
    }
    ;
    f.Kb = function() {
    ...
    var db = function(a) {
        if (a instanceof K || a instanceof L || a instanceof M)
            return a;
    ...
    N.prototype.delete = function(a) {
        return P(this.i, a) ? (delete this.i[a],
        --this.size,
        this.l++,
    ...
    var ob = function() {
      ...
      , qb = function(a, b) {
        var c = b.sessionId + "#" + b.mediaSessionId
          , d = a.i[c];
        d || (d = new chrome.cast.media.h(b.sessionId,b.mediaSessionId),
        a.i[c] = d,
    ...
    var tb = E("Gecko") && !(-1 != La().toLowerCase().indexOf("webkit") && !E("Edge")) && !(E("Trident") || E("MSIE")) && !E("Edge")
    ...
    var W = function() {
      ...
      , X = function(a, b, c, d) {
        c && hb(a.R, c);
        void 0 !== d ? b.sequenceNumber = d : (b.sequenceNumber = a.i,
        a.i = (a.i + 1) % 9007199254740992);
        d = jb(a.B, b);
        c && d && (a = ib(a.R, b.sequenceNumber)) && (a = a.g,
    ...
    W.prototype.initialize = function(a, b) {
        ...
        H = this;
        this.g = a;
        a.invisibleSender || (a = new PresentationRequest(Ab(this)),
        ...
        a.reconnect(chrome.cast.Ga).then(function(d) {
            Y(c, d)
        }, function() {}));
        b && b(void 0)
    }
    ...
    var Ab = function(a, b) {
        ...
        var e = b.dialRequest;
        e && (c = e.appName,
        (d = e.launchParameter) && !d.match(Cb) && (d = xb(d)));
        var g = [];
        g.push({
            appId: b.appId,
            capabilities: b.capabilities
        });
        b || Aa(a.g.additionalSessionRequests, function(k) {
            g.push({
                appId: k.appId,
    ...
    var Db = function(a, b, c, d, e, g, k) {
        ...
        a.Ca(d, function(l) {
            l.status && 1 == l.status.length ? e && e(l.status[0]) : (l = new chrome.cast.Error(chrome.cast.v.SESSION_ERROR),
            g && g(l))
        }, g, k)
    };
    f = W.prototype;
    ...
    var Bb = function(a, b) {
        if (a.F) {
            ...
            pb(a.I, c, b) && (a.s.delete(c),
            a.G.delete(c),
            b = a.C.get(c)) && (a.C.delete(c),
            J(b.o(), function(e) {
                e(d)
            }))
        }
    ...
    W.prototype.onMessage = function(a) {
        ...
        if (b = a.message)
            ...
            case "new_session":
                this.F = b.sessionId;
                this.l ? (this.l(b),
                this.l = null) : this.g && this.g.sessionListener(b);
                break;
            case "update_session":
                Gb(this, b);
                break;
    ...
    ;
    "complete" == document.readyState ? chrome.cast.da() : (window.addEventListener("load", chrome.cast.da, !1),
