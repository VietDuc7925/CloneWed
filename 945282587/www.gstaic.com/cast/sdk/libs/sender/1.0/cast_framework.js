...
*/
    ...
    var h = this || self
      ...
      , k = function(a, b, c) {
        k = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? da : ea;
    ...
    , w = new v("OFF",Infinity), x = new v("SEVERE",1E3), y = new v("WARNING",900), z = new v("CONFIG",700), A = [w, new v("SHOUT",1200), x, y, new v("INFO",800), z, new v("FINE",500), new v("FINER",400), new v("FINEST",300), new v("ALL",0)], B = null, fa = class {
        constructor() {
            this.ca = 0;
            this.clear()
        }
    ...
    var xa = function(a) {
      ...
      , za = function(a) {
        a instanceof I || (a = "object" == typeof a && a.Eb ? a.Cb() : String(a),
...
*/
    ...
    class Qa {
        ...
        get() {
            ...
            a = this.ha,
            this.ha = a.next,
            a.next = null) : a = this.nb();
            return a
        }
        put(a) {
            this.Tb(a);
            this.ka < this.Gb && (this.ka++,
            a.next = this.ha,
            this.ha = a)
        }
    }
    ;var Ra, Sa = function() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == G().indexOf("Presto") && (a = function() {
            ...
            var g = "callImmediate" + Math.random()
              , p = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host;
            e = k(function(q) {
    ...
    var Va = new Qa(()=>new Wa,a=>a.reset());
    class Wa {
        constructor() {
    ...
    , Za = ()=>{
        if (h.Promise && h.Promise.resolve) {
            ...
            N = ()=>{
                var a = ab, b;
                !(b = "function" !== typeof h.setImmediate) && (b = h.Window && h.Window.prototype) && (b = -1 == G().indexOf("Edge") && h.Window.prototype.setImmediate == h.setImmediate);
                b ? (Ra || (Ra = Sa()),
                Ra(a)) : h.setImmediate(a)
            }
    }
    ;
    var ab = ()=>{
    ...
    Q.prototype.then = function(a, b, c) {
        return fb(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    }
    ;
    ...
    var gb = function(a, b) {
        if (0 == a.l)
            if (a.G) {
                var c = a.G;
                if (c.A) {
                    for (var d = 0, e = null, f = null, g = c.A; g && (g.aa || (d++,
                    g.F == a && (e = g),
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.l && 1 == d ? gb(c, b) : (f ? (d = f,
                    d.next == c.I && (c.I = d),
                    d.next = d.next.next) : hb(c),
                    ib(c, e, 3, b)))
                }
                a.G = null
            } else
    ...
    ;var T = function(a) {
      ...
      , sb = function(a, b) {
        return T(a) ? (b && b.breaks || []).find(c=>c.id === a.breakId) || null : null
    }
      , tb = function(a, b) {
        return T(a) ? (b && b.breakClips || []).find(c=>c.id === a.breakClipId) || null : null
    }
      , ub = function(a) {
        if (!a.j)
    ...
    const wb = class {
        ...
        Ea() {
            ...
            this.g.isPaused ? this.j.pause(null, this.M, this.L) : this.j.play(null, this.M, this.L))
        }
        stop() {
            this.j && (this.v++,
            this.j.stop(null, this.M, this.L))
        }
        seek() {
            if (this.j) {
        ...
        Lb() {
            this.v--;
            this.j && this.j.getStatus(null, ()=>{}
            , ()=>{}
            )
        }
        Ob() {
            this.j && ("function" === typeof this.j.getEstimatedBreakTime && (this.g.currentBreakTime = this.j.getEstimatedBreakTime()),
            "function" === typeof this.j.getEstimatedBreakClipTime && (this.g.currentBreakClipTime = this.j.getEstimatedBreakClipTime()),
            "function" === typeof this.j.getEstimatedLiveSeekableRange && (this.g.liveSeekableRange = this.j.getEstimatedLiveSeekableRange()),
        ...
        D(a) {
            if (!(0 < this.v))
                if (this.h) {
                    ...
                    !a && this.h.receiver && (a = this.h.receiver.volume) && (null != a.muted && (this.g.isMuted = a.muted),
                    ...
                    if (this.j) {
                        ...
                        if (T(a)) {
                            ...
                            this.g.numberBreakClips = c && Array.isArray(c.breakClipIds) ? c.breakClipIds.length : 0;
                            c && d ? (c = c.breakClipIds.indexOf(d.id),
                            c = 0 > c ? 0 : c) : c = 0;
                        ...
                        this.Z(b.media);
                        this.g.canSeek = T(a) && (void 0 == a.whenSkippable || 0 > a.whenSkippable || a.currentBreakClipTime < a.whenSkippable) ? !1 : 0 <= b.supportedMediaCommands.indexOf(chrome.cast.media.MediaCommand.SEEK) && 0 != this.g.duration;
                        this.g.currentTime = b.getEstimatedTime();
                        this.C && (clearTimeout(this.C),
                        this.C = null);
                        b.playerState == chrome.cast.media.PlayerState.PLAYING && (this.C = setTimeout(this.Xa, 1E3))
                    } else
                        this.Z(null)
                } else
                    this.g.displayName = "",
        ...
        Z(a) {
            a ? (this.g.duration = a.duration || 0,
            a.metadata && a.metadata.title && (this.g.displayStatus = a.metadata.title)) : (this.g.isMediaLoaded = !1,
            this.g.canPause = !1,
            this.g.canSeek = !1,
    ...
    var Lb = class {
        ...
        dispatchEvent(a) {
            a && a.type && (this.U[a.type] || []).slice().forEach(b=>{
                try {
                    b(a)
                } catch (c) {
    ...
    var Mb = function(a) {
      ...
      , Nb = function(a, b) {
        a.Ya = b;
        !b.volume || a.o && a.o.muted == b.volume.muted && a.o.level == b.volume.level || (a.o = b.volume,
        a.m.dispatchEvent(new Jb(a.o.level,a.o.muted)));
        a.ia != b.isActiveInput && (a.ia = b.isActiveInput,
        b = a.ia,
      ...
      , V = class {
        ...
        Pa(a) {
            "SESSION_ENDED" != this.l && (a ? this.i.stop(()=>{}
            , ()=>{}
            ) : this.i.leave(()=>{}
            , ()=>{}
            ))
        ...
        setVolume(a) {
            ...
            this.o && (this.o.level = a,
            this.o.muted = !1);
            this.i.setReceiverVolumeLevel(a, ()=>b.resolve(), d=>b.reject(d.code));
            return c
        }
        Db() {
        ...
        Wb(a) {
            ...
            this.i.setReceiverMuted(a, ()=>b.resolve(), d=>b.reject(d.code));
            return c
        }
        isMute() {
        ...
        sendMessage(a, b) {
            ...
            this.i.sendMessage(a, b, ()=>c.resolve(), e=>c.reject(e.code));
            return d
        }
    ...
    var Qb = function(a) {
        ...
        b = new chrome.cast.ApiConfig(b,a.cb.bind(a),a.Sb.bind(a),a.s.autoJoinPolicy);
        chrome.cast.initialize(b, ()=>{}
        , ()=>{}
        );
      ...
      , Rb = function(a) {
        ...
        b !== a.S && (a.S = b,
        a.m.dispatchEvent(new Pb(b)))
    }
      , X = function(a, b, c) {
        b == a.u ? "SESSION_START_FAILED" == b && a.m.dispatchEvent(new Ob(a.h,a.u,c)) : (a.u = b,
        a.h && (a.h.l = a.u),
      ...
      , Y = class {
        ...
        Vb(a) {
            this.s ? (this.s.credentialsData = a,
            Qb(this)) : W && E(W, y, "setLaunchCredentialsData was ignored because it was called before setOptions.")
        }
        Sb(a) {
            (this.Ha = a == chrome.cast.ReceiverAvailability.AVAILABLE) && !this.h && this.ma && this.s.resumeSavedSession && chrome.cast.requestSessionById(this.ma);
            Rb(this)
        }
        Rb(a, b) {
            this.h || b != chrome.cast.ReceiverAction.CAST ? this.h && b == chrome.cast.ReceiverAction.STOP ? X(this, "SESSION_ENDING") : a && Nb(this.h, a) : X(this, "SESSION_STARTING")
        }
        cb(a) {
            const b = "SESSION_STARTING" == this.u ? "SESSION_STARTED" : "SESSION_RESUMED";
            this.ma = null;
            this.h = new V(a,b);
                ...
                case chrome.cast.SessionStatus.CONNECTED:
                    ...
                    if (d = b.applicationId == c.appId && b.name == c.displayName)
                        ...
                        ba(d) && ba(b) && d.length == b.length) {
                            ...
                            d = !1;
                    d || (a.ja = new Eb(a.i),
                    a.m.dispatchEvent(new Fb(a.ja)));
                    Nb(a, a.i.receiver);
                    a.Y != a.i.statusText && (a.Y = a.i.statusText,
                    a.m.dispatchEvent(new Gb(a.Y)));
                    break;
                default:
    ...
    var Sb = function() {
      ...
      , Vb = function(a) {
        if ("NO_DEVICES_AVAILABLE" == a.l)
            a.J.style.display = "none";
        else
            switch (a.J.style.display = a.ob,
            a.l) {
            case "NOT_CONNECTED":
      ...
      , Xb = function(a) {
        ...
        null !== a.O && (window.clearTimeout(a.O),
        a.O = null)
    }
      , Ub = function(a, b, c) {
        for (let d of a.oa)
    ...
    var bc = function() {
      ...
      , cc = function() {
        document.querySelectorAll("button[is=google-cast-button], google-cast-launcher").forEach(a=>ac(a))
    }
      , ac = function(a) {
        a.B = new Yb(a);
    ...
    customElements.define ? (customElements.define("google-cast-button", $b, {
        extends: "button"
    }),
    customElements.define("google-cast-launcher", Zb)) : ("complete" !== document.readyState ? window.addEventListener("load", cc) : cc(),
    bc());
    l("cast.framework.RemotePlayer", class {
        constructor() {
    ...
    var ec = function(a, b) {
      ...
      , Z = class extends wb {
        ...
        D(a) {
            ...
            a ? (this.g.queueData = a.queueData,
            this.g.videoInfo = a.videoInfo,
            this.g.liveSeekableRange = "function" === typeof a.getEstimatedLiveSeekableRange ? a.getEstimatedLiveSeekableRange() : a.liveSeekableRange) : (this.g.queueData = void 0,
